...
1. Download the wheel file: [snorkelai_stb-1.0.0-py3-none-any.whl](/snorkelai_stb-1.0.0-py3-none-any.whl)
2. Install using pip:
  ```bash
  pip install snorkelai_stb-1.0.0-py3-none-any.whl
  ```

**Option 2: Install from Cloud**

Install the CLI using pip with the pre-built wheel on cloud:

```bash
pip install https://snorkel-python-wheels.s3.us-west-2.amazonaws.com/stb/snorkelai_stb-1.0.0-py3-none-any.whl
```
