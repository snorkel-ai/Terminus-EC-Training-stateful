export const trainingSections = [
  ...
  },
  {
    ...
    content: (
      <>
        <h2>Rate Schedule</h2>
        <p><em>Last updated: Oct 24, 2025</em></p>
        
        <p>
          This page lists the most up-to-date and currently active compensation information for the 
          Terminus project. If any additional compensation-related information is disseminated or 
          introduced, this page will be updated accordingly.
        </p>

        <h3>General EC Role (Submissions)</h3>
        <table>
          <thead>
            <tr>
              <th>Task Type</th>
        ...
        <h3>Billing Week (Friday–Thursday)</h3>
        <ul>
          <li><strong>Definition:</strong> A seven-day billing cycle that begins at 12:00 AM on Friday (immediately after Thursday ends) and runs through 11:59 PM the following Thursday. UTC Time.</li>
          <li><strong>Average turnaround:</strong> 1–2 weeks</li>
        </ul>

        <div className="info-box">
          <strong>Example Pay Cycle:</strong>
          <ul>
            <li>Work window: Fri Sep 19 – Thu Sep 25</li>
            <li>This includes ACCEPTED Submissions and COMPLETED Reviews & Adjudications</li>
            <li>HireArt deposits funds: Fri Oct 3</li>
          </ul>
        </div>

        <h3>How to Track Payment</h3>
        <ul>
          <li>Platform status "Payout Submitted" = Snorkel has sent the payment request to HireArt and funds are on the way</li>
          <li>If "Payout Submitted" shows for &gt; 1 week and you still haven't been paid, reach out to hr@hireart.com</li>
        </ul>

        <div className="warning-box">
          <strong>Important:</strong> You will not be paid per submission, but instead per <strong>Accepted submission</strong>. 
          An accepted submission must pass all Snorkel Programmatic Evaluations and a peer review. You will have 
          the opportunity to defend your submission if it is determined that it should be rejected. However, Snorkel 
          ultimately reserves the ability to reject a submission based upon the criteria listed throughout this 
