  ...
  return (
    <div className="videos-page">
      <header className="videos-header">
        ...
        <div className="videos-logo">GitHub Onboarding Materials</div>
      </header>
      
      <main className="videos-content">
        <h1 className="videos-title">GitHub Onboarding Materials</h1>
        <div className="workbook-intro">
          <p>
            Access the onboarding presentation slides and watch the onboarding video to get started with the Terminus EC project via GitHub.
          </p>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
              <a 
                href="/Terminus-EC-Training-stateful/Terminus EC Onboarding.pdf" 
                target="_blank"
            ...
            <div>
              ...
              <div className="video-wrapper">
                ...
                >
                  <source src="/Terminus-EC-Training-stateful/Onboarding_11-14-2025.mp4" type="video/mp4" />
        ...
        <div style={{ marginTop: '2rem', maxWidth: '800px', margin: '2rem auto 0' }}>
          <CompletionToggle itemId="resource-github-onboarding" />
        </div>
      </main>
    </div>
  );
