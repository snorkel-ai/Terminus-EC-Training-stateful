...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Profiling & Benchmarking',
  'Benchmark a CMake/Ninja C++ project across linkers (ld.bfd vs lld) and with/without LTO, capturing compile vs link phase durations and Clang -ftime-trace to identify the five slowest translation units. Produce a JSON report comparing full and incremental rebuild times (after touching a common header) and recommend the fastest configuration.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Build Profiling & Benchmarking',
  'Instrument a provided CMake/Ninja C++ project with clang’s -ftime-trace and Ninja -d stats to profile cold and incremental builds, reporting the slowest translation units and link steps. Enable ccache and a precompiled header via CMake, then re-benchmark and output a before/after summary of total build time, parallelism, and cache hit rates.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Build Profiling & Benchmarking',
  'Profile a CMake+Ninja C++ project by enabling Clang -ftime-trace and Ninja -d stats to collect per-file compile/link timings and parallelism, then benchmark clean vs. incremental builds across -j values with and without ccache/PCH and using GNU ld vs. ld.lld. Emit a JSON summary ranking configurations by wall time, flag the two slowest targets, and apply minimal flag tweaks to achieve at least a 30% speedup over the baseline.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Build Profiling & Benchmarking',
  'Profile a medium C++ CMake/Ninja project by collecting compile and link timings (e.g., clang -ftime-trace and ninja -d stats), then identify the worst-offending translation units and headers. Introduce a precompiled header and an optional unity-build mode, rebuild, and emit a metrics.json comparing baseline vs optimized total build time, longest TU time, and percent improvement.',
  'medium',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Incremental Builds & Caching',
  'Configure sccache as a unified compiler cache for a mixed Rust (Cargo) + C (CMake) workspace, routing rustc, CC, and CXX through sccache with stable flags. Verify incremental behavior by performing back-to-back builds to record cache hits, then modifying a single Rust crate so only that crate recompiles while C targets are served from cache, as shown by sccache stats and build logs.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Incremental Builds & Caching',
  'Configure sccache for a Rust workspace and wire cargo to use it with rustc, enabling incremental compilation with a shared on-disk cache. Build twice across two clean worktrees, then modify a single crate to demonstrate minimal rebuilds and record timings plus sccache hit/miss stats to /app/metrics.json.',
  NULL,
  ARRAY['rust', 'compilation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Build Optimization & Performance',
  'Incremental Builds & Caching',
  'Provision a local Bazel remote cache (bazel-remote) and configure a polyglot Bazel workspace (C++, Java, Python) to use it, then perform two clean builds to prove incremental and remote cache hits. Parse the Bazel Build Event Protocol to write a summary of action counts, cache-hit ratios, and elapsed time improvements.',
  NULL,
  ARRAY['java', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure distributed, parallel compilation for a medium-size CMake+Ninja C/C++ project using distcc by launching multiple local distccd workers and wiring CC/CXX and DISTCC_HOSTS, then build with -j$(nproc). Validate by parsing distcc logs to confirm a majority of object files were compiled remotely and that total parallel jobs respect the configured CPU quota without oversubscription.',
  'medium',
  ARRAY['distributed', 'parallel', 'compilation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Build Optimization & Performance',
  'Parallelization & Resource Utilization',
  'Convert the provided CMake-based C++ project to use Ninja with CMake Unity builds and ccache, and enable ThinLTO to parallelize the link stage. Auto-detect available cores, run a cold and warm build with -j$(nproc), and output a report showing wall-time improvement and cache hits on the second build.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Parallelization & Resource Utilization',
  'Reconfigure a CMake-based C++ monorepo to use the Ninja generator with CMAKE_JOB_POOLS/CMAKE_JOB_POOL_LINK to fully parallelize compilation while capping memory-heavy link jobs, and enable ccache for reuse across repeated builds. Run a baseline (Unix Makefiles, -j1) and the optimized build, then emit /app/parallel_metrics.json with cores utilized, wall-time speedup, and cache hit rate.',
  NULL,
  ARRAY['compilation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Optimization & Performance',
  'Parallelization & Resource Utilization',
  'Refactor a recursive Makefile-based C/C++ project to be jobserver-aware and compile in parallel via distcc with ccache, spawning multiple local distccd agents to simulate a distributed build. Ensure sub-makes share the jobserver tokens, utilize all CPU cores, and emit a build log proving compilation fanned out across the agents.',
  NULL,
  ARRAY['parallel', 'distributed', 'compilation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Build Troubleshooting & Repair',
  'Build Output Validation',
  'Diagnose and correct a Go (1.22) project''s build settings so it outputs a fully static, reproducible binary. Validate by ensuring ldd reports ''not a dynamic executable'', readelf shows no INTERP or NEEDED entries, and two builds with identical SOURCE_DATE_EPOCH have identical SHA-256 hashes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Build Output Validation',
  'Fix a CMake-based project that embeds absolute RPATHs causing the installed executable to fail when moved. Reconfigure and rebuild to emit $ORIGIN-relative RUNPATH for bundled shared libraries, then validate by relocating the install tree, executing the binary, and confirming via readelf/ldd that no absolute paths remain.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Build Output Validation',
  'Repair a CMake-based C shared library that leaks internal symbols and lacks proper SONAME/versioning by enforcing hidden visibility and a GNU ld version script. Validate that the built lib has SONAME libfoo.so.1 and exports only the intended API symbols under version FOO_1.0 (checked via nm/readelf) and that a minimal client links and runs successfully.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Build Output Validation',
  'Repair a CMake-based build so the produced shared library is libvector.so.3 with an exact exported symbol set matching /app/exports.txt, no undefined symbols, no RUNPATH/RPATH, and the correct SONAME. Validate by diffing nm -D --defined-only against the reference, checking readelf -d for SONAME/RPATH, and building a tiny client that links dynamically and prints a known checksum to confirm ABI correctness.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Fix a CMake-based C++ project where building a shared plugin fails to link due to a vendored static library compiled without -fPIC (relocation against .text/.rodata). Reconfigure the build to rebuild that static library with POSITION_INDEPENDENT_CODE and correct link interface so the plugin links and a provided dlopen smoke test runs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Compiler & Linker Errors',
  'Repair a CMake-based C++17 project that fails to link a shared library due to non-PIC static dependencies and missing OpenMP/filesystem linkage. Rebuild static libs with -fPIC (or use shared), enable OpenMP via CMake and conditionally link stdc++fs for older GCC, set $ORIGIN rpath, and validate by running a threaded test that dlopens the library.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Configuration & Environment Issues',
  'Repair a Java Maven project that fails because it requires JDK 11 via the maven-toolchains-plugin but the environment defaults to JDK 17, by installing/selecting the correct JDK and configuring ~/.m2/toolchains.xml plus JAVA_HOME/PATH so mvn -B -DskipTests package succeeds without changing pom.xml. Verify by printing the javac -version used and running the built JAR to confirm it targets Java 11.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build Troubleshooting & Repair',
  'Dependency & Compatibility Issues',
  'Repair a Maven-based Java project that fails to build on JDK 21 due to incompatible plugin/dependency versions (maven-compiler-plugin, animal-sniffer) and javax→jakarta namespace conflicts. Update version pins and dependency exclusions so mvn -DskipTests=false verify succeeds and the assembled Spring Boot jar launches and responds on /actuator/health.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Artifact Publishing & Deployment',
  'Build a multi-arch OCI image for the provided service using Docker Buildx, push it to a local registry, then sign it with a locally generated cosign key and attach an SPDX SBOM as an OCI artifact. Verify by pulling the manifest list to confirm both architectures, validating the signature against the public key, reading the SBOM from the registry, and deploying via a digest-pinned Docker Compose file.',
  NULL,
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Continuous Integration & Automation',
  'Artifact Publishing & Deployment',
  'Package a small CLI tool as a Debian .deb and publish it to a locally hosted APT repository served over HTTP. Generate and sign repository metadata, add the repo to sources.list, install the package via apt by name, and verify the installed binary runs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a Bash build script that compiles a small CMake-based library and a Python extension wheel using a fixed SOURCE_DATE_EPOCH and deterministic toolchain/linker flags, then packages outputs into a tarball with a manifest of checksums and build metadata. The script must run tests, reuse a local cache across invocations, and verify reproducibility by proving two consecutive runs produce identical tarball checksums.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Continuous Integration & Automation',
  'Build Script Development',
  'Create a deterministic Bash build script and accompanying CI YAML that build a Rust-backed Python extension (PyO3) into manylinux wheels for CPython 3.11 and 3.12 using maturin, cache Cargo/pip artifacts, run pytest, and place wheels in /app/dist. The pipeline must honor SOURCE_DATE_EPOCH, run in a matrix for linux/amd64 and linux/arm64 via QEMU, and fail on formatting or type-check violations (cargo fmt --check, ruff, mypy).',
  NULL,
  ARRAY['rust', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Continuous Integration & Automation',
  'Build Script Development',
  'Write a portable Bash build script for a CMake-based C/C++ repo that runs a compiler×sanitizer matrix (gcc/clang × none/ASan/UBSan), executes ctest for each, and emits JUnit XML plus Cobertura coverage (gcovr) for gcc builds. The script must read a coverage threshold from a config file, fail the build if unmet, cache builds with ccache, and place all artifacts under /app/artifacts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Continuous Integration & Automation',
  'Build Verification & Reproducibility',
  'Build a provided Go CLI twice in separate working directories and with different PATH orders while enforcing hermetic, reproducible outputs (e.g., -trimpath, -buildid=, vendor-only modules, fixed SOURCE_DATE_EPOCH), then assert the two binaries have identical SHA256 hashes. Only adjust build scripts/configuration without modifying source code, and the task fails on any network access or hash mismatch.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Continuous Integration & Automation',
  'Build Verification & Reproducibility',
  'Configure a Gradle multi-module Java project to produce bit-for-bit reproducible artifacts (JARs and a shaded fat JAR) by normalizing file order, timestamps, and manifest fields, and pinning plugin/wrapper versions. Add a CI shell script that builds twice in isolated workspaces and fails if any artifact checksums differ.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Continuous Integration & Automation',
  'Build Verification & Reproducibility',
  'Convert a multi-module Maven Java project to produce bit-for-bit reproducible JARs by configuring project.build.outputTimestamp from SOURCE_DATE_EPOCH, normalizing MANIFEST entries, and locking dependency versions, then perform two clean builds to verify identical SHA256s for every artifact. The task should fail if any JAR differs or includes non-deterministic metadata such as timestamps, build paths, or environment-specific fields.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Installation & Version Control',
  'Convert a Rust Cargo workspace into a fully pinned, offline build by replacing loose version requirements with exact pins, generating a deterministic Cargo.lock, and vendoring all crates with cargo vendor while wiring .cargo/config.toml to the vendor directory. Verify success by clearing the Cargo registry/cache and building and testing the workspace with cargo --offline to demonstrate no network access is needed.',
  NULL,
  ARRAY['rust', 'testing']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Dependency Installation & Version Control',
  'Diagnose and fix a Go module dependency graph that fails to resolve due to mixed v1/v2+ module paths and a transitive break. Update only go.mod by pinning compatible versions and adding replace directives (including a local path for a provided fork) so that go mod tidy and go build ./... succeed.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Dependency Installation & Version Control',
  'Migrate a JavaScript monorepo to pnpm workspaces and resolve conflicting peerDependencies (e.g., React 18 and TypeScript 5) by editing package.json ranges and adding pnpm.overrides to pin a single compatible set. Generate a deterministic pnpm-lock.yaml, install with a frozen lockfile, and validate by building all packages and running a provided cross-package integration script.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Dependency Installation & Version Control',
  'Resolve peerDependency conflicts in a Yarn v3 Plug''n''Play monorepo by using resolutions and packageExtensions to align versions of React, Webpack loaders, and ESLint plugins. Produce a reproducible install (yarn.lock) and verify the workspace builds and lints successfully under Node 20.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Dependency Resolution & Conflict Fixing',
  'Fix a Rust Cargo workspace that fails to build due to conflicting versions and feature flags among tokio, hyper, and reqwest by aligning version pins and enabling compatible features in Cargo.toml without adding or removing dependencies. Ensure cargo build --locked succeeds across all workspace members with the provided toolchain.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Dependency Management',
  'Lockfile & Manifest Maintenance',
  'In a Rust workspace with crates using branch-based git and wildcard semver dependencies, pin each to exact versions and commit SHAs in Cargo.toml and regenerate a deterministic Cargo.lock. Verify reproducibility by building with cargo build --frozen in a clean state, ensuring no yanked or platform-specific mismatches remain in the lockfile.',
  NULL,
  ARRAY['rust', 'git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Lockfile & Manifest Maintenance',
  'Regenerate deterministic lockfiles for a polyglot monorepo—Python (pip-compile with --generate-hashes), Node (npm@10 package-lock v3), and Rust (Cargo.lock)—replacing version ranges with exact pins and eliminating platform-specific drift. Verify by performing two clean, offline installs that yield byte-for-byte identical dependency trees and checksums.',
  NULL,
  ARRAY['python', 'rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'Lockfile & Manifest Maintenance',
  'Regenerate fully hashed requirements.txt and requirements-dev.txt from a pyproject.toml that includes extras and environment markers, using pip-tools pinned to Python 3.11 and honoring an existing constraints.txt without pulling in optional extras. Verify that pip install --require-hashes succeeds entirely offline from the provided wheelhouse and fails if any dependency would need the network.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Dependency Management',
  'System vs. Project Dependency Isolation',
  'Build OpenSSL 1.1.x from source into a project-local prefix and compile a provided C utility to link exclusively against it (not the system OpenSSL), embedding an rpath to the local lib directory. Prove isolation by showing ldd resolves libssl/libcrypto from the project prefix and the program prints the 1.1.x version while the system ''openssl version'' remains unchanged.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'System vs. Project Dependency Isolation',
  'Initialize an R project with renv to create a project-local library and lockfile, installing specific versions of data.table and ggplot2 that differ from the system-wide packages. Run the provided R script using the isolated library and verify at runtime that .libPaths()[1] resolves to the renv project path, not the system library.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency Management',
  'System vs. Project Dependency Isolation',
  'Pin a per-project Rust toolchain via rust-toolchain.toml and vendor all Cargo dependencies into ./vendor, configuring .cargo/config.toml so the crate builds fully offline without touching global cargo/rustup caches. Verify isolation by clearing ~/.cargo and ~/.rustup, setting CARGO_HOME to a temp dir, disabling network, and successfully building and running the tests.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Language & Ecosystem-Specific Build Management',
  'C/C++ & Systems Builds',
  'Build a versioned shared library (e.g., libmathshim.so.1.0) with a proper SONAME and install a matching pkg-config file, then compile a consumer executable that discovers it via pkg-config and embeds a $ORIGIN-based RUNPATH for relocatable execution. Verify by relocating the bin and lib into a new directory tree and demonstrating the program runs and ldd shows RUNPATH without needing LD_LIBRARY_PATH.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Language & Ecosystem-Specific Build Management',
  'C/C++ & Systems Builds',
  'Configure a CMake-based C project to produce bit-for-bit reproducible builds by enabling deterministic archives and stripping build paths (e.g., SOURCE_DATE_EPOCH, ar D, -ffile-prefix-map/-fdebug-prefix-map) with split DWARF. Build twice in different directories and verify identical SHA-256 digests while ensuring no absolute build paths remain in the binary.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Language & Ecosystem-Specific Build Management',
  'C/C++ & Systems Builds',
  'Create a CMake superbuild that compiles vendored zlib and libpng via ExternalProject_Add and then builds a C++ CLI (pngdim) that links them. Ensure correct SONAME and RUNPATH so the produced binary runs in the sandbox and transforms a provided PNG to /app/out.png with an expected SHA256.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Language & Ecosystem-Specific Build Management',
  'Java & JVM-Based Builds',
  'Configure and build a mixed-language (Java + Kotlin) multi-module Maven project using toolchains to compile one legacy module with JDK 8 and the rest with JDK 17, wiring Lombok and MapStruct as annotation processors on the correct processor path. Produce a deterministic, shaded CLI artifact with relocated dependencies and attached sources/javadoc, publish to the local Maven repository, and verify by building and running a tiny consumer project that imports the library and executes the CLI.',
  NULL,
  ARRAY['java', 'rest']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Language & Ecosystem-Specific Build Management',
  'Rust/Go/Other Modern Toolchains',
  'Create a reproducible offline build for a Rust workspace by using cargo vendor and [patch.crates-io] to pin a dependency to a specific git revision, then compile the project for both x86_64-unknown-linux-gnu and wasm32-unknown-unknown using wasm-bindgen with TypeScript bindings emitted to fixed output paths. Validate by running native cargo tests and a Node.js script that loads the generated WebAssembly to confirm an exported function returns the expected value.',
  NULL,
  ARRAY['rust', 'git', 'typescript']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Language & Ecosystem-Specific Build Management',
  'Rust/Go/Other Modern Toolchains',
  'Refactor a provided multi-crate Rust project into a Cargo workspace, vendor all dependencies with cargo vendor, and configure .cargo/config.toml so the project builds fully offline. Cross-compile a static x86_64-unknown-linux-musl release binary with feature "cli" (default-features=false) and verify by running cargo test --workspace and executing the binary to emit a deterministic SHA256.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Language & Ecosystem-Specific Build Management',
  'Rust/Go/Other Modern Toolchains',
  'Vendor all crates for a multi-crate Rust workspace and configure Cargo for a fully offline build using a provided local registry mirror; resolve a feature-induced dependency graph conflict without adding or removing crates, then cross-compile the workspace for x86_64-unknown-linux-gnu and wasm32-wasi. Run tests for the native target, execute the WASI binary with wasmtime to verify expected stdout, and write artifact sizes and resolved crate versions to /app/build-metadata.json.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Build & Dependency Management',
  'Release Engineering & Version Control Integration',
  'Branch-Based Build Rules',
  'Create a Git-aware build pipeline for a small CMake project where branch names control behavior: main builds produce a reproducible, stripped, LTO-enabled tarball with SBOM and version from the latest tag; release/* builds append -rcN; feature/* builds are debug, include an experimental module, and are blocked from publish. Validate by switching branches/tags to confirm artifact names, embedded --version/--info metadata, and that publish is refused on feature/*.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Release Engineering & Version Control Integration',
  'Branch-Based Build Rules',
  'Create a Git-backed project whose Makefile/build script alters outputs by branch/tag: main and tags v* produce stripped, versioned release tarballs; staging builds include debug symbols and a visible STAGING banner; feature/* builds emit -SNAPSHOT artifacts and block the release target. Enforce these rules via branch-aware build logic and lightweight Git hooks/CI entrypoints, with tests that checkout branches/tags and verify artifact names, flags, and refusal behavior.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Release Engineering & Version Control Integration',
  'Branch-Based Build Rules',
  'Implement a Git-aware Makefile for a Rust CLI that enforces branch-specific builds: main produces a stripped LTO release with version from the latest tag and a sha256 checksums.txt; staging enables a telemetry-staging feature and adds an -rc suffix; feature/* appends +branch.sha and writes to /app/dist/feature, while release/* fails if Cargo.toml version doesn’t match the tag. The harness will check out different branches and verify artifact names, --version output, and the presence of checksums only on main.',
  NULL,
  ARRAY['git', 'rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Release Engineering & Version Control Integration',
  'Signed & Verified Builds',
  'Implement a release pipeline that signs the vX.Y.Z Git tag and a SHA256SUMS file with GPG, builds a binary embedding git describe/commit hash, and provides verify.sh to validate the tag signature, the embedded version against the tag, the checksum signature, and the artifact hashes. The task must detect and fail on any tampering with either artifacts or checksums.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Release Engineering & Version Control Integration',
  'Signed & Verified Builds',
  'Implement a release workflow that only builds from an annotated, GPG-signed git tag: produce a deterministic git-archive tar.gz, compute SHA256SUMS, and create detached ASCII-armored signatures for both the tarball and the checksum file using a provided maintainer key. Import only the supplied public key to verify the tag signature and both artifact signatures; emit to /app/dist only if all verifications succeed and the archive reproduces bit-for-bit under a fixed SOURCE_DATE_EPOCH.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Release Engineering & Version Control Integration',
  'Version Tagging & Release Automation',
  'Implement a repo-local release automation that, using Conventional Commits, calculates the next semantic version since the last git tag, updates version fields in both package.json and pyproject.toml, regenerates CHANGELOG.md, creates an annotated tag, and produces tarball artifacts with a SHA256SUMS file. Validate by seeding example commits, invoking the release script twice, and asserting that tags, changelog sections, and checksums match expected outputs.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Artifact Generation & Packaging',
  'Convert the provided Java library into an OSGi-compliant bundle and produce reproducible release artifacts: the main .jar with correct Bundle-* MANIFEST headers plus -sources.jar and -javadoc.jar. Publish them to a local Maven repository and verify a sample consumer project resolves the bundle and that bnd/osgi-info validates the metadata.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Artifact Generation & Packaging',
  'Develop a small C library using CMake with correct SONAME/versioned symlinks and a pkg-config .pc file, then produce release artifacts: a tar.gz containing headers and the shared library and distribution packages (.deb and .rpm) splitting runtime and -dev contents. Validate by building and running a tiny consumer program that uses pkg-config to link against the installed package and confirms the correct SONAME is loaded at runtime.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Build System Configuration',
  'Configure a CMake/Ninja project to run a two-stage Profile-Guided Optimization workflow: first build instrumented binaries and execute a provided training script to generate profiles, then rebuild using those profiles to emit an optimized executable at a fixed path. Verify that the profile was consumed (via build logs/artifacts) and that the optimized binary demonstrates a measurable runtime improvement over a baseline build.',
  NULL,
  ARRAY['optimization']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cross-compile a CGO-based Go CLI that embeds SQLite into static binaries for linux/amd64, linux/arm64, linux/riscv64, and windows/amd64 using zig as the cross C compiler/linker. Verify by running the riscv64 binary under qemu-user to execute a SQL query and confirming the Windows PE binary via wine or PE header inspection outputs the exact expected result.',
  NULL,
  ARRAY['sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Cross-Compilation & Multi-Platform Builds',
  'Cross-compile a provided C/C++ utility into static aarch64 and riscv64 Linux binaries using a musl-based toolchain (e.g., Zig as cc). Validate by running both under qemu-user to process the same input and write matching SHA256 output hashes to a verification file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Cross-Compilation & Multi-Platform Builds',
  'Cross-compile a provided Rust CLI into x86_64-unknown-linux-musl and aarch64-unknown-linux-musl static binaries plus an x86_64-pc-windows-gnu .exe using cargo with the appropriate cross-linkers. Verify outputs by running the native binary directly, the aarch64 binary under qemu-aarch64, and the Windows .exe under wine, asserting exact stdout including the embedded target triplet in --version.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Cross-Compilation & Multi-Platform Builds',
  'Cross-compile the provided CMake-based CLI to produce three artifacts: x86_64-linux-musl (fully static), aarch64-linux-gnu, and x86_64-w64-mingw32. Verify correctness by inspecting ELF/PE headers and running the ARM64 build under qemu-aarch64 and the Windows build under wine, ensuring the musl binary has no glibc dependency and all builds honor a fixed SOURCE_DATE_EPOCH.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Manual Compilation',
  'Manually compile a modular Java application using javac, then assemble a minimized custom runtime image with jlink that runs the app without relying on a system JRE. Validate the image by launching the program and confirming only required modules are included with debug symbols and locales stripped.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Source Compilation & Build Systems',
  'Manual Compilation',
  'Perform a two-phase profile-guided optimization build of the C program in /app/pgotask: first compile with -fprofile-generate and run it over the input corpus in /app/corpus to emit profiles, then recompile with -fprofile-use to produce /app/bin/app_pgo. Verify by timing both pre- and post-PGO binaries on the same workload and writing the speedup and file sizes to /app/pgo_report.txt.',
  NULL,
  ARRAY['optimization']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a pipeline that scans /app/logs for mixed-format Apache/Nginx logs (plain, .gz, .bz2, .zst), parses into a normalized schema, enriches with country and ASN via provided lookup CSVs, applies prefix-preserving IP anonymization, and outputs a SQLite database plus per-day aggregates (CSV and Parquet).',
  NULL,
  ARRAY['database']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'ETL (Extract-Transform-Load) Workflows',
  'Create a script that ingests mixed Apache/Nginx logs under /app/logs, normalizes timestamps to UTC, de-duplicates requests, and stitches events into user sessions using IP+User-Agent with a 30-minute inactivity threshold. Load results into /app/sessions.db (SQLite) with sessions and events tables, and write /app/landing_pages.csv listing the top 10 landing pages with session counts and bounce rate.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'ETL (Extract-Transform-Load) Workflows',
  'Create a script that ingests mixed-format web server access logs from /app/logs (plain .log, .gz, .bz2 in Common/Combined Log Format), parses and normalizes timestamps to ISO-8601 UTC, enriches with country via /app/GeoLite2-Country.mmdb, and de-duplicates by (ip, timestamp, request). Write partitioned, snappy-compressed Parquet files with a fixed schema to /app/out/year=YYYY/month=MM/day=DD.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'ETL (Extract-Transform-Load) Workflows',
  'Implement an idempotent incremental ETL that extracts customer transactions from CSV files in /app/inbox/, newline-delimited JSON in /app/stream/, and a local mock REST endpoint, normalizes timestamps/timezones and converts currencies to USD using a provided FX rates file, and de-duplicates near-duplicates. Load results into a SQLite star schema, persist a checkpoint so only new or changed data is processed on re-run, and write a data-quality report of nulls, duplicate keys, and outliers to /app/reports/.',
  NULL,
  ARRAY['rest']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'Pipeline Orchestration',
  'Create a tiny DAG runner that reads /app/dag.yaml and executes a 5-stage local ETL (extract, normalize, dedupe, aggregate, report) with dependency-aware incremental rebuilds using content hashes, per-task timeouts/retries, max-parallelism, and a dry-run mode. The harness mutates a single source file and expects only downstream nodes to re-run, emitting updated outputs plus a provenance log and a DOT graph of the executed sub-DAG.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'Python/Perl/Ruby Scripting',
  'Write a Python script that reads a workflow YAML at /app/workflow.yaml defining tasks (id, command, deps, env, max_retries, timeout), executes the DAG in dependency order with retries/timeouts, and captures per-task stdout/stderr to /app/logs/<id>.log. Output /app/report.json summarizing each task’s status (success/failed/skipped), attempt count, start/end timestamps, exit code, and a topologically sorted execution list.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create two Bash scripts: backup.sh performs idempotent, incremental backups of /app/data into date-stamped snapshots using rsync --link-dest with per-snapshot SHA256 manifests and a flock-based lock; prune.sh enforces a configurable GFS retention policy, verifies snapshot integrity before deletion, and writes a JSON report of kept/removed snapshots and verification results.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create two cron jobs: one runs every 10 minutes to promote ''stable'' CSVs from /app/incoming to /app/staging (unchanged for ≥90s), the other runs at 00:05 UTC to consolidate all staged CSVs into a deduplicated, timestamp-sorted daily report at /app/reports/YYYY-MM-DD.csv.gz. Use flock to prevent overlaps, write last-run metadata as JSON to /app/status.json, and provide a one-shot script to trigger both jobs immediately for verification.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'Task Scheduling & Cron Jobs',
  'Set up a cron-orchestrated ETL with three scripts: every 2 minutes ingest and idempotently upsert JSON files from /app/inbox into SQLite, hourly export a rolling 24h metrics CSV to /app/out/report.csv and prune old rows, and daily rotate/compress processed inputs to /app/archive. Enforce flock-based locking, CRON_TZ=UTC, and a catch-up mechanism that detects downtime and replays missed windows.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Workflow Scripting',
  'Task Scheduling & Cron Jobs',
  'Write a backup script that snapshots /app/db.sqlite to /app/backups as timestamped compressed files, retaining the last 7 daily and last 4 Sunday weekly backups. Install a cron.d entry to run it at 02:17 UTC daily with flock-based locking and append-only logging to /app/backup.log.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a script that ingests mixed-format web access logs (CSV and JSONL), normalizes them to a single schema, sessionizes requests per client with a 30-minute inactivity timeout, and computes per-session aggregates (request count, duration, total bytes). Output a compact session table and a brief text summary with top landing paths and percentile session lengths.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Aggregation & Reduction',
  'Create a terminal pipeline that scans /app/logs for web-event files in CSV, JSONL, and .jsonl.gz, normalizes fields (utc_ts, user_id, url, status, bytes), and computes 5-minute rollups with totals, distinct users, bytes p50/p95/p99, and the top-3 URLs by count. Write /app/rollup.parquet and /app/top_urls.csv, and support an incremental mode that updates only new windows using /app/watermark.txt.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Data Merging & Joins',
  'Create a script that merges a product catalog CSV (product_id, sku, upc), a price events NDJSON (sku, price, timestamp), and a UPC alias TSV by normalizing UPCs and resolving aliases to canonical IDs, then joining on sku/upc. Output a consolidated CSV per product_id with latest price and count of price events, plus an unmatched.csv listing any price events that could not be linked.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Data Merging & Joins',
  'Create a script that merges an Apache access_log (CLF/combined) and an application event stream (JSON Lines) into a single CSV by first joining on a shared request_id when available; if absent, fall back to the nearest timestamp within ±2 seconds for the same client IP and URL path, and mark which join strategy was used. Output must contain one row per web request with selected fields from both sources and unmatched records discarded.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Data Merging & Joins',
  'Create a script that merges three datasets—orders.csv, refunds.csv, and chargebacks.jsonl—into a single per-order report by joining on order_id (exact) and de-duping conflicting events by the latest event_timestamp. Compute each order’s final_status (Pending/Fulfilled/Refunded/Chargeback) and net_amount, and write a sorted CSV with a fixed header.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Data Merging & Joins',
  'Create a script that performs a temporal as-of join across three datasets—ad impressions (CSV), clicks (JSONL), and conversions (Parquet)—to attribute each conversion to the most recent prior click (≤7 days) and impression (≤24 hours before the click) for the same user_id with deterministic tie-breaking. Write a unified Parquet with attribution fields and a JSON report listing conversions with ambiguous or missing joins.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Data Merging & Joins',
  'Join network event logs with IP ownership datasets by performing longest-prefix-match containment over IPv4/IPv6 CIDR ranges, resolving overlaps via most-specific prefix and source priority. Produce an enriched events output annotated with org/asn and a summary report of per-org counts and unmatched coverage.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Filtering & Selection',
  'Implement a command-line tool that reads one or more COCO-format annotation JSONs in /app/dataset and filters annotations to categories listed in /app/categories.txt while enforcing bbox area and score thresholds from /app/filter.yaml, dropping any now-orphaned images. Output a pruned COCO JSON with deterministically ordered, remapped contiguous ids and a newline manifest of kept image file paths.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Filtering & Selection',
  'Write a script that scans /app/logs for Apache/Nginx access logs (plain text and .gz), filters entries whose client IP falls within any CIDR in /app/eu_cidrs.txt, whose request path matches any pattern in /app/paths.txt, and whose status is 2xx. Output /app/filtered.csv with ISO8601 timestamp, ip, method, and path, deduplicated per ip+path within rolling 10‑minute windows.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI that scans /app/datasets for CSV/TSV and JSONL files with mixed encodings, delimiters, header spellings, and timestamp/number formats; auto-detects encoding and delimiter, canonicalizes Unicode (NFKC), maps header synonyms to a target schema (user_id, event, ts_utc, amount), and standardizes timestamps to ISO 8601 UTC and numbers to dot-decimal, writing RFC4180 UTF-8 CSVs to /app/normalized. Emit /app/audit.json summarizing per-file detection results, header mappings, and counts of fixed/dropped rows with a small before/after sample of transformed values.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Normalization & Standardization',
  'Create a script that ingests a mixed-format coordinate dataset (DMS strings, decimal degrees with hemisphere letters, and UTM zones) and normalizes all positions to WGS84 latitude/longitude in signed decimal degrees with fixed precision. Validate ranges, correct common notations (e.g., stray hemisphere suffixes), and emit a clean, standardized output with a report of any unresolvable rows.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Normalization & Standardization',
  'Create a script that ingests mixed CSV/JSON sensor datasets from /app/data where numeric values include heterogeneous units and localized formats (e.g., 72F, 21.1 °C, 55 mph, 24,6 m/s, 1 234.5). Normalize all measurements to SI units with canonical float types and ISO 8601 UTC timestamps, then emit a unified standardized Parquet and a normalization report summarizing per-field conversions, unit assumptions, and any imputations or drops.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Normalization & Standardization',
  'Create a script that scans /app/data for CSV/TSV/JSON product records and outputs /app/normalized.csv with sku, weight_g, length_mm, width_mm, height_mm, price_usd, and updated_at (UTC ISO-8601). It must normalize unit‑labeled values (g/kg/lb/oz; mm/cm/in/ft), localized numbers (commas, spaces), and currencies (using /app/rates.json), converting all timestamps to UTC and writing irrecoverable rows with reasons to /app/errors.csv.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Normalization & Standardization',
  'Create a script that scans /app/logs for mixed-format logs (Apache, syslog, JSON), normalizes all timestamps (including timezone and epoch forms) to ISO 8601 UTC (Z) and standardizes severity to a fixed set [DEBUG, INFO, WARN, ERROR, FATAL] while lowercasing hostnames. Emit a single JSON Lines file at /app/normalized_logs.jsonl with a consistent schema and entries sorted strictly by timestamp.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a command-line script that ingests time-series CSV files in /app/sensors, normalizes ISO-8601 timestamps, and detects per-sensor outliers using median absolute deviation plus sanity checks (negative values where forbidden, duplicated timestamps, and sudden step changes). Output cleaned CSVs to /app/cleaned, append all flagged rows with reason codes to /app/anomalies.csv, and write a per-file summary to /app/report.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Outlier & Error Detection',
  'Create a script that ingests /app/readings.csv of IoT telemetry and writes /app/clean.csv plus /app/anomalies.csv, flagging schema/plausibility errors (invalid UTF-8, column count, status not in {OK,WARN,FAIL}, out-of-range temp/humidity/battery, duplicate device_id+timestamp, and non-monotonic timestamps per device). Additionally, mark statistical outliers in temperature per device using a 1-hour rolling median with MAD-based thresholds and annotate anomalies with semicolon-separated reason codes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Outlier & Error Detection',
  'Create a script that ingests GPX/CSV GPS tracks, normalizes timestamps and coordinate formats, and flags/removes points that imply impossible speeds, large teleports, or non-monotonic time. Output cleaned tracks and an anomalies report summarizing each file’s discarded points and reasons.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Cleaning & Transformation',
  'Outlier & Error Detection',
  'Write a script that scans /app/trips/*.csv (columns: trip_id, device_id, timestamp, lat, lon, odometer_km) to detect geospatial and temporal anomalies such as impossible speeds via haversine distance/time, out-of-bounds coordinates, non-monotonic timestamps per device, duplicate trip_ids, and odometer regressions. Output anomalies.jsonl with one record per issue (including a machine-readable reason and fields) and cleaned_trips.parquet with all offending rows removed.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI tool that scans /app/data for CSV, JSONL, or Parquet files and writes profile.json containing per-column summaries (type, non-null count, distinct≈HLL, min/max, mean, median, std, p5/p25/p50/p75/p95) and fixed-bin histograms for numeric fields; if a timestamp column exists, also output hourly counts. Emit a stratified 1% sample that preserves rare categories to /app/sample.ndjson.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Sampling & Exploration',
  'Descriptive Statistics & Summaries',
  'Create a streaming profiler that scans all CSV and JSONL (including .gz) files under /app/data and produces per-column summaries: non-null count, distinct count (case-insensitive), min, max, mean, median, and p95 for numeric fields, and top 5 categories with frequencies for non-numeric fields. Write a consolidated report to /app/profile.csv and a machine-readable /app/profile.json, handling mixed schemas across files and locale-formatted numbers (commas and decimals).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Sampling & Exploration',
  'Sampling & Subsetting',
  'Create a CLI script that, given customers.csv, orders.csv, and order_items.csv, produces a reproducible 1% per-month stratified sample of orders via deterministic hashing, then emits subsetted CSVs for all three tables that include only rows linked to sampled orders while preserving referential integrity and original column order. Additionally, write a summary manifest reporting per-month sample rates and total rows kept per table.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Sampling & Exploration',
  'Sampling & Subsetting',
  'Create a script that builds a deterministic, stratified sample of a normalized CSV dataset in /app/data (e.g., users, orders, order_items, events) by selecting users proportionally across country and signup cohort using a seed from /app/seed.txt and including only their related rows. Output referentially complete subset CSVs to /app/sample and a manifest with per-stratum counts and basic distribution checks.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Sampling & Exploration',
  'Visualization & Reporting (CLI-based)',
  'Implement a script that reads /app/events.csv with timestamps and categories, performs stratified reservoir sampling to bound memory, and generates an ASCII calendar heatmap of daily activity for the last month plus a per-category horizontal bar chart of counts. Write a single human-readable report to /app/report.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Sampling & Exploration',
  'Visualization & Reporting (CLI-based)',
  'Write a script that profiles a mixed dataset directory (CSV, JSONL, Parquet), performs deterministic sampling, infers column types, and generates a single CLI report with ASCII histograms for numeric columns, a character-based missingness heatmap by column, and top-k value tables for categoricals. Output the human-readable report to /app/profile.txt with sections per file and columns sorted by variability.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integrity Checks & Diffs',
  'Build a tool that compares two release artifacts (e.g., .tar.gz vs .zip) for content-equivalence by extracting, normalizing metadata (timestamps, owners, entry order), and normalizing text EOL for .txt/.md before computing per-file hashes and a directory Merkle root. Emit a machine-readable JSON report of added/removed/changed/renamed files and permission-only changes, optionally validating against a provided manifest.json and exiting nonzero on drift.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Integrity Checks & Diffs',
  'Create a CLI that compares two mixed-format dataset snapshots at /app/v1 and /app/v2 using rules from /app/rules.yaml: JSON compared semantically (ignoring key order/whitespace), CSV diffed by declared primary keys, text normalized for EOL/encoding, and binaries by SHA256. Emit a single /app/diff_report.json summarizing added/removed/modified records/files and exit non‑zero if any change violates the allowlist rules.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Integrity Checks & Diffs',
  'Create a script that compares dataset snapshots at /app/stage_a and /app/stage_b by canonicalizing contents (CSV normalized by a configured primary key from /app/diff_config.toml; JSON/JSONL with sorted keys) and computing content checksums per file. Write /app/diff_report.json listing added/removed files, checksum mismatches, and for changed CSVs counts of added/removed/modified rows keyed by the primary key.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Integrity Checks & Diffs',
  'Implement a CLI that compares two dataset snapshots in /app/snap_a and /app/snap_b, verifies SHA-256 integrity, and classifies per-table differences as identical, row-reordered-only, or content-changed across CSV and Parquet files. Detect renamed files by matching content hashes and write /app/changes.json (added/removed/modified/moved with reasons) and /app/violations.txt (checksum failures).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a script that merges CSV enrollment files in /app/enrollments and validates against /app/students.csv, deduplicating repeated registrations (same student_id, course_id, term) and flagging registrations with missing or unknown student_ids. Output a cleaned /app/enrollments_clean.csv plus /app/duplicates.csv (grouped duplicate sets with source filenames) and /app/missing.csv (rows with null or unmatched keys).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Missing & Duplicate Detection',
  'Implement a script that scans mixed-format contact datasets in /app/data (CSV and JSONL), normalizes them to a common schema, detects duplicates via canonicalized emails plus approximate name matching, and flags rows with missing required fields. Output a deduplicated clean_contacts.csv, a duplicates_report.json with cluster details and chosen canonical records, and a missing_summary.csv of per-column missing counts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Missing & Duplicate Detection',
  'Write a script that ingests all headered CSVs in /app/logs/daily with fields sensor_id,timestamp,value, deduplicates rows by the (sensor_id,timestamp) key across files, and emits a consolidated /app/clean.csv sorted by sensor_id then timestamp. For each sensor, detect missing 1-minute intervals between its min and max timestamp, insert placeholder rows with empty value for gaps, and produce /app/quality_report.json summarizing per-sensor duplicates removed and gaps inserted.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Regression Testing for Data Outputs',
  'Create a regression harness that compares two pipeline outputs in /app/run_prev/ and /app/run_new/ (CSV or Parquet): verify identical table set, column order and types against /app/schema.json, per-partition row counts and key-level checksums match, and numeric aggregates stay within tolerances from /app/thresholds.toml. Emit a JUnit-style XML report to /app/results.xml and exit non-zero on any failure.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Regression Testing for Data Outputs',
  'Create a script that compares /app/baseline and /app/candidate outputs across matching CSV or NDJSON files by joining records on id (order-insensitive), enforcing schema compatibility (no removed columns) and comparing numeric fields within a configurable tolerance while ignoring volatile fields like updated_at. Write a summary to /app/regression_report.txt and exit non-zero on missing/extra rows, type changes, or values outside tolerance.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Regression Testing for Data Outputs',
  'Implement a CLI that compares new aggregation outputs in /app/current/*.parquet to golden snapshots in /app/baseline/*.parquet using /app/spec.yaml to define composite key columns and per-column rules (exact for categoricals, relative/absolute tolerances for numerics, allowed new columns). Align by keys, flag missing/extra keys, schema narrowing, null-rate increases, and tolerance violations; write /app/report.txt and /app/report.json and exit non-zero on any failure.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI script that validates all NDJSON event files in /app/events against /app/schema.json (JSON Schema draft-2020-12), enforcing required fields, types, enum values, and custom formats (uuid, email, RFC 3339 timestamps). Coerce only lossless type fixes (e.g., numeric strings to numbers), write all valid records to /app/validated/merged.ndjson, emit a line-level error report to /app/invalid_report.json for rejects, and exit non-zero if any record fails.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Validation & Quality Assurance',
  'Schema & Type Validation',
  'Create a script that validates all records in /app/events/*.ndjson against /app/schema.json plus extra rules (user_id must be UUIDv4, timestamp ISO 8601 and not in the future, amount nonnegative with currency-specific decimal precision). Output /app/validation_report.csv with line_number,error_code,field,message for all failures and /app/valid.ndjson containing only canonicalized, schema-conforming records.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Data Processing & Scripting',
  'File Parsing & Format Conversion',
  'Encoding & Compression',
  'Create a CLI that recursively scans /app/input for text files, auto-detects encoding (e.g., UTF-8/UTF-16/Windows-1252/Shift-JIS), converts them to UTF-8 with LF newlines in /app/normalized, then builds a reproducible tar.zst archive with sorted entries and fixed metadata. Output a manifest.csv listing original path, detected encoding, original/normalized sizes and SHA256 hashes, and support a verify mode that extracts the archive and validates checksums against the manifest.',
  NULL,
  NULL
);

-- Batch 2 complete (200 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Data Processing & Scripting',
  'File Parsing & Format Conversion',
  'Encoding & Compression',
  'Create a script that reassembles a split ZIP in /app/parts (dataset.zip.001, .002...), verifies integrity, and extracts its contents. Auto-detect and convert all text files to UTF-8 with LF line endings (leaving binaries unchanged), then repack the normalized tree into a deterministic /app/normalized.tar.xz with sorted entries, fixed timestamps/permissions, and write a SHA-256 manifest to /app/manifest.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Encoding & Compression',
  'Create a script that scans /app/inbox for .eml or mbox files, decodes MIME parts (base64 and quoted-printable) while honoring per-part charsets (UTF-8, ISO-8859-1, Windows-1252, UTF-16LE), and extracts only CSV or CSV.GZ attachments. Convert all text to UTF-8 with LF line endings, decompress .gz attachments, deduplicate identical rows, and write a single merged /app/combined.csv.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Encoding & Compression',
  'Create two scripts: one that normalizes a directory by auto-detecting and converting text file encodings to UTF-8 with LF line endings (leaving binaries intact) and then produces a deterministic tar.gz (lexicographic order, fixed uid/gid/uname/gname, mtime from SOURCE_DATE_EPOCH) along with a MANIFEST.sha256 of pre/post hashes. The second script verifies determinism by re-packing and comparing the tarball and manifest, reporting any mismatches.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Encoding & Compression',
  'Implement a script that recursively normalizes a mixed-encoding dataset in /app/inbox: detect each text file’s encoding (BOM-aware; fallback heuristic), convert to UTF-8 without BOM, normalize Unicode to NFC, unify line endings to LF, and transparently gunzip any *.gz logs. Package the result as a deterministic tar.gz at /app/normalized.tar.gz (sorted entries, uid/gid=0, mtime=0) and write /app/manifest.csv summarizing original_path, output_path, original_encoding, original_eol, was_gzipped, bytes_before, bytes_after, and sha256_after.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a CLI script that reads all multi-document YAML files in /app/k8s (resolving anchors/aliases) and converts each document into a normalized JSON object with dot-notated keys, outputting a consolidated JSON Lines file at /app/resources.jsonl. Then convert that JSONL to Parquet at /app/resources.parquet with inferred column types, lexicographically ordered columns, and an added source_filename field.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'File Format Conversion',
  'Create a script that converts a directory of YAML documents that use anchors, aliases, and merge keys into a single NDJSON file, fully resolving all references and merges. Each line must be a canonicalized JSON object with deterministically sorted keys, ISO-8601-normalized timestamps, and an added source field containing the original filename.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'File Format Conversion',
  'Create a script that converts all XML files in /app/input_xml (with multiple namespaces) into YAML files in /app/yaml, representing attributes with an @ prefix, text with _text, preserving child order, and turning repeated tags into sequences. If any element named Data contains base64 text, decode it to /app/blobs/<stem>_<n>.bin and replace the YAML value with the relative blob path.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a CLI script that infers a JSON Schema (Draft 2020-12) from all NDJSON files in /app/samples, unioning fields and types, distinguishing integer vs number, detecting nullability, min/max, enum for low-cardinality strings, and formats (date-time, uuid, email). Validate /app/new_records.jsonl against the inferred schema, writing the schema to /app/schema.json and a newline-delimited list of invalid record indices with short reasons to /app/invalid.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Schema Inference & Validation',
  'Create a command-line tool that scans /app/datasets for mixed CSV and JSONL files, infers a unified typed schema (nullability, unions, enums from low-cardinality strings, and date/time/decimal detection) and emits a JSON Schema Draft 2020-12 file. Validate every record against the schema with a detailed per-file report of failures (row number and reason), and write normalized, UTF-8, type-coerced Parquet outputs conforming to the inferred schema.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Text & Log Parsing',
  'Create a script that scans /app/logs for web access logs in mixed formats (Apache combined, Nginx default, and JSON-lines), including rotated .gz files, normalizes them to a common schema, and writes a timestamp-sorted /app/normalized.ndjson. Then compute per-hour aggregates (requests, unique sessions using a 30-minute inactivity window, 4xx/5xx rates, and P50/P95 latency) and save a 2-space-indented JSON report to /app/traffic_report.json.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File Parsing & Format Conversion',
  'Text & Log Parsing',
  'Ingest mixed-format service logs from /app/services/* (Apache/Nginx text, JSON app logs, and RFC5424 syslog), normalize core fields, and correlate events by request_id to reconstruct per-request timelines and end-to-end latencies. Output traces.jsonl (one record per request with ordered spans and missing-service gaps) and summary.csv with per-endpoint counts, mean, and P95 latency.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File System Operations',
  'Archival & Backup Scripting',
  'Write a command-line script that creates time-stamped snapshot backups of /app/source, using rsync with --link-dest for unchanged files and packing small files (<256 KiB) into a single zstd-compressed tar encrypted with GPG, honoring exclude patterns from /app/.backupignore and preserving permissions, symlinks, xattrs, and ACLs. Implement a restore mode that reconstructs to /app/restore from a chosen snapshot by merging the snapshot tree with the decrypted tarball and verifies integrity against a SHA-256 manifest, pruning old snapshots according to /app/retention.yaml.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a command-line script that scans /app/photos for JPEG/HEIC images, extracts EXIF capture timestamp and camera model, renames each to YYYYMMDD_HHMMSS_{make-model}.{ext} (collisions resolved with _01, _02...), de-duplicates by SHA256 hash, and moves files into /app/library/YYYY/MM/ directories. Produce a CSV at /app/ingest_log.csv listing original_path,new_path,hash,was_duplicate,source_timestamp_used (exif|mtime), and write a JSON summary (/app/summary.json) with counts by camera and month.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File System Operations',
  'Batch File Operations',
  'Write a script that scans /app/incoming for images/videos, extracts capture timestamps from embedded metadata (falling back to file mtime), and batch renames/moves them to /app/library/YYYY/MM/YYYYMMDD_HHMMSS_{counter}.{ext}, keeping sidecar files (.xmp/.srt) in sync. On timestamp collisions, deterministically order and increment the counter without gaps and output /app/manifest.csv mapping old_path,new_path for every moved file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File System Operations',
  'File Discovery & Search',
  'Create a script that recursively scans /app/docs for Markdown files, extracts relative image links (e.g., ![...](./img/foo.png)), and verifies that each referenced file exists (ignoring absolute URLs and anchors). Write a JSON array to /app/missing_images_report.json listing missing references with fields: md_file, line, ref, and resolved_path, sorted by md_file then line.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File System Operations',
  'File Discovery & Search',
  'Scan /app/docs for Markdown files, extract relative image and link targets, canonicalize paths, and compare against the real files under /app/docs (excluding hidden and build artifacts). Write /app/report.json with two sorted arrays: missing_references (referenced but absent) and orphan_files (present but never referenced), using paths relative to /app/docs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'File System Operations',
  'File Discovery & Search',
  'Write a script that recursively scans /app/site, finds all asset files under /app/site/assets (extensions: png,jpg,jpeg,svg,gif,mp3,mp4,pdf,webp) and reports those not referenced by any Markdown/HTML/CSS/JS file in the project. Ignore directories .git, node_modules, dist, and build; output a sorted newline-separated list of orphan paths to /app/orphans.txt.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'API Data Fetching & Posting',
  'Create a command-line script that reads SKUs from /app/skus.csv and an API key from the environment, then queries a paginated inventory/pricing REST API with conditional GETs (ETag/If-None-Match) and backoff for 429 to produce /app/inventory.csv. For any items below the reorder threshold in the input, batch POST a JSON payload to a /reorders endpoint and write the response to /app/reorder_response.json.',
  NULL,
  ARRAY['api', 'rest']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'API Data Fetching & Posting',
  'Write a script that reads /app/cities.txt, fetches the last 48 hours of PM2.5/PM10 per city from a public air-quality API (e.g., Open-Meteo AQ) using curl or Python requests with ETag-based caching and retry-on-429, aggregates per-city min/mean/max, and writes /app/aq_summary.csv. Then POST a signed (HMAC-SHA256) JSON summary to a provided local webhook endpoint and print the returned confirmation ID.',
  NULL,
  ARRAY['api', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Cloud Storage Interaction',
  'Build a policy-driven cross-cloud sync tool that mirrors an AWS S3 prefix to a GCS bucket, preserving Content-Type/Cache-Control and applying include/exclude and rename rules from /app/policy.yaml; use checksum-aware diffing that reconciles S3 ETags (including multipart) with GCS CRC32C/MD5 to avoid redundant transfers. Support dry-run and apply modes, persist a local SQLite manifest for idempotency, and write /app/report.json listing created/updated/deleted/skipped objects and any conflicts.',
  NULL,
  ARRAY['cloud', 'aws']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Cloud Storage Interaction',
  'Write a script that uses AWS CLI against a provided S3-compatible endpoint to perform an idempotent two-way sync between the remote prefix s3://tb-datasets/projects and /app/cache, honoring patterns from /app/.syncignore and verifying integrity via ETag/MD5. Persist object metadata (Content-Type, Cache-Control) to /app/cache/_metadata.json and emit /app/sync_report.txt with counts of added, updated, and removed items; delete locals only when a --prune flag is given.',
  NULL,
  ARRAY['aws']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Database Query & Export',
  'Implement a terminal-run script that reads credentials from environment variables, connects to PostgreSQL and MongoDB, reconciles active users by email with at least one paid order in the last 90 days, and exports a flattened dataset to /app/output/users_aggregate.csv and /app/output/users_aggregate.parquet with deterministic ordering. Provide a PostgreSQL .sql file to create a materialized view and indexes used by the export, and ensure the script uses server-side COPY for CSV and batched streaming for Parquet to support million-row exports.',
  NULL,
  ARRAY['postgresql', 'mongodb', 'sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Data Processing & Scripting',
  'Integration with External Systems',
  'Database Query & Export',
  'Spin up local Postgres and MongoDB with seed data, then implement a CLI script that joins Postgres orders to MongoDB user profiles by user_id, computes 30/60/90-day LTV and signup-month cohorts per acquisition_channel, and exports results to a partitioned Parquet dataset plus a summary CSV. The script must support incremental runs via a persisted watermark (last_order_ts) and perform idempotent upserts of partitions.',
  NULL,
  ARRAY['mongodb']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a Bash script that reads SSH credentials and paths from /app/remote.toml, uploads /app/input/* to a remote server, triggers a Nextflow pipeline there in a detached session, and polls its status until success/failure with a timeout. On completion, download the produced artifacts to /app/output and write /app/run_report.json containing run_id, status, start/end timestamps, and SHA256 checksums for each artifact.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Remote Pipeline Execution',
  'Create a CLI that SSHes into a remote SLURM head node, renders a batch script from a local YAML, submits it with sbatch, and robustly monitors the job by polling squeue/sacct and tailing logs (including retrying if preempted). On completion, scp the results back, verify checksums from a manifest, and write a run_report.json with job ID, final state, runtime, and artifact hashes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Remote Pipeline Execution',
  'Create a CLI that submits a SLURM job array to process CSV shards listed in /app/manifest.json, capturing the sbatch JobID and polling squeue/sacct until every task completes successfully. When done, fetch each task’s output via scp into /app/results, verify SHA256 checksums from the manifest, and merge the outputs into /app/final.parquet in deterministic shard order; exit non-zero if any task fails or times out.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Integration with External Systems',
  'Remote Pipeline Execution',
  'Implement a CLI tool that reads an SSH inventory and a jobs.json describing data partitions, then dispatches a processing script to multiple hosts via rsync+ssh, launches jobs under nohup with a unique run_id, and periodically polls remote status/logs until completion with bounded retries. On success it collects artifacts into /app/results/{run_id} and writes a summary manifest (per-host status, duration, and stderr tail), supporting resume and cancel by run_id.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Markdown/HTML/Text Conversion',
  'Build a command-line tool that migrates a static HTML site in /app/site to a markdown-first repo: convert each article HTML to Markdown with YAML front matter (title/date/tags), mirror images locally and rewrite internal links to .md. Generate index.md as a site map and report.txt listing broken links and missing assets.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Markdown/HTML/Text Conversion',
  'Create a script that compiles a directory of Markdown notes (with YAML front matter and [[WikiLinks]]) into a self-contained HTML site and a JSONL plain-text search index. Resolve {{include:...}} directives, convert wikilinks to relative paths, inline local images as data URIs, and output a broken-link report.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Markdown/HTML/Text Conversion',
  'Create a script that converts all Markdown files under /app/pages into self-contained HTML, rendering fenced mermaid and graphviz code blocks to inline SVG (using mermaid-cli and dot) and converting the remainder via pandoc. It must rewrite cross-file links to .html, preserve front-matter metadata as meta tags, and generate a tag index page from YAML front matter.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Markdown/HTML/Text Conversion',
  'Create a script that scans /app/posts/*.md (with YAML front matter: title, date, tags), converts each to a standalone HTML article in /app/site via pandoc, preserving code fences and rewriting relative links using a BASE_URL. Also generate an Atom feed at /app/site/atom.xml listing the 20 most recent posts with RFC 3339 UTC timestamps, canonical URLs, and a summary taken from the first paragraph.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Data Processing & Scripting',
  'Text & Document Processing',
  'Pattern Extraction & Regex Matching',
  'Create a command-line script that recursively scans /app/logs (including .gz files), uses regular expressions to parse heterogeneous log lines into structured fields (timestamp in multiple formats, level, message) and extract entities (IPv4/IPv6, emails, GUIDs, request/user IDs). Redact PII by masking emails and Luhn-valid credit card numbers with stable pseudonyms, write redacted_logs.ndjson, and output templates.csv by normalizing messages to regex-derived templates (replace numbers/hex/IDs/IPs with placeholders) with aggregated counts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Pattern Extraction & Regex Matching',
  'Create a command-line script that scans all .txt files in /app/contracts for calendar dates written in diverse styles (YYYY-MM-DD, MM/DD/YYYY, DD Mon YYYY, Mon DD, YYYY, DDth of Month ’YY, and ranges like Jan 3–5, 2024) using regexes that handle ordinal suffixes, commas, stray punctuation, and Unicode dashes. Normalize each concrete date to YYYY-MM-DD, expand ranges into individual dates, and write a CSV to /app/contract_dates.csv with columns file,line_number,original_snippet,normalized_date, sorted by file then normalized_date.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Pattern Extraction & Regex Matching',
  'Create a script that scans /app/paper for .tex and .bib files, uses regex to extract citation keys from LaTeX citation commands (handling optional arguments and comma-separated lists), and extracts BibTeX entry keys. Write /app/citation_audit.txt listing ordered unique cited keys, missing citations (cited but absent in .bib), unused .bib entries, and per-file citation counts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Pattern Extraction & Regex Matching',
  'Scan /app/docs for Markdown files and use regex to extract external URLs, bare domain mentions, and email addresses from prose while excluding fenced code blocks and inline code. Also detect reference-style link labels to report undefined and unused labels, writing links.csv (type,value,first_file,count) and ref_audit.txt with the findings.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Report & Document Generation',
  'Generate release notes by parsing a Git repo at /app/repo using Conventional Commits, producing /app/RELEASE_NOTES.md and a machine-readable /app/release.json for the latest tag range (or last 50 commits if no tags). Categorize entries by type and scope, detect BREAKING CHANGE footers, count contributors, and convert issue/PR references (e.g., #123) into links.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Report & Document Generation',
  'Implement a script that scans Nginx-style logs in /app/logs/*.log and a release timeline in /app/releases.json to detect outage windows where per-minute 5xx response rate exceeds a given threshold and attribute each window to the nearest release. Generate a Markdown incident report (/app/incident_report.md) with a timeline and a CSV (/app/incident_windows.csv) with start,end,duration,peak_rate,top_errors,release_sha, sorted chronologically.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Data Processing & Scripting',
  'Text & Document Processing',
  'Template Rendering & Macro Expansion',
  'Create a CLI that renders Jinja2 templates in /app/templates using layered variables from /app/config/base.yaml, /app/config/env/*.yaml, and /app/config/secrets.json, and for each locale in /app/locales.csv merges the matching /app/i18n/<locale>.yaml. It must support simple macros for pluralization and date formatting, fail on unresolved placeholders, emit outputs to /app/build/<locale>/ preserving paths, and write /app/build_manifest.json listing each file with its locale and SHA256.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Template Rendering & Macro Expansion',
  'Create a script that renders all Jinja2 templates under /app/templates to /app/build using layered variables from /app/defaults.yaml, environment variables, and optional per-template .vars.yaml files (per-template > env > defaults), preserving directory structure and failing on undefined variables. Implement custom filters slug (kebab-case) and sha256_file(path under /app/assets), support {% include %}, and write a manifest.json in /app/build listing each output and its SHA-256.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text & Document Processing',
  'Template Rendering & Macro Expansion',
  'Implement a preprocessor that renders a set of .tmpl files into environment-specific configs by expanding user-defined macros, {{ENV_VAR}} placeholders, and conditional blocks from a vars.yml inventory, with nested include support and cycle detection. Output dev, staging, and prod variants to /app/build and exit non-zero if any placeholder remains unresolved.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Exception Handling & Recovery',
  'Fix a Python CLI downloader that crashes on transient HTTP errors and leaves corrupted partial files by adding robust try/except handling with timeouts, retry-with-exponential-backoff, mirror fallback, and safe atomic writes that can resume from .part files. Verify by simulating failures and confirming the final artifact matches a provided checksum.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Exception Handling & Recovery',
  'Fix a Python ETL loader that crashes on malformed CSV rows, encoding errors, and SQLite constraint violations by adding robust try/except handling, per-row validation, and a dead-letter output. The job should complete with partial success, write rejected rows to /app/bad_rows.csv, and exit zero once all recoverable errors are handled.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Exception Handling & Recovery',
  'Harden a Python CLI that crashes with BrokenPipeError when its output is piped to another process (e.g., head) by adding robust EPIPE/SIGPIPE handling and a clean shutdown path. Verify it emits no stack trace, exits successfully, and does not leave partial lines in the downstream output.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debug an intermittent crash in a multithreaded C program by using gdb to reproduce the failure, inspect thread states, and set conditional breakpoints and memory watchpoints to trace a use-after-free. Patch the lifetime bug and verify stability by running the provided stress test until it passes consistently.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Interactive Debugger Usage',
  'Diagnose and fix a sporadic SIGSEGV in a multithreaded C ring-buffer logger by reproducing under load, attaching with gdb, and using thread-aware stepping and watchpoints on head/tail indices to find the out-of-bounds write. Patch the bug using proper atomics/locking and verify stability with a stress test.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Interactive Debugger Usage',
  'Track down an intermittent segmentation fault in a multi-threaded C log processor by using gdb to reproduce, inspect per-thread backtraces, and set watchpoints on a shared ring buffer to catch the corrupting write. Fix the use-after-free in the consumer, rebuild, and verify stability under a provided parallel stress test.',
  NULL,
  ARRAY['parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Code Debugging & Error Resolution',
  'Logic & Algorithmic Bugs',
  'Diagnose and fix a Rust implementation of topological sort that yields incorrect or nondeterministic orders by mutating a set during iteration and miscounting in-degrees. Implement a correct queue-based Kahn’s algorithm and add a regression test covering cycles, duplicate edges, and deterministic ordering.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Logic & Algorithmic Bugs',
  'Identify and fix a Python topological sort implementation that returns incorrect orders and occasionally fails to detect cycles due to flawed in-degree updates and non-deterministic node selection. Implement a deterministic Kahn’s algorithm with explicit cycle detection and verify stable ordering across repeated runs on provided DAGs.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Logic & Algorithmic Bugs',
  'Repair a shortest-path tool that returns wrong Dijkstra distances on graphs with zero-weight edges due to stale priority-queue entries and off-by-one node indexing. Update the algorithm to correctly handle decrease-key via ignoring stale heap nodes and proper indexing so outputs match provided golden results across multiple graphs, including disconnected cases.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'A Rust CLI builds successfully but crashes with SIGSEGV only in --release. Use RUST_BACKTRACE with AddressSanitizer or Miri to locate undefined behavior inside an unsafe block, fix the memory error, and verify cargo test and cargo run complete without crashes.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Runtime & Compilation Errors',
  'Diagnose a C++17 CLI tool that compiles but intermittently segfaults on large inputs. Use AddressSanitizer/UBSan and gdb to trace iterator invalidation from std::vector reallocation in a loop, refactor the code to avoid undefined behavior, and verify by running the provided corpus without crashes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Debugging & Error Resolution',
  'Runtime & Compilation Errors',
  'Diagnose and repair a C++ CLI tool that crashes under -O2 with a SIGSEGV due to vector iterator invalidation in a custom deduplication routine. Use AddressSanitizer or gdb to pinpoint the fault, refactor the loop to avoid invalidated iterators, then rebuild with -O2 and verify the program completes on the provided dataset without crashing.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Automation & Cron Job Failures',
  'Diagnose a nightly cron job that runs a Python ETL (CSV to Parquet) but fails under cron with ModuleNotFoundError and missing files due to minimal PATH, unset locale, and relative paths. Fix the job by using a virtualenv and absolute paths via a wrapper script, exporting PATH/LANG/TZ, ensuring execute permissions and logging, and verify success by running it under a simulated cron environment.',
  NULL,
  ARRAY['python', 'logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Data & Pipeline Debugging',
  'Automation & Cron Job Failures',
  'Diagnose a nightly cron-scheduled CSV-to-JSON ETL that works manually but fails under cron due to CRLF line endings, a bad shebang, and reliance on relative paths/implicit virtualenv activation. Convert line endings, fix executable/shebang and use absolute paths to the venv’s Python, then verify the job runs from cron and writes the expected outputs and logs.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Automation & Cron Job Failures',
  'Diagnose why a nightly cron job defined in /etc/cron.d/etl that should transform /app/input/*.csv into /app/out/data.parquet never produces output. Identify and fix cron-specific issues (PATH/virtualenv, working directory/relative paths, stale flock lockfile) and dependency/import errors so the job runs under cron; verify by forcing a run and ensuring the Parquet is generated.',
  NULL,
  NULL
);

-- Batch 3 complete (300 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Data & Pipeline Debugging',
  'Automation & Cron Job Failures',
  'Investigate a nightly ETL cron job that succeeds interactively but fails under cron by reproducing the cron environment, inspecting mail/cron logs, and pinpointing issues like missing PATH/virtualenv, % expansion in the command, relative paths, or SSH key permission denials. Fix the job by correcting the cron entry (escaping %, adding absolute paths and required environment), adjusting file permissions, and verifying via a forced run and persisted logs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debug a failing ETL that joins newline-delimited JSON to CSV lookups after an upstream change made id string-typed and some nested fields optional. Update the ingest and normalization steps to handle schema drift (type coercion, defaulting missing nested fields, dropping unknown columns) and emit a Parquet file that conforms to the provided JSON Schema.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Data Format & Schema Mismatches',
  'Diagnose a Spark job that crashes when reading a partitioned Parquet dataset because certain partitions were written with conflicting types for the same columns (e.g., id as int in some, string in others, differing decimal scales). Create a command-line repair tool that scans partitions, infers a unified schema, rewrites or casts offending files, and verifies the job completes with a stable row count.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Data Format & Schema Mismatches',
  'Diagnose and fix a Python CSV-to-Parquet conversion script that crashes because different input shards use inconsistent schemas (missing columns, reordered headers, mixed numeric/string types, and dual date formats). Implement a normalization step that defines a canonical schema, coerces/validates types, fills defaults for absent fields, and produces a single readable Parquet dataset verified by a provided reader script.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Data Format & Schema Mismatches',
  'Diagnose and fix a failing ETL step where a pandas CSV loader expects comma-delimited UTF-8 with headers id,event_time,amount, but input partitions are mixed: semicolon-delimited ISO-8859-1 with BOM, and some months rename amount to total_amount or omit it entirely. Implement robust delimiter/encoding detection, header alias mapping, and default value/backfill logic, then emit Parquet conforming to a provided schema and verify via a schema-validation script.',
  NULL,
  ARRAY['pandas']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Data Format & Schema Mismatches',
  'Diagnose and fix a failing Python ETL that ingests NDJSON into a SQLite table where some shards emit objects missing required fields, integers as strings, or an array instead of an object. Implement a loader that validates against a provided JSON Schema, coerces types and fills defaults, quarantines irreparable records to /app/bad_rows.ndjson, and completes the load without errors.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Data & Pipeline Debugging',
  'I/O & File Handling Errors',
  'A log aggregation ETL that tails /var/log/app.log misses data after rotation and crashes on reading gzipped archives due to stale file handles and incorrect decompression. Diagnose and fix the pipeline to detect log rotation (reopen on inode change), read both .log and .log.*.gz with correct permissions, and emit a complete deduplicated JSONL to /app/out.jsonl for a target date.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'I/O & File Handling Errors',
  'Diagnose and fix a Python log ETL that hangs or fails with UnicodeDecodeError when consuming gzipped records from a named pipe and rotating .gz files because it treats FIFOs like regular files, seeks on non-seekable streams, and assumes UTF-8. Make the reader stream-safe, BOM/encoding-aware, and tolerant of concatenated/partial gzip members, then verify it emits a single UTF-8, LF-normalized output.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'I/O & File Handling Errors',
  'Diagnose and fix a file-descriptor leak in a Python ETL that globs and processes thousands of (optionally gzipped) JSON Lines files, causing intermittent ''Too many open files'' errors. Refactor to use context managers and bounded concurrency, then verify the full dataset ingests without EMFILE failures.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'I/O & File Handling Errors',
  'Diagnose why a JSONL merge ETL script silently skips inputs and corrupts records when traversing a directory tree containing spaces/newlines in filenames, symlinks, and mixed UTF-8/Latin-1 encodings. Repair the script to robustly discover files and handle .jsonl and .jsonl.gz, safely read/normalize encodings, and write a single deduplicated UTF-8 newline-delimited output to /app/merged.jsonl.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debug a GNU Make–driven ETL where a CSV→JSON→SQLite pipeline intermittently fails because a normalization step writes to a .tmp file and downstream rules consume stale outputs due to misdeclared targets and misordered prerequisites. Fix the Makefile by declaring correct outputs, ordering dependencies (including any order-only deps), and verify that a full run and incremental rebuilds execute the correct stages end-to-end.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Pipeline Stage Failures',
  'Debug a Snakemake ETL where a normalization step writes gzipped CSVs while declaring .csv outputs, causing downstream aggregation to miss inputs and the DAG to misorder. Fix the rule I/O patterns, compression settings, and dependencies so the pipeline runs end-to-end and emits the expected final summary.csv.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Pipeline Debugging',
  'Pipeline Stage Failures',
  'Diagnose a Snakemake ETL where a mid-pipeline rule now outputs gzipped TSV files while downstream rules still expect plain TSV, leading to a no-op aggregation and an empty final report. Align I/O patterns and shell commands across affected rules, rebuild the DAG, and verify the corrected output.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Build Configuration & Toolchain Issues',
  'Diagnose a CMake-based C++ project that fails to link on a clean environment due to missing transitive dependencies and non-PIC objects in a shared library. Fix CMakeLists.txt to use imported targets with correct PUBLIC/INTERFACE scopes and enable POSITION_INDEPENDENT_CODE, then rebuild and verify by running the provided demo binary.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Build Configuration & Toolchain Issues',
  'Diagnose and repair a CMake-based C++ project that fails to link a shared library due to non-PIC static dependencies and whose test binary cannot locate the built .so at runtime. Modify CMake to build static libs with POSITION_INDEPENDENT_CODE and set correct RPATH/INSTALL_RPATH so the library links and the tests execute successfully.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Build Configuration & Toolchain Issues',
  'Fix a CMake-based C++ project that fails to build shared libraries due to missing -fPIC and unresolved OpenMP symbols when using Clang. Diagnose the errors and update the CMake configuration to enable position independent code and link the correct OpenMP runtime so the project compiles and tests run successfully.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose and fix an npm install failure for the sharp image library where native module build via node-gyp breaks due to missing toolchain and system libraries or incompatible Node ABI/prebuilt binaries. Install the necessary build tools and libvips (or align Node version so prebuilt binaries work), then verify by running a Node script that loads sharp and successfully resizes an image.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Package Installation Failures',
  'Diagnose and fix why pip install lxml fails due to missing system headers and build tools (libxml2/libxslt, zlib, compiler). After repair, install lxml successfully and verify by running a provided test script that parses XML without errors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Package Installation Failures',
  'Diagnose and repair a failing npm install of node-canvas that errors with node-gyp and missing libcairo/Pango headers by installing the correct system build tools and configuring pkg-config (and, if necessary, pinning to a compatible Node ABI). Verify the fix by successfully installing the package and rendering a PNG to /app/out.png using a provided test script.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Package Installation Failures',
  'Diagnose and repair a pip install failure for pygraphviz on a minimal Linux image where the build cannot locate Graphviz headers/libraries. Install the required system packages and set appropriate env vars so the wheel builds, then verify by generating a PNG from a simple graph.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Package Installation Failures',
  'In an Alpine Linux container, diagnose and fix pip install cryptography failing by installing the Rust toolchain and OpenSSL/musl development headers, and configuring the build environment so a source build succeeds. Verify by importing cryptography and generating an Ed25519 keypair in a short Python script.',
  NULL,
  ARRAY['container', 'cryptography', 'rust', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Dependency & Build Troubleshooting',
  'System Library & Path Errors',
  'Diagnose a Python + GDAL/PROJ setup where importing osgeo.gdal fails with a libgdal.so load error or missing grid files because the shared libraries and data directories aren’t on the search path. Fix by correctly wiring PATH/LD_LIBRARY_PATH/PKG_CONFIG_PATH and GDAL_DATA/PROJ_LIB (or adding an rpath) and verify by importing GDAL and performing a coordinate transform.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'System Library & Path Errors',
  'Diagnose and fix a prebuilt CLI in /app/bin/remote-sync that fails with ''error while loading shared libraries: libssl.so.1.1'' due to an OpenSSL ABI mismatch. Provide a compatible libssl/libcrypto and configure the dynamic linker (e.g., rpath/LD_LIBRARY_PATH or ldconfig) so ldd resolves all libraries and the CLI completes its test run.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'System Library & Path Errors',
  'Diagnose and repair a Pillow import failure caused by a missing or mislinked system libjpeg (e.g., ''libjpeg.so.X: cannot open shared object file''). Install or relink the correct library and rebuild or reinstall Pillow, then verify JPEG load/save works in a short script.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'System Library & Path Errors',
  'Diagnose and repair a prebuilt ELF CLI in /app/bin that fails with ''error while loading shared libraries: libfoo.so.X: cannot open shared object file'' due to a missing or misconfigured runtime library search path. Locate the correct library directory and fix the binary via RPATH (patchelf) or environment (LD_LIBRARY_PATH) so the tool executes a provided command successfully.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose a Node.js project that fails with a ''module was compiled against a different Node-API/ABI'' error due to a mismatch between the installed Node version and native addon binaries (e.g., sharp/sqlite3). Align versions by switching Node via nvm/asdf or rebuilding addons, then verify the app runs a provided command successfully.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Version Incompatibility',
  'Diagnose and fix a Node.js TypeScript project where builds/tests fail under Node 20 due to incompatible versions of TypeScript, ts-node/ts-jest, and Jest (ESM/CJS loader and peer-dependency errors). Align and pin a compatible toolchain or update configs for ESM/CJS correctly, then verify npm run build and npm test succeed.',
  NULL,
  ARRAY['typescript']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Dependency & Build Troubleshooting',
  'Version Incompatibility',
  'Diagnose and fix a Node.js project that fails to start due to a native addon compiled for an incompatible Node-API/ABI (e.g., “Module version mismatch” or “Module did not self-register”). Align the Node.js/runtime version and rebuild the addons (or select a compatible prebuilt) so the program runs and the addon loads successfully.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Configuration File Parsing & Validation',
  'Diagnose and fix a broken Docker Compose v2 YAML that misuses anchors/merge keys and ${VAR} interpolation, triggering schema/type errors on docker compose. Refactor to a valid v2 schema (e.g., via x- extension fields and correct quoting), supply a minimal .env, and verify with docker compose config and a successful service start.',
  NULL,
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Configuration File Parsing & Validation',
  'Diagnose why Prometheus fails to start by fixing prometheus.yml and the referenced rules/*.yml: tabs, a UTF-8 BOM, inconsistent indentation, and a stringified numeric scrape_interval cause YAML parsing and schema validation errors. Normalize the files (no tabs/BOM), correct types and rule paths to satisfy the Prometheus schema, and verify with promtool check config and promtool check rules.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Configuration File Parsing & Validation',
  'Diagnose why a Prometheus server fails to start due to a malformed prometheus.yml (bad indentation, duplicate scrape_configs, and invalid relabel_configs). Fix the YAML so promtool check config passes and the server can start and scrape a bundled dummy target, verified by a successful GET of /-/ready.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose a Python CLI project that runs on macOS/Windows but fails on Linux due to case-mismatched imports and CRLF-terminated helper scripts causing /bin/sh^M errors. Make it Linux-portable by correcting import/module casing and normalizing line endings and path handling, then verify the CLI executes successfully end-to-end.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Cross-Platform Environment Differences',
  'Diagnose a Python CLI that crashes with UnicodeEncodeError on Linux but works on macOS due to running under the C/POSIX locale. Generate and set a UTF-8 locale in the container (e.g., en_US.UTF-8), update startup config to export LANG/LC_ALL, and verify it correctly processes non-ASCII filenames.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'A Node.js Express app crashes at startup with ''Missing ENV: DATABASE_URL, JWT_SECRET'' even though a .env file exists. Diagnose why environment variables are not loaded in the containerized runtime, load or export them correctly so the app starts, and verify the /health endpoint returns 200.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Environment Variable Misconfiguration',
  'Diagnose and fix a CLI application’s UnicodeDecodeError caused by running under the POSIX C locale with LANG/LC_* unset or misconfigured. Configure and activate a UTF-8 locale and appropriate environment variables so the program can read and print UTF-8 (including emojis) without errors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Environment Variable Misconfiguration',
  'Diagnose and fix a CLI tool that crashes on Unicode filenames due to a non-UTF-8 locale by correctly configuring LANG/LC_ALL and generating the required UTF-8 locale in the container. Persist the fix for both interactive and non-interactive shells, then verify the tool processes files with accented characters without errors.',
  NULL,
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Environment & Configuration Debugging',
  'Environment Variable Misconfiguration',
  'Diagnose why both curl and a Python requests client fail HTTPS verification against a provided local TLS service, tracing it to a missing CA trust path. Configure SSL_CERT_FILE or SSL_CERT_DIR to point at the bundled CA bundle so both tools succeed, and verify by performing a successful GET request.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Environment & Configuration Debugging',
  'Virtual Environment & Container Issues',
  'Diagnose a Docker image where a preinstalled Conda environment is not used at runtime, causing imports to fail because the container launches with a non-login shell that never activates Conda. Fix the Dockerfile/entrypoint to reliably run under the intended Conda env (e.g., conda run -n app or sourcing conda.sh) and verify by executing a provided script that imports numpy and prints its version.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose and fix slow HTTP requests caused by the system preferring IPv6 (AAAA) addresses that are unroutable, leading to connection timeouts before IPv4 fallback. Reconfigure address selection, routing, or resolver settings so connections to a dual-stack host complete quickly without timeouts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Connection & Timeout Errors',
  'Investigate persistent timeouts when a local microservice calls an internal API and discover they are caused by inherited HTTP(S)_PROXY environment variables pointing to a dead proxy. Reconfigure NO_PROXY or unset the proxy so direct connections succeed, and verify with curl and a test run.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Connection & Timeout Errors',
  'Investigate why a client app’s HTTP requests to an internal service stall before timing out: the hostname resolves to IPv6 while the server only binds on IPv4. Fix the mismatch (e.g., enable dual-stack binding or force IPv4 resolution) and verify low-latency success with the provided test script.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Proxy, SSL & Certificate Errors',
  'Diagnose and fix an Nginx reverse proxy that returns 502 due to a failed TLS handshake with an HTTPS upstream caused by disabled SNI and an untrusted/intermediate-missing CA chain. Update the proxy’s TLS settings (enable SNI, set the correct upstream host, provide a trusted CA bundle) and verify that curling the proxied endpoint over HTTPS succeeds.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Proxy, SSL & Certificate Errors',
  'Diagnose and repair a Maven-based Java project that fails to download dependencies through a corporate HTTPS proxy performing TLS interception. Import the provided root CA into the JVM truststore, configure authenticated proxy settings without disabling SSL verification, and verify mvn dependency:resolve succeeds.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Proxy, SSL & Certificate Errors',
  'Fix a broken mutual TLS setup on an Nginx reverse proxy fronting a local API: clients see handshake failures and ''unknown ca'' errors due to an incomplete server certificate chain and verification against the wrong client CA. Rebuild and reference the correct fullchain, configure nginx to trust the proper client CA, issue a client certificate/key, reload, and verify curl with the client cert succeeds while requests without it are rejected.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose a FastAPI service managed by supervisord that never becomes healthy because it binds only to 127.0.0.1 and its /healthz endpoint crashes on missing environment configuration. Reconfigure binding to 0.0.0.0 and make the health check independent of external services, then verify the container healthcheck and curl to /healthz return 200.',
  NULL,
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Service Availability & Health Checks',
  'Diagnose a Nginx→Gunicorn→Flask stack that never passes its health check because Nginx proxies to a nonexistent unix socket, Gunicorn is listening on TCP port 8001, and the /health endpoint hard-depends on a missing database. Reconfigure the upstream to the correct port and make the health route shallow so the service reports healthy and curl to /health returns 200.',
  'hard',
  ARRAY['database']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Service Availability & Health Checks',
  'Diagnose an Nginx-proxied FastAPI service whose /health endpoint returns intermittent 502s due to IPv6/IPv4 mismatch (upstream resolving to ::1 while the app binds only to 127.0.0.1). Adjust the app bind address or Nginx upstream to ensure consistent HTTP 200 health checks across restarts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & Service Debugging',
  'Service Availability & Health Checks',
  'Diagnose and fix a misconfigured reverse proxy that causes a healthy backend service to fail its /healthz check (e.g., wrong upstream port, missing Host/X-Forwarded headers, or TLS-to-HTTP mismatch). Correct the proxy and service configs and reload them so curl http://localhost/healthz returns 200 with the expected body.',
  NULL,
  ARRAY['backend']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Performance & Resource Optimization',
  'CPU & Memory Profiling',
  'Profile a mixed Python+C log-processing tool to locate CPU hotspots and memory bloat using cProfile, perf, and Valgrind (memcheck/massif). Eliminate an O(n^2) Python loop and fix a C-side leak so the job completes ≥2x faster with ≥50% lower peak RSS while preserving identical output.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose a C-based log aggregator that is extremely slow due to 1-byte read() calls and an fsync/flush on every line. Refactor it to use buffered streaming and batched writes (e.g., setvbuf/FILE* or coalesced writev) and verify /app/bench.sh runs at least 5x faster without changing output.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Performance & Resource Optimization',
  'I/O & Disk Bottlenecks',
  'Diagnose a Python SQLite ingestion script that is painfully slow due to per-row transactions causing fsync storms and page cache thrashing. Use strace/iostat to confirm the I/O bottleneck, then optimize by batching transactions and enabling WAL with appropriate PRAGMAs to achieve >5× speedup while preserving identical database contents.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Performance & Resource Optimization',
  'Parallelization & Concurrency Bugs',
  'Diagnose a deadlock and throughput collapse in a Rust Tokio-based pipeline where a Mutex is held across await points and a bounded mpsc channel backpressures a blocking file writer. Refactor to avoid cross-await locks and move blocking I/O to spawn_blocking or a dedicated thread pool, then verify no hangs under a provided stress script and achieve at least 3× higher throughput.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Performance & Resource Optimization',
  'Parallelization & Concurrency Bugs',
  'Diagnose a throughput collapse in a Java service where CompletableFuture chains run on a fixed-size ExecutorService, causing thread-starvation deadlocks under load. Refactor the scheduling (e.g., non-blocking composition or separate executors for nested tasks) so the load test completes without timeouts and throughput improves by at least 2x.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Performance & Resource Optimization',
  'Parallelization & Concurrency Bugs',
  'Diagnose and fix an intermittent deadlock in a Rust Tokio service caused by holding a std::sync::Mutex across await points and doing blocking file I/O inside async tasks, leading to hangs under load. Refactor to use tokio::sync::Mutex/RwLock and spawn_blocking for I/O, add cancellation timeouts, and verify via a stress script, cargo test, and tokio-console traces.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Root Cause Analysis & Postmortem Debugging',
  'Dependency & Environment Audit',
  'Diagnose why a Node.js project’s native addon (e.g., sharp or grpc) fails to load with errors like GLIBC_x.y not found or wrong ELF class inside the container. Audit Node ABI vs compiled binaries and system libc/libstdc++ versions, rebuild or pin a compatible binary with node-gyp and verify the addon loads in a minimal script.',
  NULL,
  ARRAY['grpc', 'container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Root Cause Analysis & Postmortem Debugging',
  'Dependency & Environment Audit',
  'Diagnose why the prebuilt /app/server web binary exits on launch with “No such file or directory” and fix it by auditing dynamic library dependencies and environment drift (e.g., missing libsqlite3 due to CGO). Install or rebuild with the correct dependencies (or static linking), verify the /health endpoint responds, and write a brief postmortem to /app/POSTMORTEM.md.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Dependency & Environment Audit',
  'Investigate a prebuilt C++ CLI tool that fails at startup with a “GLIBCXX_x.y not found” error inside the container. Identify the ABI mismatch between the binary and the system libstdc++/glibc, remediate by aligning runtime libraries or rebuilding, and verify the tool runs successfully end-to-end.',
  NULL,
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Dependency & Environment Audit',
  'Investigate why importing a pip-installed C++ extension (e.g., scikit-learn) now fails with GLIBCXX/CXXABI symbol errors after a base image or compiler runtime change by auditing the system’s libstdc++/libgcc versus the wheel’s required ABI. Resolve by aligning the C++ runtime or installing compatible wheels/pins, then verify with a minimal script that imports and exercises the package.',
  NULL,
  NULL
);

-- Batch 4 complete (400 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Root Cause Analysis & Postmortem Debugging',
  'Error Reproduction & Isolation',
  'Diagnose an intermittent segfault in a C utility that only occurs when compiled with -O2. Reproduce by varying compiler flags and inputs, then reduce the program to a minimal C file that crashes reliably and reveals the underlying undefined behavior.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Error Reproduction & Isolation',
  'Reproduce an intermittent deadlock in a Go HTTP server that occurs only under specific GOMAXPROCS values and concurrent request patterns, then isolate a minimal single-file program and deterministic request sequence that triggers it. Capture the exact environment and commands used (race detector, pprof blocking profile, goroutine dumps) to demonstrate the deadlock reliably.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Error Reproduction & Isolation',
  'Reproduce and isolate a CLI tool crash that emits ''Broken pipe'' or exits non-zero when its stdout is piped to head/grep -m1, identifying the minimal code path that triggers SIGPIPE/EPIPE under controlled conditions. Implement graceful handling so the pipeline exits cleanly without stack traces or spurious errors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  NULL,
  ARRAY['api', 'container', 'monitoring']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Root Cause Analysis & Postmortem Debugging',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Traceback & Stack Analysis',
  'Investigate a Java service that fails at startup with a NoSuchMethodError originating from org.apache.commons.lang3 in the stack trace, indicating JAR hell from conflicting transitive dependencies. Use gradle dependencies to trace the classpath, add dependency constraints or exclusions to resolve the conflict, then rebuild and verify the service starts and a provided smoke test passes.',
  NULL,
  ARRAY['java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Traceback & Stack Analysis',
  'Investigate a Node.js CLI that crashes on startup with "RangeError: Maximum call stack size exceeded"; run with --trace-uncaught and --trace-warnings to obtain full stack traces and pinpoint a circular require/import loop causing infinite recursion. Refactor the modules to break the cycle and verify the program starts and returns the expected output.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Traceback & Stack Analysis',
  'Investigate a Python ProcessPool-based task that fails with BrokenProcessPool by reading the exception chain and worker stack traces to find the underlying pickling error caused by a nested/local function. Refactor the callable to be picklable (e.g., move to module scope) and verify the parallel job completes successfully.',
  NULL,
  ARRAY['python', 'parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Root Cause Analysis & Postmortem Debugging',
  'Traceback & Stack Analysis',
  'Investigate an intermittently crashing Go HTTP service by analyzing its panic log and full goroutine dump to trace the execution path to a ''concurrent map writes'' failure and pinpoint the offending map and call sites. Implement a minimal synchronization fix and a stress test that runs with -race to verify the panic no longer occurs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Security & Access Debugging',
  'Access Policy & Role Misconfiguration',
  'Diagnose and correct a MinIO S3 setup where a data-ingest user cannot list or upload objects due to conflicting bucket and user policies. Apply the least-privilege fix by adjusting the bucket and user policies so that aws s3 ls and multipart uploads succeed only within the intended bucket/prefix.',
  NULL,
  ARRAY['aws']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Access Policy & Role Misconfiguration',
  'Diagnose and fix a Redis ACL misconfiguration that blocks a non-default user from executing required commands (e.g., SET/GET) on a specific key prefix used by a sample app. Update the ACLs to grant least-privilege access for that user and verify the app completes successfully end-to-end.',
  NULL,
  ARRAY['redis']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Access Policy & Role Misconfiguration',
  'Fix a Kubernetes RBAC setup where the ci-deployer ServiceAccount cannot create or patch Deployments in the staging namespace, yet is mistakenly allowed to read Secrets cluster-wide. Diagnose Role/ClusterRole and (Cluster)RoleBinding scope and apiGroup/verb mismatches, then rework the policy to grant least-privilege deploy rights only in staging and no Secrets access; verify with kubectl auth can-i and by successfully applying the provided manifest.',
  NULL,
  ARRAY['kubernetes']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Authentication & Authorization Failures',
  'Diagnose and fix a local PostgreSQL login failure for user ''app'' where URI-based connections are rejected due to pg_hba.conf rule order, SCRAM-vs-MD5 password mismatch, and missing LOGIN/CONNECT privileges. Correct the configuration and role settings, reload PostgreSQL, and verify with psql postgresql://app:app@localhost:5432/appdb -c SELECT 1.',
  NULL,
  ARRAY['postgresql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Authentication & Authorization Failures',
  'Diagnose and repair a local PostgreSQL connection that fails with pg_hba.conf rejection and mismatched password method (SCRAM vs md5), preventing a bundled Python app from logging in. Update pg_hba.conf, recreate the user with the correct authentication scheme and role grants, reload Postgres, and verify a psycopg2 script can perform read/write queries.',
  NULL,
  ARRAY['postgresql', 'python', 'logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'Security & Access Debugging',
  'Authentication & Authorization Failures',
  'Diagnose and resolve npm 401 Unauthorized errors when installing from a local Verdaccio registry by pinpointing bad/expired credentials or scope misconfiguration in ~/.npmrc and registry ACLs. Reauthenticate or correct token scopes/registry settings so installing a private package succeeds from the terminal.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Authentication & Authorization Failures',
  'Diagnose why kubectl returns Forbidden and token-related errors using the provided kubeconfig for namespace analytics. Replace the expired/invalid ServiceAccount token and create the minimal Role/RoleBinding needed, update kubeconfig, and verify by successfully applying manifests and listing pods in that namespace.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'Environment Secrets & Credential Mismanagement',
  'Diagnose and fix a CI/container build that fails to fetch private npm packages and Git submodules due to mismanaged tokens (missing/misnamed env vars, malformed .npmrc, and SSH key permission issues). Repair the credential chain and config so npm install and git submodule update complete non-interactively.',
  NULL,
  ARRAY['container', 'git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'A reverse proxy cannot connect to its backend via a Unix domain socket at /run/app.sock due to permission denied on the socket path. Diagnose and correct directory/socket ownership, mode bits, and group/ACL settings so the proxy user can connect, then verify a 200 OK from curl localhost.',
  NULL,
  ARRAY['backend']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'File & Directory Permission Errors',
  'Diagnose and fix a reverse proxy failing with 502 because nginx cannot access a backend UNIX domain socket (EACCES) due to incorrect ownership/permissions on the socket and its parent directories. Adjust ownership, mode, and directory execute bits or set ACLs, then make the fix persistent by updating the systemd .socket/.service or tmpfiles.d configuration, and verify that curl via nginx returns 200.',
  NULL,
  ARRAY['backend']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security & Access Debugging',
  'File & Directory Permission Errors',
  'Diagnose why a client receives ''Permission denied'' when connecting to a Unix domain socket at /app/run/metrics.sock: the socket’s parent directory lacks execute permission for the client’s group and the daemon’s umask creates overly restrictive socket permissions. Implement a least-privilege fix by adjusting directory ownership/modes and the daemon’s umask or group, then verify bidirectional communication over the socket.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Analyze journald, kernel dmesg, and application/service logs to time-correlate intermittent 5xx outages with OOM-killer events caused by a runaway process triggered by a cron job. Produce a concise root-cause timeline and propose a mitigation (e.g., systemd MemoryMax) to prevent recurrence.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System & Process Diagnostics',
  'Log Inspection & Anomaly Detection',
  'Correlate a recurring 2–3 minute outage by analyzing nginx access/error logs, systemd-journal logs, and cron logs while compensating for a deliberate 5‑minute clock skew between components. Identify that a misconfigured logrotate postrotate script intermittently sends SIGSTOP to the web app and apply a minimal fix so the outage ceases.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'System & Process Diagnostics',
  'Process Crashes & Core Dumps',
  'A Node.js script using the sharp image library crashes with SIGSEGV; enable core dumps and use coredumpctl + gdb (with addr2line) to analyze the core and trace the fault into libvips due to an ABI/version mismatch. Repair by installing compatible libvips/sharp binaries or rebuilding the module, then verify an image resize completes without crashing.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System & Process Diagnostics',
  'Process Crashes & Core Dumps',
  'Analyze a core dump from a Rust CLI that intermittently SIGSEGVs during FFI calls into a C library. Use gdb and addr2line to pinpoint a dangling pointer/use-after-free across the FFI boundary, patch the Rust/C bindings to fix ownership and lifetimes, rebuild, and verify the crash no longer occurs under the stress script.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System & Process Diagnostics',
  'Process Crashes & Core Dumps',
  'Investigate a Node.js service that segfaults when requiring a native addon, analyzing the generated core dump with gdb to pinpoint an ABI/version mismatch between Node and the .node binary. Rebuild the addon for the correct Node-API/ABI (e.g., via node-gyp or prebuilds), replace the artifact, and verify the service runs and responds to a simple request without crashing.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System & Process Diagnostics',
  'System Resource Exhaustion',
  'Diagnose intermittent cargo build/test failures in a Rust workspace that end with ''Killed'' or LLVM crashes, caused by OOM from parallel compilation and a nearly full disk from stale build artifacts. Mitigate by freeing disk space, adding a swapfile, and limiting build parallelism, then rebuild and run the tests to confirm stability.',
  NULL,
  ARRAY['rust', 'parallel', 'compilation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Debugging & Troubleshooting',
  'System & Process Diagnostics',
  'System Resource Exhaustion',
  'Diagnose sporadic ''No space left on device'' errors despite ample free disk by identifying inode exhaustion caused by millions of small files in /var/tmp/app-cache. Implement cleanup and a prevention policy (e.g., tmpfiles.d or a cleanup cron) and verify new files can be created successfully.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Git & Version Control Issues',
  'Diagnose and repair a Git repo where refs are lost and the repository is stuck mid-rebase: HEAD is detached, refs/heads/main is missing due to a corrupted packed-refs, and an index.lock prevents most commands. Recover the branch from reflog and dangling commits, clean up the rebase/lock state, and complete a fast-forward push to origin/main.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Git & Version Control Issues',
  'Diagnose and repair a repository with broken Git submodules where .gitmodules contains incorrect paths/URLs and the submodule SHAs are orphaned, causing clone/update to fail. Fix the .gitmodules entries, sync configs, repoint submodules to valid remotes and commits, reinitialize recursively, and verify a fresh clone yields a clean working tree with all submodules checked out.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Git & Version Control Issues',
  'Investigate a repository that fails to clone recursively because a submodule references a non-existent commit and an outdated remote. Fix by updating .gitmodules and the submodule’s origin URL, rewriting the parent commit to point at a reachable submodule revision if necessary, and verify that a fresh --recursive clone completes with a clean working tree.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Git & Version Control Issues',
  'Repair a Git repository that fails with ''fatal: bad object HEAD'' due to a corrupted packed-refs file and a missing refs/heads directory. Reconstruct branch and tag refs from reflogs and reachable commits, restore HEAD to main, verify with git fsck, and push the recovered history to a new local bare remote.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Local vs Remote Environment Divergence',
  'Diagnose a Node.js/TypeScript project that passes locally but fails in CI because CI uses NODE_ENV=production and npm ci --omit=dev, leaving runtime modules incorrectly placed in devDependencies unavailable. Reproduce both environments and then fix the workflow by pinning Node and reclassifying dependencies/build steps so the full test suite passes identically in both.',
  NULL,
  ARRAY['typescript']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Testing & CI/CD Failures',
  'Investigate why tests that rely on large sample assets fail in CI but pass locally, discovering that Git LFS-tracked files are checked out as pointer stubs in the CI environment. Initialize and configure Git LFS in the pipeline, fetch actual binaries, and rerun the suite until all tests pass.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Tool Misconfiguration & Dependency Drift',
  'Diagnose a Rust workspace that fails in a simulated CI script due to dependency drift and toolchain mismatch (yanked versions in Cargo.lock, incompatible feature flags, and an unsupported rustc). Repair by pinning a compatible toolchain, updating/patching dependencies and regenerating the lockfile so cargo build and cargo test complete successfully.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Toolchain & Workflow Diagnostics',
  'Tool Misconfiguration & Dependency Drift',
  'Fix a failing Node.js monorepo build/test workflow that uses pnpm and corepack: the CI script selects an incompatible Node version, ignores the repo’s pinned pnpm, and relies on a stale lockfile that breaks workspaces. Update the workflow and configs (e.g., .nvmrc/engines, corepack enablement, pnpm-lock.yaml/cache keys) so the provided run-ci.sh passes on a clean checkout.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Interactive Education & Learning Tasks',
  'Command Discovery Quests',
  'Embark on a Manual Page Scavenger Hunt where each stage hides a token inside the EXAMPLES, ENVIRONMENT, or SEE ALSO sections of specific man/info/tldr entries discovered via apropos and --help. Collect all tokens and use the newly learned subcommands and rarely used flags to build a validating command pipeline that outputs the final passphrase to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Command Discovery Quests',
  'Explore a custom lab CLI that discovers subcommands from executables named ''lab-*'' on the PATH; by chaining ''lab help'' and each subcommand''s --help/man pages, deduce the correct workflow to authenticate and extract a hidden secret. Write the recovered secret to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Command Discovery Quests',
  'Explore a sandbox full of custom, undocumented CLI tools in /app/tools and hinted only via man/--help to discover how to reconstruct a corrupted, sharded archive. Infer and execute the correct pipeline (index, stitch, parity-fix, decode, decompress, verify) to recover the plaintext and write it to /app/answer.txt.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Command Discovery Quests',
  'Explore a sandbox of unknown CLI tools with self-documented interfaces (e.g., --help, help subcommands, and man pages) to learn their capabilities and compose them into a working pipeline. Use the discovered commands to decode a multipart artifact and write the exact recovered message to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Interactive Education & Learning Tasks',
  'Error Interpretation & Correction Games',
  'Broken Build Bootcamp: a staged C project with intentional faults (misconfigured Makefile flags, segfaults, and undefined behavior) driven by a tutor CLI that provides compiler/linker logs, sanitizer traces, and unit-test feedback. Progress by interpreting each failure and patching the Makefile and C sources until every stage reports PASS.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Error Interpretation & Correction Games',
  'Interact with a Shell Clinic tutor that presents five stages of broken Bash scripts; running clinic stageN executes tests, shows minimal logs, and offers targeted hints after each failure. Diagnose and fix quoting, word-splitting, pipefail, subshell, and locale/sort bugs until all stages pass, then write the provided success token to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Error Interpretation & Correction Games',
  'Interact with a simulated init system where a multi-service stack fails to start due to curated faults (dependency order, bad permissions, missing env vars, and port conflicts). Use logs and status tools to identify and fix each issue until all services are active, then write the final status summary to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Education & Learning Tasks',
  'Progressive Learning Environments',
  'Advance through a terminal-based Git dojo where each level teaches and verifies a specific operation (branching, merging, rebasing, cherry-picking, reverting, bisecting, submodules) before unlocking the next. After completing all levels, write the verified final commit SHA (LEVEL_FINAL) to /app/answer.txt.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Debugging Under Constraints',
  'Diagnose and fix a deadlock in a multithreaded C echo server that intermittently hangs under load, using only strace and gdb with a maximum of 12 commands total and editing at most two source lines. Verify the fix by running the concurrent client harness to completion and writing OK to /app/result.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Interactive Programming & Debugging Challenges',
  'Exploit & Reverse Engineering Games',
  'Analyze a provided crackme.wasm that validates a passphrase; reverse or patch it using wasm2wat/wasm-objdump and run it (e.g., via wasmtime/node) to trigger the success path and print the hidden flag. Write the exact flag to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Exploit & Reverse Engineering Games',
  'Bypass a dynamic license check in a stripped ELF by either reversing libcheck.so to derive a valid key or injecting an LD_PRELOAD shim that overrides the verifier; then run the program to unlock and print the secret. Save the exact secret to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Exploit & Reverse Engineering Games',
  'Interact with a CLI vault that issues sequence-based one-time passcodes derived from a predictable PRNG. Infer or reverse engineer the PRNG from observed outputs and generate the correct admin code to unlock the root vault, then write the revealed secret to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Exploit & Reverse Engineering Games',
  'Reverse a stripped 64-bit ELF that embeds a tiny stack-based VM and a hidden print_flag() routine; using gdb or radare2, recover the VM instruction set and craft an input/bytecode that pivots execution to the win path despite ASLR and NX. Execute the payload against the service to reveal the flag and write it to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Exploit & Reverse Engineering Games',
  'Reverse a stripped ELF implementing a custom WASM-like bytecode VM that loads program.bin and rejects unknown opcodes; interactively recover the instruction set via objdump/gdb and black-box probing. Assemble a crafted bytecode payload that calls the hidden reveal routine to print the secret and write it to /app/results.txt.',
  NULL,
  NULL
);

-- Batch 5 complete (500 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Interactive Programming & Debugging Challenges',
  'Live Coding Challenges',
  'Create an interactive ''Regex Golf'' challenge where the agent writes a single PCRE regex per round under a character budget to match all include strings and none of the exclude strings, with the harness streaming randomized cases and instant pass/fail diffs. Finish all rounds and write the final regexes, one per line, to /app/answers.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Live Coding Challenges',
  'Implement next_state(grid, steps) to simulate a custom Life-like cellular automaton whose birth/survival rules are loaded from /app/rules.txt (e.g., B36/S23) with toroidal wrap-around. An interactive test runner re-executes on save and reports the first failing case until all levels pass, after which the final solution is written to /app/solution.py.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Interactive Programming & Debugging Challenges',
  'Live Coding Challenges',
  'Solve an interactive regex-golf ladder where a CLI judge streams sets of positive and negative examples and you submit a single POSIX ERE pattern under a byte-length budget that must match all positives and none of the negatives to advance. Clear 20 levels with cumulative pattern length capped and immediate pass/fail feedback after each submission.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Meta-Challenges & Adaptive Tasks',
  'Dynamic Difficulty Adjustment',
  'Build a terminal-driven stealth microgame where the agent exchanges JSON messages with a referee, issuing one legal move per turn to reach an exit while avoiding dynamic guard line-of-sight. After each success the referee expands the grid, upgrades guard AI, injects decoys/noise, and the agent must clear three escalating tiers and write the final run transcript to /app/replay.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Meta-Challenges & Adaptive Tasks',
  'Dynamic Difficulty Adjustment',
  'Build an agent to play a terminal-based adaptive Mastermind/Wordle hybrid where, after each successful round, the secret’s length, symbol set, and feedback strictness increase; the agent must reach and solve Tier-5 difficulty and export every round’s secret and full guess history to /app/solutions.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Meta-Challenges & Adaptive Tasks',
  'Dynamic Difficulty Adjustment',
  'Create an agent that plays an adaptive ''Protocol Negotiation'' game where a local server alters its text-based handshake, auth, and payload schema each round based on prior success. The agent must probe, infer, and complete three escalating exchanges to obtain and write the final session token to /app/result.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Meta-Challenges & Adaptive Tasks',
  'Goal Discovery & Hidden Objective Games',
  'Interact with a black-box CLI that accepts short sequences of shell-style actions and returns graded hints while adaptively reshaping its constraints based on your recent attempts. Infer the hidden rule set and produce a minimal sequence that triggers ''EXIT GRANTED'' within a fixed budget, then write both the inferred rule and the winning sequence to /app/solution.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Meta-Challenges & Adaptive Tasks',
  'Goal Discovery & Hidden Objective Games',
  'Interact with a black-box finite-state machine REPL (/app/fsm_lab) that exposes only a few actions (reset, step A/B/C, probe) and returns minimal cues (opaque state hashes, warmer/colder signals) while its transition rules randomize each run. Infer the hidden acceptance condition and the action sequence to trigger it, then capture the acceptance token printed by the program and write it to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Meta-Challenges & Adaptive Tasks',
  'Goal Discovery & Hidden Objective Games',
  'Interact with a daemon that watches /puzzle and provides adaptive hints in response to your file operations (create/rename/chmod/symlink/edit/touch). Infer and perform the hidden ritual—a precise sequence of operations—to trigger ''RITUAL COMPLETE'' and write the revealed token to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Meta-Challenges & Adaptive Tasks',
  'Goal Discovery & Hidden Objective Games',
  'Interact with a shape-shifting oracle CLI whose feedback adapts to your recent commands, signaling only via exit codes, response latency, and log entropy whether you’re getting closer or farther. Deduce that the hidden objective is to achieve a ‘Harmony’ state by simultaneously satisfying three latent conditions (a process with specific args, a file with exact permissions/content, and an open port), then coax the oracle to reveal a token to write to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Meta-Challenges & Adaptive Tasks',
  'Multi-Stage Interactive Scenarios',
  'Create an agent that plays an adaptive terminal tower-defense simulator: run waves to probe enemy types, infer resistances from combat logs, and iteratively design a rule-based layout/upgrade plan that counters evolving enemy compositions. Upon defeating all adaptive waves, output the final defense ruleset and a succinct battle report to designated files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Adversarial Game Environments',
  'Create a terminal agent that plays an adversarial Battleship variant against a hidden AI where ships can legally drift one cell per turn after each round. With a limited number of probes and optional sonar sweeps, the agent must track probabilistic ship positions, anticipate evasive maneuvers, and achieve a target win rate over a best-of series.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Adversarial Game Environments',
  'Create an agent that plays a fog-of-war Battleship variant against a deceptive AI via a line-based terminal protocol. The AI may relocate damaged ships and emit noisy decoy feedback; the agent must track uncertainty and sink all ships within a fixed shot budget without illegal moves.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Collaborative Simulations',
  'Coordinate three simulated warehouse robots via provided CLI tools and TCP sockets to pick, carry, and deliver items on a 2D grid while avoiding collisions and respecting capacity and battery limits. Plan a joint schedule including charging stops, issue synchronized move/pick/drop commands, and write the final delivery ledger to /app/fulfillment.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Collaborative Simulations',
  'Implement an agent that joins a turn-based, socket-driven cooperative pipe network repair simulation alongside a simulated teammate controlling a disjoint set of tiles. Using a 16-byte-per-turn radio channel, coordinate synchronized rotations and valve toggles to connect all sources to sinks without leaks within 250 turns, then output the final ASCII grid to /app/network.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Negotiation or Dialogue Simulations',
  'Implement an autonomous negotiator that interacts via a stdin/stdout JSON protocol with two simulated counterparts to settle a multi-issue contract (price, delivery, warranty) under a strict 10-round deadline. The agent must adapt to counteroffers, maintain feasibility and constraints, achieve a target utility score, and persist the agreed terms and full transcript to /app/contract.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Multi-Agent or Adversarial Simulations',
  'Negotiation or Dialogue Simulations',
  'Negotiate a multi-item procurement contract with three simulated vendors over a CLI dialogue protocol, exchanging offers that vary unit price, lead time, and minimum-order constraints. Produce a single purchase order that fulfills the given BOM within budget and deadline while minimizing total cost.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'Environment Navigation Challenges',
  'Explore a terminal-based grid with hidden paired portals and one-way conveyor tiles under partial observability, inferring teleport linkages and movement dynamics as you go. Reconstruct the exact ASCII map, list portal pairings, and compute the shortest S→E route that respects conveyors and teleports.',
  NULL,
  ARRAY['observability']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'Environment Navigation Challenges',
  'Interact with a time-evolving grid simulator where hazards drift each turn; using only local scans and actions (up/down/left/right/wait/ping), explore to map the environment, collect two artifacts, and return to S. Write the final ASCII map and the time-indexed action sequence to /app/solution.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Simulation & Virtual Environments',
  'Interactive Physics or Cellular Simulations',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'Interactive Physics or Cellular Simulations',
  'Pilot a capsule in a simplified 2D orbital dynamics simulator by issuing discrete thruster burns via a CLI to match position and velocity with a target module before fuel runs out. On successful dock, write the timestamp of docking and remaining fuel to /app/docking_report.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'Resource Management Simulations',
  'Use a terminal microgrid-sim to manage solar, wind, battery, and diesel assets over 48 simulated hours, issuing per-tick dispatch commands to meet demand without blackouts. Minimize fuel use and battery wear amid stochastic weather and output a final KPI summary to /app/report.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'System or Network Simulations',
  'Operate a simulated three-tank industrial control system via a terminal CLI, reading sensor states and issuing bounded pump/valve commands under latency and sensor noise. Keep all tank levels within target bands for 500 ticks despite disturbances, then write the stability checksum to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'System or Network Simulations',
  'Operate a terminal-driven Raft cluster simulator where nodes suffer leader flapping from mis-tuned timeouts and intermittent network partitions. Diagnose logs and adjust per-node settings and links to maintain quorum and consistency across hundreds of simulated ticks.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Virtual Environments',
  'System or Network Simulations',
  'Using a provided Raft cluster simulator, bootstrap a 5‑node key-value store, write a test key, then induce controlled failures by stopping/restarting nodes to trigger leader elections while preserving linearizable reads. Verify consistency by reading the key from all nodes after recovery and write the observed leader IDs over time to /app/leader_log.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Strategy & Reasoning Games',
  'Board & Turn-Based Games',
  'Build an agent that plays terminal Battleship against a provided opponent, using probabilistic heatmaps and constraint reasoning to select shots and update an internal belief grid. Run multiple seeded matches, sink all ships, and write the shot sequences and outcomes to /app/shots.json while meeting a shots-per-game efficiency target.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Strategy & Reasoning Games',
  'Board & Turn-Based Games',
  'Create a terminal Battleship agent that connects to a line-based server, places a legal fleet, tracks hits/misses/sunk feedback, and selects shots via a probability heatmap search. It must sink the opponent’s fleet within 60 turns on at least 8/10 random seeds and write the full shot trace to /app/trace.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Strategy & Reasoning Games',
  'Board & Turn-Based Games',
  'Interact with a terminal-based Minesweeper referee that accepts reveal/flag commands on a hidden 16×16 board with 40 mines. Implement a solver that combines logical deductions and probabilistic tiebreaking to clear the board without detonations, then write the final ASCII board state to /app/board.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Strategy & Reasoning Games',
  'Board & Turn-Based Games',
  'Play a terminal-based Battleship judge on a 10×10 grid by issuing coordinate probes, interpreting hit/miss/sunk feedback, and adaptively planning to sink the entire standard fleet within a strict shot budget. Upon victory, output the exact shot sequence in order and the reconstructed final board layout to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Strategy & Reasoning Games',
  'Interactive Optimization Problems',
  'Interact with a CLI contextual multi-armed bandit simulator: each round you read feature vectors, choose one of K actions, and observe a noisy reward with occasional non-stationary drift. Implement an online policy that maximizes cumulative reward over N rounds and writes the final score and learned parameters to /app/results.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Strategy & Reasoning Games',
  'Probability & Randomized Challenges',
  'Build a terminal agent to play a non-stationary multi-armed bandit exposed via CLI/HTTP, choosing among 10 arms with stochastic rewards and occasional distribution shifts. Across 5,000 rounds, the agent must adapt online and complete with sublinear regret while writing final metrics to /app/results.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Strategy & Reasoning Games',
  'Probability & Randomized Challenges',
  'Implement a terminal agent that plays a K-armed bandit via /app/bandit, using only pull and status commands to learn unknown reward distributions under a fixed budget. The agent should employ an online algorithm (e.g., Thompson sampling/UCB) to maximize cumulative reward across randomized seeds and write a summary (seed, total reward, arm statistics) to /app/results.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Adventure & Exploration Games',
  'Play a terminal-based time-loop mystery where the facility resets every 10 in-game minutes, altering NPC schedules and door states. Across multiple loops, navigate rooms, cache items in persistent lockers, infer patterns from logs, and assemble a 6-symbol code to trigger the final shutdown and escape.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Escape Room & Challenge Scenarios',
  'Escape a submarine control room by navigating a filesystem-based map, extracting hidden clues from file metadata (timestamps, POSIX ACLs, and extended attributes) to derive access codes. Use the recovered codes to forge a CRC16-framed command over a provided pseudo-serial socket that unlocks the hatch, then capture the exact ''HATCH OPEN'' response to /app/escape.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Logic & Math Puzzles',
  'Build a cryptarithm (alphametic) solver that reads an expression like SEND+MORE=MONEY from /app/puzzle.txt, finds a valid letter-to-digit assignment with no leading zeros, and verifies the arithmetic. Write the mapping and evaluated equation to /app/solution.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Logic & Math Puzzles',
  'Implement an agent that interacts with a terminal Minesweeper server (open/flag commands over stdio), deducing safe cells strictly by logic until the board is cleared without guesses or invalid moves. Upon completion, exit gracefully and write the final grid with mines marked as ''M'' to /app/solution.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Logic & Math Puzzles',
  'Interact with a terminal-based Nonogram (Picross) game, issuing commands to fill or mark cells using the provided row and column clues to solve a 15x15 puzzle without guessing. Upon completion, capture the final revealed pattern and write the exact ASCII art to /app/nonogram.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Logic & Math Puzzles',
  'Interact with a terminal-based Nonogram (Picross) interface that provides row/column clues and accepts commands to mark cells filled/empty and validate lines. Solve the 20×15 puzzle to completion and write the exact final ASCII grid (e.g., ''#'' for filled, ''.'' for empty) to /app/solution.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Logic & Math Puzzles',
  'Solve a deterministic terminal Minesweeper instance by interacting with a CLI that prints the board and accepts reveal/flag commands, using only logical inference to avoid detonations. On success, capture the exact victory token the game prints and write it to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Word & Pattern Games',
  'Create an agent that plays a terminal Wordle-like CLI, submitting 5-letter guesses, parsing per-letter feedback (G/Y/-), and pruning a candidate list via regex and letter-count constraints to guarantee solving within six tries. Output the ordered guess list and the discovered secret word to /app/guesses.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Word & Pattern Games',
  'Create an agent to play a multi-round Regex Golf terminal game: for each round, synthesize a single POSIX ERE that matches all ‘in’ words and none of the ‘out’ words within a length budget by iteratively querying a validator binary. Output the final winning patterns for all rounds to /app/answers.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Text-Based Games & Puzzles',
  'Word & Pattern Games',
  'Solve a terminal ''regex crossword'': fill an N×N grid with A–Z so each row and column matches its provided regular expression. Use the provided /app/regex_oracle to validate partial grids and write the final ASCII grid to /app/solution.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Tool & CLI Mastery Challenges',
  'Interactive REPL Mastery',
  'Launch gdb on the provided ''vault'' ELF, interactively identify the password check routine, patch the branch condition in-memory to bypass it, run the program to reveal the secret, and write the token to /app/flag.txt. Do not modify the binary on disk; all changes must occur live in the debugger.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Interactive REPL Mastery',
  'Use the Python debugger (pdb) to load a protected script, set breakpoints to inspect the call stack and variables, and live-patch values/functions to bypass randomized checks. Continue execution to reveal the secret token and write it to /app/answer.txt.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Interactive REPL Mastery',
  'Using only the sqlite3 interactive prompt, recover a partially corrupted database with .recover into a clean DB, attach any provided shards, and execute a supplied query to derive the final secret. Use .mode and .output to write the single-line result to /app/answer.txt after verifying PRAGMA integrity_check returns ok.',
  'hard',
  ARRAY['database']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Interactive REPL Mastery',
  'Using the GNU Debugger (gdb) REPL, attach to and analyze the provided /app/lockbox binary, intercept its credential check (e.g., via breakpoints on strcmp) to recover the correct unlock token, then rerun the program to reveal the secret and write it to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Analyze an unknown ELF binary using radare2’s CLI (r2, pdf, afl, aec, izz, etc.) to locate the input check routine and recover the exact passphrase that reveals a secret when the program is run. Run the binary with the recovered input and write the secret output verbatim to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Interactive Tool Learning',
  'Use an Enigma-machine CLI emulator by consulting its --help/man to configure rotors, reflector, ring settings, plugboard, and starting positions from /app/settings.txt, then decrypt the ciphertext in /app/cipher.txt. Write the exact plaintext to /app/plain.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Interactive Tool Learning',
  'Using only tshark (learned via --help/man), analyze a provided PCAP to reconstruct an HTTP transfer, extract a base64-encoded secret from the payload, decode it, and write the exact flag to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Shell Puzzle Games',
  'Aggregate mixed-format logs (CSV, JSON, Apache) scattered in nested compressed archives and directories, then correlate timestamps and locations using only shell pipelines (find/grep/awk/jq/sort) to invalidate alibis. Identify the single culprit and write their username to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Shell Puzzle Games',
  'Recover a hidden release key by streaming through a labyrinth of nested archives and mixed-format shards, normalizing CSV/TSV/JSONL on-the-fly, key-joining records, and verifying order with checksums using a single shell pipeline. No intermediate files are allowed; write the final key to /app/results.txt.',
  'hard',
  NULL
);

-- Batch 6 complete (600 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Interactive Challenges & Games',
  'Tool & CLI Mastery Challenges',
  'Shell Puzzle Games',
  'Starting at /app/maze/start, traverse a symlink-based filesystem maze where each encountered file contains JSON giving a regex for the next filename plus a token fragment and sequence number. Using only shell tools (find, sed/awk, jq, sort), detect and avoid cycles, collect and order fragments, then base64-decode and gunzip the concatenated string to plaintext and write it to /app/answer.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'Shell Puzzle Games',
  'Traverse a directory tree containing mixed-format event fragments (logs, JSON, CSV, and filename-encoded timestamps), some nested in unlabeled archives, and normalize their heterogeneous timestamps (RFC3339, epoch ms/nanos, DOY, base36) using shell tools. After deduping by event id and globally sorting, extract one character per event to reconstruct the hidden message and write it to /app/message.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'TUI (Text User Interface) Interaction',
  'Use the tig ncurses Git interface to locate the first commit that introduced a target function signature and determine the first tag that contains it by navigating log, search, and blame views. Record the exact commit SHA and tag name to /app/results.txt as ''SHA TAG'' after exiting the TUI.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Tool & CLI Mastery Challenges',
  'TUI (Text User Interface) Interaction',
  'Using the lazygit TUI, resolve a prepared merge conflict by selectively staging hunks to restore a passing implementation, commit with the exact message ''merge-fix: OK'', and push to the provided local bare remote. After the test suite passes, write the resulting commit SHA to /app/result.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Data Augmentation & Synthesis',
  'Build a CPU-only Python CLI that reads WAV files from /app/speech, impulse responses from /app/rir, and noise from /app/noise, and synthesizes an augmented set by convolving speech with a chosen RIR and mixing noise at randomized target SNRs, resampling as needed and peak-normalizing to -1 dBFS without clipping. Save 16-bit PCM WAVs under /app/aug deterministically given a --seed and write /app/aug/metadata.csv listing source paths, chosen RIR/noise, SNR, RT60 estimate of the RIR, output path, and random seed.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Data Augmentation & Synthesis',
  'Create a Python CLI that ingests multivariate IoT sensor readings from /app/sensor.csv, trains a variational autoencoder on normal windows, then synthesizes a balanced dataset with labeled normal and anomalous sequences by sampling and latent-space perturbations plus jitter, scaling, and time-warp augmentations. Save train/val/test Parquet files (fixed-length windows) and a manifest JSONL capturing augmentation provenance to /app.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Data Cleaning & Preprocessing',
  'Build a CLI pipeline that ingests multiple vendor CSVs of product listings with mixed encodings, locale-specific number/currency formats, and heterogeneous timestamp columns, then standardizes them. Normalize text to UTF-8 NFC, parse dates to UTC ISO-8601, harmonize decimal/thousand separators, convert currencies via a provided FX table, impute missing numeric fields per-category with robust medians, remove outliers via MAD, deduplicate by SKU/title similarity, and write a cleaned Parquet plus a data-quality summary JSON.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Data Cleaning & Preprocessing',
  'Create a CLI that consolidates multi-sensor time-series CSVs with differing time zones and sampling rates: normalize timestamps to UTC, auto-detect and correct per-sensor clock drift via alignment to a shared ''sync'' channel, resample to 1 Hz, impute gaps ≤5s, and flag/remove outliers using robust MAD. Save the cleaned dataset to Parquet and emit a JSON audit of imputations, drift corrections, and outlier statistics to support reproducibility.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI that performs a purged, group-aware time-series split with an adjustable embargo to prevent leakage, using entity_id as the group and preserving chronological order. It must output train/val/test CSVs that maintain marginal and pairwise label co-occurrence within ±2% via iterative multi-label stratification and emit a JSON report of balance and leakage diagnostics.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Dataset Splitting & Sampling',
  'Implement a Purged Group Time Series Split that creates train/validation/test indices for timestamped events grouped by an entity_id, enforcing a configurable gap and embargo to prevent temporal leakage while approximately preserving class balance via quantile-based stratification. Provide a CLI that reads /app/events.csv and writes split index files plus a JSON report with leakage checks and per-split label prevalence.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Dataset Splitting & Sampling',
  'Implement a deterministic multi-label, group-aware stratified k-fold splitter with an optional time-based embargo to prevent leakage across folds. Provide a CLI that reads id/group_id/timestamp/labels columns and outputs per-fold splits plus a JSON report of label balance, zero group overlap, and temporal ordering, scaling to millions of rows via streaming.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Feature Extraction & Transformation',
  'Build a CPU-only Python CLI that loads directed graphs from /app/graphs/*.edgelist and computes reproducible 128-dimensional node2vec embeddings via fixed-seed random walks and skip-gram training, writing /app/embeddings/{graph}.npy and a matching {graph}_nodes.txt listing nodes in row order. Ensure deterministic node ordering across runs, gracefully handle disconnected nodes, and fit any walk/model parameters using only the provided train split to prevent leakage.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Feature Extraction & Transformation',
  'Build a Python CLI that performs leakage-safe out-of-fold target encoding and frequency encoding for multiple high-cardinality categorical columns on a time-stamped dataset using chronological folds with smoothing and optional noise regularization. Output transformed train/test Parquet files and a reusable encoder artifact to ensure consistent application on future data.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data Preparation & Feature Engineering',
  'Feature Extraction & Transformation',
  'Create a Python CLI that reads an edge list from /app/graph.csv and computes per-node features including node2vec embeddings and structural metrics (degree, betweenness, clustering coefficient, PageRank), then standardizes and writes a single feature table with a node_id column to /app/node_features.parquet. Ensure deterministic results with fixed RNG seeds and correct handling of isolated nodes and disconnected components.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Implement a Mixture-of-Experts Transformer feed-forward block in PyTorch with top-2 gating, capacity-based token dispatch (including overflow handling), and an auxiliary load-balancing loss. Integrate it into a small decoder-only model and provide tests for routing correctness, gradient flow, and equivalence to a dense FFN when num_experts=1.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Architecture Design & Implementation',
  'Implement a PyTorch LoRA adapter system that injects low‑rank adapters into a vanilla Transformer’s attention (Q, K, V, and output) and MLP projections, with per-module rank/alpha settings, freezing of base weights, and precise merge/unmerge of adapters into the backbone. Provide a CLI that trains only the adapters on a tiny language-modeling corpus and verifies identical logits pre/post-merge within a tight tolerance while confirming no non-adapter parameters changed.',
  NULL,
  ARRAY['pytorch', 'modeling']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Deep Learning & Neural Network Engineering',
  'Architecture Design & Implementation',
  'Implement a PyTorch Mixture-of-Experts Transformer block with top-2 routing, per-expert capacity with token dropping, and an auxiliary load-balancing loss, supporting variable sequence lengths and attention masks. Ensure numerically stable, deterministic routing and gradient flow across dtypes on CPU, and include a small CLI to verify balanced expert utilization on synthetic data.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Loss Function Design & Custom Layers',
  'Implement a PyTorch Soft-DTW loss with numerically stable forward/backward that supports batched variable-length sequences via padding masks, per-sample Sakoe–Chiba windows, and mixed precision. Provide a TemporalAlignment layer that uses the expected alignment matrix to differentiably warp sequences for downstream models.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Loss Function Design & Custom Layers',
  'Implement a batched Soft-DTW loss with padding masks and an optional Sakoe–Chiba band for variable-length time-series, plus a custom temporal attention pooling layer that uses differentiable DTW alignment scores as attention weights. The components must run on CPU/GPU, support mixed precision, and be memory-efficient enough to handle sequences up to length 10k.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Loss Function Design & Custom Layers',
  'Implement a custom TokenDropAttention layer for a tiny Transformer that learns to stochastically drop uninformative tokens via Gumbel-Softmax gates, paired with a sparsity-consistent KL loss enforcing a user-specified target keep-rate with temperature annealing and mixed-precision safety. Train on a synthetic sequence classification dataset and verify via tests that the achieved keep-rate is within tolerance and that accuracy drop versus a vanilla attention baseline stays below a threshold.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Loss Function Design & Custom Layers',
  'Implement a differentiable sorting-based Top-k pooling layer (NeuralSort/SoftSort) and a listwise NDCG surrogate loss in PyTorch to train a ranking model on variable-length item lists with padding masks. The layer and loss must be numerically stable in fp16/fp32, efficient on long lists, and include gradient checks and input validation.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Training Stabilization Techniques',
  'Implement a PyTorch character-level LSTM trained on Tiny Shakespeare with two runs: an unstable baseline and a stabilized variant using dropout, gradient clipping, label-smoothed cross-entropy, and a warmup+cosine learning rate schedule. Log gradient norms and NaN/Inf checks, and verify the stabilized run achieves a target perplexity while the baseline shows exploding gradients or divergence.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Training Stabilization Techniques',
  'Train a compact Transformer for character-level language modeling on long sequences, implementing stabilization features: gradient clipping (by norm and value), warmup+cosine LR scheduling, dropout, label smoothing, and EMA/SWA of weights. Provide a CLI to ablate each component, log per-step gradient norms and NaN/Inf events to /app/stability_log.json, and save the best-perplexity checkpoint.',
  NULL,
  ARRAY['modeling']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Training Stabilization Techniques',
  'Write a PyTorch training script for CIFAR-10 that stabilizes an intentionally aggressive setup (large LR, small batch) using mixed precision with dynamic loss scaling, adaptive gradient clipping (AGC), linear warmup plus cosine decay scheduling, and EMA of weights with switchable BatchNorm/GroupNorm and dropout. Tests verify no NaNs/Inf, bounded gradient norms, correct LR schedule behavior, and a validation curve that is smoother and at least as good as a baseline without these techniques.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Visualization & Debugging',
  'Build a Python CLI that loads a PyTorch ResNet-18 and, via forward/backward hooks on a small image batch, saves per-layer activation/gradient histograms (PNGs), a gradient-flow plot, and a dead-ReLU heatmap. Write a debug_report.json summarizing per-layer gradient norms and flagging any vanishing/exploding gradients.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Deep Learning & Neural Network Engineering',
  'Visualization & Debugging',
  'Create a PyTorch script that hooks into a ResNet-18 training on CIFAR-10 to record per-layer activation histograms, activation sparsity, and gradient norms across one epoch, automatically flagging layers with saturation or vanishing/exploding gradients. Produce a self-contained HTML report of these visuals and save Grad-CAM overlays for the top-3 misclassified images.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Data & Model Sharding',
  'Build an expert-parallel Mixture-of-Experts layer that shards experts across ranks and routes tokens via top-2 gating with a capacity factor, using all_to_all to dispatch to per-rank experts and recombining to the original order. Provide an unsharded reference and ensure numerical parity and gradient correctness across world_size 1/2/4, with support for dropless/drop policies, variable sequence lengths, and mixed precision.',
  'hard',
  ARRAY['parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Data & Model Sharding',
  'Implement 1D tensor-parallel sharding for GPT-style attention and MLP in PyTorch with custom ColumnParallelLinear/RowParallelLinear layers using torch.distributed (Gloo), including forward/backward collectives (all-gather/reduce-scatter) and model-parallel RNG. Provide a test script that trains a tiny Transformer on synthetic data across 2–4 ranks and verifies numerical parity with an unsharded reference, correct gradient synchronization, and that memory per rank drops below a set threshold.',
  'hard',
  ARRAY['parallel', 'pytorch', 'distributed']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Foundation Models & Large-Scale Systems',
  'Data & Model Sharding',
  'Implement CPU-only tensor parallelism for a single Transformer block using torch.distributed (Gloo), sharding QKV and MLP weights across two ranks with column/row-parallel matmuls and the necessary all-reduce/concat steps. Provide a script that verifies forward/backward parity with an unsharded baseline to 1e-5 and reports per-rank parameter and optimizer memory to demonstrate sharding benefits.',
  'hard',
  ARRAY['distributed', 'parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Foundation Models & Large-Scale Systems',
  'Data & Model Sharding',
  'Implement a minimal ZeRO Stage-2 optimizer in PyTorch that shards Adam states and gradients across ranks, using reduce-scatter for gradient partitioning and on-demand all-gather of parameters for forward passes. Train a small model on synthetic data and verify numerical parity with an unsharded baseline, correct save/load of sharded checkpoints, and peak memory reduction for world_size 1, 2, and 4.',
  'hard',
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Distributed & Parallel Training Infrastructure',
  'Launch a PyTorch FSDP training job for a small Transformer on synthetic sequence data across 4 local ranks with torchrun, enabling mixed precision and activation checkpointing, and write sharded checkpoints plus a script to consolidate them into a single state_dict.pt. Provide a baseline DDP run and verify that resuming from the sharded checkpoint reproduces validation loss within tolerance and that peak memory per rank is at least 30% lower than DDP.',
  'hard',
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Inference Optimization at Scale',
  'Deploy a BERT-base encoder in NVIDIA Triton with two TensorRT backends (FP16 and INT8 calibrated from /app/calib), enable dynamic batching and concurrent instance groups, and write a Python client that drives variable-length requests over HTTP to collect p50/p95 latency and throughput. Validate that the INT8 engine achieves at least 1.8x throughput over a PyTorch eager baseline on the same hardware and emit a JSON report to /app/metrics.json.',
  'hard',
  ARRAY['python', 'pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Inference Optimization at Scale',
  'Stand up a CPU-only Triton Inference Server hosting an INT8-quantized DistilBERT ONNX model via the ONNX Runtime backend, configured with dynamic batching and multiple instances, then load-test batch sizes {1, 8, 32, 128}. Validate outputs against an FP32 baseline within tolerance and write a JSON report summarizing per-batch throughput plus p50/p99 latency scraped from Triton’s /metrics endpoint.',
  NULL,
  ARRAY['backend']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Large Model Fine-Tuning & Adaptation',
  'Fine-tune a small causal LM (e.g., GPT-2) with PEFT to produce two separate LoRA adapters on two distinct domains (e.g., prose and code) in a CPU-only setting. Implement inference-time weighted composition of the adapters to blend or route behaviors, then save individual/composed adapters and a merged variant, and report a metrics JSON comparing cross-entropy/perplexity across domains and blends.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Large Model Fine-Tuning & Adaptation',
  'Implement a soft prompt-tuning pipeline for a decoder-only LLM (e.g., distilgpt2) that learns K virtual tokens while freezing all base weights. Provide scripts to train on data/, save/load the prompt embeddings, verify perplexity improvement on a held-out split, and generate completions for prompts.txt into outputs.jsonl with deterministic seeds.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Foundation Models & Large-Scale Systems',
  'Large Model Fine-Tuning & Adaptation',
  'Implement soft prompt tuning for a small causal LM (e.g., distilgpt2) to learn k virtual tokens for reversible date format conversion on a tiny synthetic dataset, keeping the base model frozen. Save the learned prompt vectors separately and provide an inference script that attaches them to the base model to generate outputs for test inputs, writing predictions to /app/date_convert.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a Python CLI that runs an offline Weights & Biases sweep of 8 trials for a scikit-learn imbalanced binary classifier, performing 5-fold CV per trial and logging per-fold metrics, aggregated results, confusion matrices, and the best model as artifacts under a single grouped sweep. Enable run resumption, and export a self-contained wandb-export.tar.gz with all offline run data to /app/wandb_export plus a best_trial.json summarizing chosen hyperparameters and metrics.',
  NULL,
  ARRAY['python', 'logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Experiment Tracking & Logging',
  'Configure and execute a Weights & Biases hyperparameter sweep in offline mode that trains a scikit-learn model with StratifiedKFold, logging hyperparameters, per-fold AUC/accuracy, ROC curves, and saving the fitted estimator as a W&B artifact for each run. After the sweep completes, programmatically identify the best run by mean AUC and write its run ID, config, and artifact file path to /app/best_run.json.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Experiment Tracking & Logging',
  'Create a Python CLI that runs 5-fold cross-validation with hyperparameter search, using MLflow to record a parent run and nested child runs per trial and fold with parameters, metrics, and artifacts (ROC/PR plots, confusion matrices, and serialized models). The CLI must support resuming by skipping completed child runs, produce an aggregated leaderboard.csv, and register the best model with signature and input example in the Model Registry.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Experiment Tracking & Logging',
  'Implement a resumable training pipeline that uses MLflow to start a run, log hyperparameters and per-epoch metrics, save checkpoints, then intentionally crashes mid-training. On re-execution it must detect state and resume the exact same run_id (start_run with run_id), continue logging without duplicating epochs, record environment snapshots (pip freeze and git commit) and a learning-curve artifact, and write the run_id to /app/run_id.txt.',
  NULL,
  ARRAY['logging', 'git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Model Registry & Versioning',
  'Create a Python CLI that publishes trained models as OCI artifacts to a local Docker registry (registry:5000), storing model weights and a metadata.json layer with code/data hashes, metrics, and dependency manifest. Support semver tags and aliases (staging/production), integrity verification by content digest, version comparison by a chosen metric, and atomic promote/rollback of the production alias.',
  NULL,
  ARRAY['python', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Model Registry & Versioning',
  'Create a schema-aware local model registry that assigns semantic versions (MAJOR/MINOR/PATCH) when registering scikit-learn models by diffing input schema, hyperparameters, and data hashes. Provide a CLI to register, list, and promote versions with stage transitions and a ''champion'' alias, then verify by loading the Production model to score a held-out set.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Model Registry & Versioning',
  'Start a local MinIO S3 server on localhost:9000 and configure a DVC remote (s3://model-registry) to serve as a centralized model registry for versioned model artifacts and metrics. Train two scikit-learn models, push both versions with semantic tags (e.g., v0.1.0, v0.2.0), implement a promote.py CLI to label Staging/Production in a bucket-hosted registry.json, and demonstrate a rollback to the prior Production version.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Pipeline Construction & Scheduling',
  'Create an Apache Airflow DAG that monitors /app/current.csv, computes data drift against /app/reference.csv with Evidently, and branches to either retrain/evaluate a scikit-learn model or skip retraining when drift is below a threshold. The DAG must be scheduled daily with retries and SLAs, use XCom to pass metrics, persist artifacts to /app/, and implement a file-content hash to cache and skip redundant training.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Pipeline Construction & Scheduling',
  'Create an Apache Airflow DAG that uses dynamic task mapping to run k-fold cross-validation (download/validate data, per-fold training, metric logging, aggregation) and conditionally register the model only if the averaged score exceeds a threshold. Package it for a local Dockerized Airflow setup, schedule it to run daily, ensure idempotent runs, and persist all artifacts/metrics under /app/artifacts.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Machine Learning Pipelines & Automation',
  'Reproducibility & Environment Setup',
  'Create a Nix flake that defines a hermetic Python 3.11 environment with pinned NumPy, pandas, and scikit-learn, plus a CLI that trains a logistic regression on /app/data.csv with fixed seeds. Add a Makefile target that builds the flake and runs the training twice in fresh pure shells, asserting identical SHA256 hashes for model.pkl and metrics.json to confirm bit-for-bit reproducibility.',
  NULL,
  ARRAY['python', 'pandas']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a Python CLI that runs repeated StratifiedGroupKFold cross-validation to produce out-of-fold predictions for two classifiers, with options for class-weighting to handle imbalance. Compute ROC-AUC/PR-AUC means and bootstrap CIs, apply the Nadeau–Bengio corrected resampled t-test and McNemar’s test to assess performance differences, and write a summary report to /app/results.json.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Cross-Validation & Statistical Testing',
  'Create a Python CLI that loads /app/adult.csv and runs nested stratified 5x2 cross-validation comparing tuned logistic regression and tuned random forest on F1 and PR-AUC, then applies Dietterich''s 5x2cv paired t-test and bootstrap 95% CIs for metric differences, writing /app/fold_predictions.csv and /app/eval_report.json with p-values, effect sizes, and CIs. Use fixed seeds for reproducibility, handle class imbalance, and hard-fail if variance across folds is zero.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Cross-Validation & Statistical Testing',
  'Implement a CLI that compares two classifiers on /app/data.csv using nested stratified 5x2 cross-validation, reporting ROC-AUC and F1 per fold. Assess significance with Dietterich’s 5x2cv paired t-test and DeLong’s AUC test, and output a reproducible JSON containing fold scores, BCa bootstrap 95% CIs, and overall p-values.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Cross-Validation & Statistical Testing',
  'Implement a CLI that runs Dietterich’s 5x2 cross-validation paired t-test to compare LogisticRegression and RandomForest on the scikit-learn breast cancer dataset with stratification and fixed seeds. Aggregate out-of-fold predictions to compute ROC AUC and Average Precision with bootstrap 95% CIs, and write per-fold metrics, the t statistic, p-value, and a significance verdict to results.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI that ingests a CSV of binary classifier outputs (y_true, y_score, group) and generates reliability diagrams with bootstrap CIs, ROC/PR curves, and score histograms, saving plots to /app/eval. It must choose a decision threshold that minimizes expected cost from user-specified FP/FN costs, then emit per-group confusion matrices and a summary JSON reporting ECE, MCE, Brier, AUROC/AUPRC, and the worst-affected groups.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Error Analysis & Visualization',
  'Build a CLI that ingests multiclass predictions (logits or probabilities) and ground-truth labels, computes calibration metrics (ECE/MCE, class-conditional ECE, Brier, NLL) with bootstrap confidence intervals, fits temperature scaling on a validation split, and recomputes metrics post-calibration. Output adaptive-binning reliability diagrams, confidence histograms, and per-class normalized confusion matrices highlighting top confusable pairs, and save a concise markdown report linking all figures.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Error Analysis & Visualization',
  'Build a CLI that ingests multiclass softmax predictions and ground-truth labels from CSVs in /app/preds/{train,val,test} (optionally including a ''group'' column) and generates per-group confusion matrices and reliability diagrams. Fit temperature scaling on the validation split, then save before/after ECE and Brier scores, interactive HTML plots, and a JSON metrics summary to /app/report.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Error Analysis & Visualization',
  'Create a Python CLI that evaluates multivariate time-series forecasts against ground truth, computing per-horizon sMAPE, MASE, and prediction-interval coverage, and generates horizon-wise error heatmaps plus overlay plots of predictions vs. actuals for the worst 10 series by MASE. Write a metrics.json and PNG plots to /app/output while streaming to handle >1e6 points with numerically stable aggregations.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Metric Computation & Reporting',
  'Build a CLI that ingests CSVs of true labels and model logits/probabilities for in-distribution and OOD samples, fits a single temperature on a validation split, and computes accuracy, macro-F1, ROC-AUC, PR-AUC, NLL, Brier score, ECE/MCE (fixed and adaptive bins), and OOD AUROC/AUPR/FPR@95 using MSP and energy scores. Output a metrics.json and per-class.csv plus reliability diagrams and score histograms with strict input validation and numerically stable computations.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Evaluation & Validation',
  'Metric Computation & Reporting',
  'Create a CLI that ingests a Parquet file containing multilabel ground-truth indicators and model score columns, learns per-label thresholds on a validation split to maximize macro-F1, then evaluates the test split with those thresholds. Output a JSON report with per-label precision/recall/F1, micro/macro averages, LRAP, coverage error, Jaccard index, and the chosen thresholds, and write per-label 2x2 confusion matrices to CSV.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Inference & Serving',
  'Batch & Online Inference',
  'Build a dual-mode inference app around an ONNX image classifier using onnxruntime: a CLI that runs batched CPU inference over all images in /app/images and writes predictions.csv, and a lightweight HTTP server exposing /predict for single-image requests with lazy, thread-safe model loading and unified preprocessing. Implement optional dynamic batching on the server (short timeout window) and enable onnxruntime CPU optimizations for consistent, reproducible outputs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Inference & Serving',
  'Batch & Online Inference',
  'Export a pretrained torchvision MobileNetV2 to ONNX, then implement an ONNX Runtime-powered FastAPI endpoint for online top-5 ImageNet predictions and a batch script that scores all images in a directory. Include optional dynamic quantization and write JSONL predictions plus latency/throughput metrics for the batch run.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Inference & Serving',
  'Batch & Online Inference',
  'Export a pretrained torchvision ResNet-18 to ONNX and implement a CPU-only FastAPI service backed by ONNX Runtime that supports single-image and dynamic micro-batched inference (≤50 ms window). Provide a CLI for offline batch predictions over a folder, saving top-5 classes per image and recording throughput and p95 latency to /app/metrics.json for both online and batch modes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Inference & Serving',
  'Latency & Throughput Optimization',
  'Build an async Python inference server for a small Hugging Face Transformer that adds micro-batching (time-windowed), dynamic int8 quantization, and a tokenizer cache. Provide a replay benchmark that outputs baseline vs optimized p50/p95 latency and throughput to a JSON report.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Export a PyTorch sequence model to both TorchScript (scripted) and ONNX with dynamic axes and opset 17, saving weights in safetensors with strictly pickle-free serialization. Provide a CLI that loads the exported artifacts on CPU, runs onnxruntime and TorchScript inference on the same inputs, and asserts numerical parity within a tight tolerance.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Inference & Serving',
  'Model Export & Serialization',
  'Implement a CLI that builds a variable-length batched BiLSTM tagger in PyTorch using PackedSequence, exports it to TorchScript and ONNX (opset 17) with dynamic batch and sequence length, and provides an ONNX-compatible unpacking path. Validate numerical parity across eager PyTorch, TorchScript, and ONNX Runtime on randomized inputs, saving all artifacts and a sample input under /app/export.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Add LoRA adapters to a pretrained T5-small and fine-tune on a local summarization dataset in /app/data (train.jsonl, val.jsonl) while freezing all base weights, then export both an adapter-only checkpoint and a merged full model. Verify base weights are bitwise-identical pre-merge, that the merged model matches adapter outputs on a fixed prompt, and that ROUGE-L on val improves over the frozen baseline.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Fine-Tuning Pretrained Models',
  'Fine-tune T5-small with parameter-efficient prefix tuning to translate English task descriptions into Bash one-liners on a provided dataset; evaluate exact match and BLEU on a held-out split, and save both the prefix adapter and a merged model plus predictions.json to /app.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Hyperparameter Optimization',
  'Build an Optuna multi-objective HPO pipeline that trains a tabular classifier (XGBoost if installed, otherwise scikit-learn GradientBoosting) with stratified K-fold CV to jointly minimize validation log loss and 95th-percentile per-sample prediction latency. Implement pruning, class-imbalance handling, and a dynamic search space conditioned on the chosen estimator, then export the selected Pareto-optimal trial’s hyperparameters, a serialized model, and a small report of the Pareto front.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Hyperparameter Optimization',
  'Run a multi-objective Optuna study to tune a CPU-only LightGBM classifier on the UCI Adult income dataset, maximizing ROC-AUC while minimizing p95 inference latency over 10k predictions. Persist the study, write the Pareto front with hyperparameters to JSON, and export the fastest Pareto-optimal model artifact to /app.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Model Training & Optimization',
  'Resource Management & Parallel Training',
  'Build a PyTorch DDP training harness that runs a small CNN on synthetic data in both single-process and 4-rank torchrun modes, auto-selecting CPU/GPU and gloo/NCCL while pinning one device per rank and using gradient accumulation with optional AMP to keep the effective batch size constant. Log images/sec per rank, global throughput, speedup vs single-process, and (if GPUs exist) per-GPU memory/utilization via nvidia-smi, saving a final JSON/CSV report.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Resource Management & Parallel Training',
  'Build a PyTorch training launcher that runs a small CNN under DistributedDataParallel across all available GPUs (falling back to multi-process CPU via gloo), automatically selecting the largest per-device microbatch via OOM-aware binary search and using gradient accumulation to hit a target global batch size. Record per-rank and averaged throughput, communication overlap vs non-overlap timings, and memory usage to a CSV, and support resuming checkpoints when world_size changes.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Resource Management & Parallel Training',
  'Implement a PyTorch training launcher that uses torchrun to start DistributedDataParallel across all detected GPUs (falling back to multi-process CPU with Gloo), pins each rank to a device, and enables AMP on CUDA. Log per-rank throughput (images/sec) and memory stats to a shared JSONL and aggregate a final /app/throughput.json confirming that multi-GPU total throughput scales over a single process baseline.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Supervised & Unsupervised Learning',
  'Learn a supervised metric using scikit-learn’s Neighborhood Components Analysis on labeled data, then perform k-means clustering in the learned embedding on the full dataset. Save cluster assignments and evaluate clustering quality with adjusted mutual information and silhouette scores to a metrics file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Model Training & Optimization',
  'Training Loop Implementation',
  'Implement a pure-PyTorch training loop for a CNN on a synthetic image dataset with gradient accumulation, automatic mixed precision (CPU/GPU fallback), global-norm gradient clipping, cosine-annealing learning-rate scheduling, and early stopping on a validation metric. Add robust checkpointing that saves and restores model/optimizer/scheduler states, best metric, and dataloader progress to resume mid-epoch or after SIGINT/SIGTERM, producing both latest and best artifacts.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Reinforcement Learning & Simulation-Based Training',
  'Environment Setup & Policy Training',
  'Build a CLI that reads a JSON-specified stochastic GridWorld (walls, terminal states, slip probability) and trains a tabular Q-learning agent with epsilon-greedy exploration and learning-rate decay to learn an optimal policy. Support variable map sizes and multiple maps in a folder, ensure deterministic seeding, evaluate the greedy policy to meet a success-rate threshold, and save both the Q-table and a human-readable policy artifact.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Environment Setup & Policy Training',
  'Build a PettingZoo AEC multi-agent predator–prey gridworld with optional message-passing actions and invalid-move masking, register it with Gymnasium, and configure RLlib to train decentralized PPO policies with GAE, vectorized rollout workers, and resume-from-checkpoint support. Evaluate on held-out procedurally generated maps (fixed seed) and require a ≥0.70 predator win rate over 100 episodes while logging training metrics to TensorBoard.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Environment Setup & Policy Training',
  'Create a custom Gymnasium environment backed by a SimPy discrete-event simulation of a two-station production line with stochastic arrivals and a controllable dispatch/batching policy. Train a Stable-Baselines3 PPO agent on CPU to minimize average job latency, logging learning curves and saving a checkpoint and evaluation report that demonstrates at least a 20% latency reduction versus a fixed-rate heuristic baseline.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Environment Setup & Policy Training',
  'Create and register a custom Gymnasium environment ''ThermalControl-v0'' whose dynamics (heat capacity, loss rate, actuator limits, and disturbance sequence) are loaded from /app/dynamics.yaml, and train a Soft Actor-Critic agent with stable-baselines3 (automatic entropy tuning) to keep temperature within a target band via domain-randomized episodes. Save the trained policy to /app/checkpoints and a 100-episode seeded evaluation log (time, state, action, reward) to /app/eval.csv for automated verification.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Environment Setup & Policy Training',
  'Install Ray RLlib with PettingZoo and SuperSuit, configure the MPE simple_spread_v3 multi-agent environment, and train a shared-parameter PPO policy using vectorized parallel environments. Export the trained policy to TorchScript and run a seeded evaluation that writes per-agent rewards and coverage metrics to /app/mpe_eval.json.',
  NULL,
  ARRAY['parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Multi-Agent & Self-Play Training',
  'Implement a self-play Counterfactual Regret Minimization trainer for Kuhn Poker with a minimal game engine including chance nodes, information-set caching, and average-strategy export. The script should train to a low-exploitability policy verified by a best-response evaluator, be reproducible via seeding, and finish on CPU within tight time limits.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Multi-Agent & Self-Play Training',
  'Implement a self-play training pipeline for Connect Four using OpenSpiel where a PyTorch policy–value network is optimized via AlphaZero-style MCTS. After training, evaluate against a depth-limited minimax baseline over 100 games and save win/draw/loss and Elo metrics to /app/results.json.',
  NULL,
  ARRAY['pytorch']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Multi-Agent & Self-Play Training',
  'Implement from-scratch CFR+ self-play for Kuhn Poker with a CLI to train for N iterations and compute exploitability via an exact best response. Save the average strategy to /app/kuhn_policy.json and ensure the final policy’s exploitability is ≤0.05 chips.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Multi-Agent & Self-Play Training',
  'Train a near-Nash strategy for Kuhn Poker via self-play Counterfactual Regret Minimization (CFR/CFR+) using OpenSpiel (pyspiel), then serialize the average policy and compute exploitability. Produce a policy artifact and a metrics report demonstrating exploitability below a specified threshold.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Reward Design & Evaluation',
  'Implement a Gymnasium-compatible ''Windy Keys-and-Doors'' gridworld and design a potential-based reward shaping function that balances goal completion, energy use, and safety while preserving the optimal policy. Provide a training/evaluation script that compares shaped vs. sparse rewards (e.g., with tabular Q-learning), demonstrating faster learning and fewer collisions, verifying equal optimal returns, and flagging reward-hacking behaviors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reinforcement Learning & Simulation-Based Training',
  'Reward Design & Evaluation',
  'Implement a custom Gymnasium GridWorld with a sparse goal reward, time penalty, and stochastic hazard tiles, then compare two rewards: potential-based shaping via Manhattan-distance potential and a naive per-step progress bonus. Train PPO under both and report success rate, hazard contacts, and path optimality gap to highlight shaping invariance vs reward hacking.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Reinforcement Learning & Simulation-Based Training',
  'Simulation Rollouts & Replay Buffers',
  'Implement a disk-backed prioritized replay buffer daemon that ingests CartPole-v1 transitions from multiple local producer scripts over TCP, computes n-step returns across episode boundaries, and persists state for crash-safe restart. Provide a client to sample mini-batches with PER (alpha/beta) and importance weights, with a test harness that verifies sampling distribution, deterministic checksums for sampled batches, and replay continuity after restart.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Adversarial Robustness & Defense',
  'Implement a CPU-only Python CLI that loads a provided CIFAR-10 model, wraps it with a non-differentiable defense (bit-depth reduction plus randomized resizing), and evaluates robust accuracy under FGSM, PGD, and BPDA+EOT-PGD. Save per-attack metrics to /app/robust_metrics.json and 32 adversarial samples per attack to /app/adv/{attack}/, demonstrating that BPDA+EOT meaningfully reduces reported robustness compared to naive PGD.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Adversarial Robustness & Defense',
  'Train a small CNN on MNIST (CPU) and implement FGSM and PGD-Linf attacks. Add a feature-squeezing detector (bit-depth reduction + median smoothing) and an adversarially trained variant, then report clean/robust accuracy at eps=0.3 and ROC-AUC for detection, saving metrics and checkpoints.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Adversarial Robustness & Defense',
  'Train a small CNN on a CIFAR-10 subset, wrap it with an L2 randomized smoothing certifier (configurable sigma), and compute per-example certified radii with 95% confidence for 200 test images, writing certificates.csv and a summary JSON. Implement an EOT-PGD attack that accounts for the smoothing noise and report robust vs attacked accuracies across L2 epsilons, verifying certified accuracy lower-bounds are not violated.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Bias Detection & Mitigation',
  'Create a Python CLI that loads /app/data.csv with features, label, and protected_attribute, audits a logistic-regression baseline via demographic parity difference, equalized odds difference, and calibration within groups, then mitigates bias using reweighting plus group-wise threshold optimization. Write a before/after fairness report to /app/fairness_report.json, requiring <2% accuracy drop and at least 50% reduction in each measured disparity.',
  NULL,
  ARRAY['python', 'optimization']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Responsible AI & Model Robustness',
  'Bias Detection & Mitigation',
  'Create a Python CLI that trains a binary classifier on a tabular dataset, scans all intersectional subgroups (combinations of up to 3 sensitive attributes) to find the worst demographic parity difference and equalized odds violation, and then applies a per-group threshold optimizer to reduce violations below a target while keeping overall AUC within 2%. Output a before/after fairness report (JSON) and save the calibrated, debiased model and the learned group thresholds.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Machine Learning & AI',
  'Responsible AI & Model Robustness',
  'Ethical & Policy Compliance Validation',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Ethical & Policy Compliance Validation',
  'Build a CLI that audits a JSONL training dataset and a local text-generation model for policy compliance by verifying data provenance (required source_url and license in an allowed whitelist) and detecting/redacting PII (emails, phones, addresses, SSNs) with deterministic hashing. Run a fixed red-teaming prompt suite against the model to flag PII leakage and disallowed content, then emit a compliance_report.json with per-rule counts, sample snippets, thresholds, overall pass/fail, and a sanitized_data.jsonl output.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Explainability & Interpretability',
  'Create a CLI tool that trains a scikit-learn tabular classifier on a provided CSV, computes per-sample SHAP (TreeExplainer) and LIME attributions, and writes unified explanations to /app/explanations.json with global summaries. Evaluate faithfulness by producing deletion/insertion curves that mask features by attribution rank, outputting Kendall rank agreement and AUC metrics to /app/faithfulness.csv with deterministic seeding and memory‑efficient batching.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Responsible AI & Model Robustness',
  'Explainability & Interpretability',
  'Train a gradient boosting classifier on the UCI Adult dataset and generate local explanations for 20 test instances using both SHAP and LIME. Implement a faithfulness evaluation via deletion/insertion curves over ranked features, report AUC metrics for each method, and save per-instance attributions (JSON) and summary plots to /app/.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Astronomy & Astrophysics Computation',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Domain-Specific Computation',
  'Astronomy & Astrophysics Computation',
  'Build a Python CLI that reads a time–flux light curve from /app/lightcurve.csv, robustly detrends it, and uses a Box Least Squares search to detect the strongest transiting-planet signal. Write the inferred period, transit epoch, depth, duration, and SNR to /app/transit.json and save the phase-folded, binned light curve to /app/phase.csv.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Domain-Specific Computation',
  'Astronomy & Astrophysics Computation',
  'Implement a CLI tool that ingests asteroid astrometric observations in MPC 80-column format, computes a preliminary orbit (e.g., Gauss) and refines it via weighted least-squares differential corrections. Propagate the fitted state to a target UTC with a two-body Kepler solver and write osculating elements, residual RMS, and a topocentric RA/Dec ephemeris from a specified observatory code.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Domain-Specific Computation',
  'Computational Chemistry & Biology',
  'Using COBRApy, load the provided SBML metabolic network, configure exchange reactions to model aerobic minimal media with glucose, and maximize biomass to compute the optimal growth rate. Then perform a single-gene deletion screen to identify essential genes under these conditions and write the growth rate and the sorted essential gene IDs to output files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a 1D compressible gas dynamics solver for the Sod shock tube using a conservative finite-volume scheme (MUSCL-Hancock with HLLC flux and CFL control) from Riemann initial data, and write density/velocity/pressure profiles at specified times. Include a check that total mass and total energy are conserved to within a small tolerance.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Domain-Specific Computation',
  'Physics & Engineering Simulation',
  'Implement a 1D compressible Euler solver to simulate the Sod shock tube using a finite-volume Godunov scheme (e.g., HLLC) with CFL-controlled timestepping and positivity preservation. Output density, velocity, and pressure profiles at specified times and report L1 error against the analytic solution.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Domain-Specific Computation',
  'Physics & Engineering Simulation',
  'Implement an Euler–Bernoulli beam finite element solver for a uniform clamped–clamped beam that assembles mass and stiffness matrices and computes the first three natural frequencies and mode shapes. Validate the frequencies against closed-form solutions within 2% and save frequencies and mode shapes to specified output files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Matrix & Vector Operations',
  'Implement a Python CLI that loads A, B, C from /app/*.npy and solves A X B = C for X using factorization-based linear solves without forming the Kronecker product (e.g., via LU/QR and column/row reshaping), with an option for Tikhonov regularization. Save X to /app/output/X.npy and a metrics JSON including relative residual (target ≤ 1e-8) and simple condition estimates.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Numerical Integration & Differentiation',
  'Implement a Python tool that loads a parameterized ODE and scalar loss from a problem module, integrates forward to produce state samples at given eval_ts, then computes dL/dθ via a reverse-time continuous adjoint solve with accurate interpolation of the forward trajectory. Output the trajectory and gradient along with a verification report that checks the adjoint gradient against central finite differences within a specified tolerance.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Numerical Integration & Differentiation',
  'Implement an adaptive Gauss–Kronrod 21/10 quadrature with a best-first error priority queue that handles infinite limits and endpoint algebraic/log singularities via variable transformations, enforcing absolute/relative tolerances and a cap on function evaluations. The CLI loads an integrand from /app/integrand.py and a JSON spec of intervals and tolerances, then writes the integral, error estimate, and evaluation statistics to /app/output.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Numerical Integration & Differentiation',
  'Implement an adaptive tanh-sinh (double-exponential) quadrature that handles endpoint singularities and infinite limits, returning integrals to specified absolute/relative tolerances while tracking function-evaluation counts. Provide a CLI that reads multiple integrals and intervals from input, computes results without external integration libraries, and writes both values and convergence traces.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Optimization & Root Finding',
  'Implement a command-line tool that computes the minimax (L-infinity) polynomial approximation of a given function on [a,b] using the Remez exchange algorithm, with optional weighting. Output the polynomial coefficients, the achieved uniform error, and the final set of alternation points to a results file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Random Number Generation & Monte Carlo Methods',
  'Create a terminal script that loads a symmetric positive-definite matrix from /app/A.npz and estimates log(det(A)) by approximating trace(log A) via stochastic Lanczos quadrature with Hutchinson (Rademacher) probes using a reproducible RNG seed. The tool should adaptively increase probes to meet a target confidence interval and write the estimate, probe count, and CI to /app/answer.json within a time budget.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Numerical Computation & Linear Algebra',
  'Random Number Generation & Monte Carlo Methods',
  'Implement a program that estimates the log-determinant of a large sparse SPD matrix using stochastic trace estimation (Hutchinson with Rademacher probes) combined with Lanczos quadrature, adaptively increasing probes until a 95% confidence interval is within ±1% relative error. Output the estimate, confidence interval, and the number of probes used to a results file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Cluster & Batch Job Management',
  'Build a SLURM workflow manager that submits a 3‑stage pipeline (preprocess → job array → reduction) with dependency chaining, monitors via squeue/sacct, and automatically requeues only failed array tasks (e.g., preempted or OOM) with adjusted resources and retry limits. It must handle SIGTERM for checkpointing and produce a final JSON/CSV report of exit status, retries, elapsed time, and MaxRSS per task.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Cluster & Batch Job Management',
  'Build a SLURM-driven workflow that launches a job array for a parameter sweep, enforces job dependencies (build -> stage data -> array -> postreduce), detects and auto-recovers preempted/failed tasks via sacct, and aggregates per-task elapsed time and GPU allocation into results.json. Provide scripts to submit, monitor, and checkpoint outputs so requeued runs resume without redoing completed work.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Distributed Numerical Computation',
  'Implement an MPI-based 3D Poisson solver on a structured grid using domain decomposition and a conjugate gradient method with Jacobi preconditioning, with each rank maintaining ghost cells and performing halo exchanges each iteration. Validate against an analytical solution by reporting L2 error and residual reduction, and write per-rank timing/scaling metrics and a representative solution slice to output files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Distributed Numerical Computation',
  'Implement an MPI-based 3D Poisson solver on a uniform grid using 3D Cartesian domain decomposition with nonblocking halo exchanges and Jacobi/CG iteration, writing per-iteration residuals, timings, and a central solution slice to standardized outputs. The harness runs at 1, 2, and 4 ranks to validate against a manufactured sinusoidal solution (error threshold), ensure monotonic residual decrease, and assess near-ideal weak scaling.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Multi-Threaded & Parallel Programming',
  'Implement a 2D steady-state Poisson solver on a large grid using Jacobi iterations, providing both a single-threaded baseline and a multi-threaded version (OpenMP or multiprocessing). The CLI must accept grid size and thread count, iterate until a residual threshold, and write the final field plus a convergence/timing summary that demonstrates speedup with ≥4 threads.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Parallel & High-Performance Computing (HPC)',
  'Multi-Threaded & Parallel Programming',
  'Implement serial and shared-memory parallel PageRank for a large sparse graph loaded from disk, using thread-partitioned sparse matvec and residual-based convergence. Output the top-ranked nodes and detailed timings to demonstrate speedup over the serial baseline.',
  NULL,
  ARRAY['parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reproducible Research & Workflow Automation',
  'Data Versioning & Dependency Control',
  'Implement a DVC-managed pipeline (preprocess → train → evaluate) with two local dataset versions and lock Python dependencies via pip-tools so reproducing on v1 yields identical artifact and metrics hashes across runs, while switching to v2 triggers only minimal stage recomputation. The run must emit an output manifest with dataset version, DVC stage checksums, and exact pip freeze, and validate at startup that installed packages match the lockfile.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Scientific Computing & Analysis',
  'Reproducible Research & Workflow Automation',
  'Notebook & Script Reproducibility',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reproducible Research & Workflow Automation',
  'Notebook & Script Reproducibility',
  'Create a CLI that executes /app/analysis.ipynb via papermill with user parameters, seeds all RNGs (random, NumPy, pandas, and torch if present) and forces single-threaded BLAS for determinism, then exports CSV outputs and a deterministic HTML report. The tool must write a manifest with parameters, pip-freeze, and SHA256 checksums of artifacts and provide a verify mode that re-runs and asserts bitwise identity for identical parameters.',
  NULL,
  ARRAY['pandas']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reproducible Research & Workflow Automation',
  'Report Generation & Automation',
  'Build a Snakemake pipeline that runs a parameterized Monte Carlo study, exports figures and summary tables, and renders a Quarto report to both HTML and PDF. The workflow must record seeds, config, and dependency versions into a manifest to ensure exact reproducibility across runs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Reproducible Research & Workflow Automation',
  'Report Generation & Automation',
  'Build a reproducible, Makefile-driven pipeline that reads a provided CSV, computes summary statistics and bootstrap 95% CIs in Python, saves tables/figures, and renders a self-contained HTML report from a Jinja2 template under /app/report. The build must be deterministic with a fixed seed and incremental (only re-running steps when inputs or templates change).',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Scientific Computing & Analysis',
  'Scientific Data Processing & Visualization',
  'Image & Geospatial Data Handling',
  'Build a Python CLI that ingests a multi-band satellite GeoTIFF (with NIR and Red), computes NDVI with nodata handling, reprojects to EPSG:3857, and writes a colorized XYZ tile pyramid into an MBTiles database with correct bounds and metadata. Additionally, vectorize pixels where NDVI exceeds a threshold into simplified GeoJSON polygons and export a PNG quicklook map.',
  NULL,
  ARRAY['python', 'database']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Scientific Data Processing & Visualization',
  'Image & Geospatial Data Handling',
  'Build a Python CLI that ingests a time-series of multispectral GeoTIFFs and a polygon ROI, decodes per-pixel cloud masks from QA bands, harmonizes projection/resolution, and computes a cloud-free median NDVI composite. Output a cloud-optimized GeoTIFF with overviews, a quicklook PNG with ROI outline and scale bar, and a CSV of per-ROI summary statistics.',
  NULL,
  ARRAY['python', 'cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Scientific Data Processing & Visualization',
  'Image & Geospatial Data Handling',
  'Create a Python tool that reads a folder of multi-date satellite GeoTIFFs with varying CRSs and resolutions plus an AOI polygon, reprojects and clips them to a common grid, and builds a cloud-robust medoid mosaic across dates using RGB+NIR bands. Write the mosaic as a Cloud-Optimized GeoTIFF, a PNG quicklook with AOI overlay, and a JSON report of per-band mean/std and fraction of valid pixels.',
  NULL,
  ARRAY['python', 'cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Scientific Data Processing & Visualization',
  'Spectral & Signal Processing',
  'Create a CLI tool that computes a multitaper (DPSS) power spectral density of a 1-D signal and automatically detects narrowband line components above a robust noise floor. Apply notch filtering at detected lines and save the cleaned signal, PSD before/after, and a figure highlighting the peaks removed.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Scientific Data Processing & Visualization',
  'Spectral & Signal Processing',
  'Create a CLI tool that computes power spectral density estimates for multichannel signals using both Welch and multitaper (DPSS) methods, saving PSDs and 95% confidence intervals to CSV plus comparison plots. Validate normalization via Parseval’s theorem by requiring the PSD-integrated variance to match the time-domain variance within 2% and report any channels that fail.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Scientific Data Processing & Visualization',
  'Visualization & Plotting',
  'Write a Python CLI that loads gridded geophysical data (lat, lon, time, variable) from a NetCDF file, computes a 30-year climatology and anomalies for a target month, and generates a 3-panel publication figure: global anomaly map with coastlines, zonal-mean latitude–anomaly cross-section, and a time series with rolling mean and confidence band. Use Matplotlib (and Cartopy for maps) with a symmetric, colorblind-safe diverging colormap centered at zero and fixed normalization across panels, saving the figure PNG and a JSON with summary statistics.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Design and package a Python library for uncertainty propagation offering linearized (Jacobian-based) and Monte Carlo estimators for vector-valued functions, with interchangeable NumPy and JAX backends. Ship a type-hinted API, Sphinx docs with runnable examples, unit tests with finite-difference validation, a CLI that evaluates models from JSON, and a wheel for local installation.',
  NULL,
  ARRAY['python', 'api', 'installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Scientific Computing & Analysis',
  'Scientific Software Engineering',
  'Library Development & Documentation',
  'Develop a Python interval arithmetic library that guarantees enclosure for elementary functions using outward rounding and vectorized NumPy operations, with a clean API, type hints, and Sphinx docs driven by doctests. Include a CLI to evaluate expressions over named intervals and a test suite that verifies inclusion properties and monotonicity on randomized cases.',
  NULL,
  ARRAY['python', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a metamorphic and differential testing framework for FFT/IFFT routines that auto-generates random and structured signals, validates Parseval’s theorem, round-trip fidelity, and the convolution theorem, and cross-checks outputs between numpy.fft and an FFTW-based CLI tool within set tolerances. Integrate deterministic seeding, tolerance budgets, and performance regression guards into a CI pipeline that fails on numerical drift or speed regressions.',
  NULL,
  ARRAY['testing', 'performance']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Scientific Computing & Analysis',
  'Scientific Software Engineering',
  'Testing & Verification Frameworks',
  'Build a metamorphic and property-based test harness for a 2D Poisson solver that generates randomized periodic RHS fields, asserts exact recovery on single Fourier modes, checks symmetry/conservation invariants, and differential-tests against an independent finite-difference reference with convergence and error thresholds. Provide a CLI to run the suite and a CI workflow that records metrics and fails on tolerance regressions.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a Python CLI that performs adjoint-based parameter estimation for an ODE by integrating both the forward system and its continuous-time adjoint to obtain exact gradients of a least-squares misfit. Apply it to fit the Lorenz system’s (sigma, rho, beta) to a provided noisy trajectory, and report recovered parameters along with adjoint–finite-difference gradient agreement.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Differential Equation Solvers',
  'Build a Python CLI that solves the Lane–Emden boundary-value problem y'''' + (2/x) y'' + y^n = 0 with y(0)=1, y''(0)=0 using a shooting method and SciPy''s solve_ivp, seeding near x=0 from a SymPy-derived series expansion. Write the sampled solution and the first zero-crossing radius to output files and report max error versus the closed-form solutions for n=0 and n=1.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Differential Equation Solvers',
  'Implement a 1D Fisher–KPP reaction–diffusion simulator using FiPy that, given D and r, initializes a step profile, advances to a traveling-wave regime, and estimates the wavefront speed from threshold crossings over time. Save positions and the speed estimate to outputs and verify the speed is within 5% of the theoretical 2*sqrt(D*r).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Differential Equation Solvers',
  'Implement a Python CLI that solves the 1D Fisher–KPP reaction–diffusion PDE on [0, L] with Neumann boundaries via method-of-lines (finite differences) using SciPy’s stiff integrator from a compact initial condition. Estimate the traveling wave speed from the simulation and verify it is within 5% of the theoretical minimum 2*sqrt(D*r), writing the estimated speed and error to /app/answer.json.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Finite Element & Numerical Methods',
  'Implement a Python finite element solver for 2D linear elasticity on an L-shaped domain using P1 triangles from a provided Gmsh mesh, enforcing Dirichlet and traction boundary conditions and computing von Mises stress. Include a Zienkiewicz–Zhu a posteriori error estimator with Doerfler marking to drive three adaptive refinement cycles, writing VTK field outputs and a JSON convergence summary (DOFs, ||u||_H1 error, observed rate).',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Finite Element & Numerical Methods',
  'Implement a sparse finite element modal analysis tool for 2D trusses: parse nodes and bar elements with A, E, and ρ, assemble global stiffness and consistent mass matrices, apply fixed DOFs, and compute the first k natural frequencies and mode shapes via eigsh. Write frequencies to an output text file and mode shapes to a mesh-compatible format (e.g., VTK/CSV).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Parameter Sweeps & Sensitivity Analysis',
  'Build a CLI tool that runs a stochastic SIR epidemic simulation (Gillespie SSA) and performs a Sobol global sensitivity analysis over R0, mean infectious period, and initial infected fraction, reporting first- and total-order indices for peak prevalence, time-to-peak, and final size. Use Saltelli sampling with a fixed seed, parallelize simulations, and write indices and summary metrics to CSV/text outputs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Parameter Sweeps & Sensitivity Analysis',
  'Build a Monte Carlo simulator for the 2D Ising model with periodic boundaries, sweeping temperature across a range and multiple lattice sizes to compute ensemble magnetization, energy, specific heat, susceptibility, and Binder cumulant. Estimate the critical temperature by locating the susceptibility peak and Binder cumulant crossing, saving the full per-temperature statistics and Tc estimate to outputs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Parameter Sweeps & Sensitivity Analysis',
  'Implement a Python CLI that integrates the Lorenz ''63 system and, for a grid of (sigma, rho) values at fixed beta, computes the largest Lyapunov exponent to map chaotic vs non-chaotic regions, writing a CSV heatmap and the estimated boundary. Assess numerical sensitivity by rerunning a subset with stricter solver tolerances and reporting deviations in the exponent.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Scientific Computing & Analysis',
  'Simulation & Modeling',
  'Stochastic or Agent-Based Simulations',
  'Build a discrete-event simulator for an M/M/c/K queue with balking at full capacity and exponential reneging, using a fixed RNG seed and automatic warm-up detection before collecting statistics across multiple replications. Output per-replication and aggregated 95% CI estimates for throughput, loss probability, mean queue length, and waiting time to standardized CSV/JSON files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Stochastic or Agent-Based Simulations',
  'Implement a discrete-event simulation of a priority M/M/c/K queue with balking and reneging, reading parameters from /app/scenario.yaml, and run batched replications with fixed RNG seeds to estimate per-class throughput, mean wait, and server utilization with 95% CIs to /app/results.json. Include a test mode that sets K→∞ and a single class to validate against the analytical M/M/c steady-state formulas within a specified tolerance.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Simulation & Modeling',
  'Stochastic or Agent-Based Simulations',
  'Implement a discrete-event simulator for an M(t)/M/c/K queue with two priority classes (preemptive-resume) and impatient customers (reneging), supporting reproducible random seeds and multi-run parameter sweeps via CLI. For each run, write CSVs with time-series queue lengths and per-class summary metrics (utilization, mean/95th-percentile wait, abandonment rate).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a memory-bounded CLI that streams a large (possibly gzipped) CSV to compute per-column descriptive stats (count, mean, std, min/max, skewness, kurtosis) and approximate quantiles (1,5,25,50,75,95,99) using online algorithms (e.g., Welford + KLL), with NA handling and optional group-by by a categorical field. Write a JSON report including equal-width histograms per column and enforce quantile approximation error ≤0.005 while keeping peak RAM ≤200 MB.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Statistical Analysis & Data Modeling',
  'Descriptive Statistics & Summarization',
  'Implement a streaming CLI that computes per-column (and optional group-by) descriptive stats—count, mean, variance, min/max, skewness, kurtosis—and approximate quantiles (p1, p5, p25, p50, p75, p95, p99) from a large CSV using a memory-bounded quantile sketch (e.g., t-digest/P^2), outputting a compact JSON summary and fixed-bin histograms. The tool must handle missing values and optional weights while operating on datasets larger than RAM.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Statistical Analysis & Data Modeling',
  'Descriptive Statistics & Summarization',
  'Implement a streaming CLI that reads a potentially multi-GB CSV at /app/data.csv and computes per-group descriptive statistics (count, mean, variance, min, max) and approximate quantiles (p10, p50, p90) using numerically stable online methods (e.g., Welford plus a GK or t-digest sketch), writing a compact JSON report to /app/summary.json. The tool must ignore NaNs, support optional observation weights, and complete under a strict memory cap and time budget.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Statistical Analysis & Data Modeling',
  'Hypothesis Testing & Inference',
  'Build a CLI tool that performs permutation-based ANCOVA (Freedman–Lane) to test a binary treatment effect while adjusting for a continuous covariate, optionally within blocking factors. Output the permutation p-value, partial R², and 95% bootstrap CI, and apply Benjamini–Hochberg correction if multiple outcomes are tested.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Statistical Analysis & Data Modeling',
  'Hypothesis Testing & Inference',
  'Create a script that ingests stratified 2x2 contingency data (A/B by success/failure with a stratum identifier), performs a Cochran–Mantel–Haenszel test to estimate a common odds ratio with 95% CI, and reports its p-value. Additionally run the Breslow–Day test for homogeneity across strata and write the common OR, CI, and both p-values to an output JSON file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI tool that fits an errors-in-variables Deming regression for method-comparison data, estimating the error variance ratio from replicate measurements and optionally applying Huber M-estimation to orthogonal residuals for robustness. Output slope, intercept, their 95% CIs (bootstrap), the variance ratio estimate, and a CSV of fitted values and orthogonal residuals.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Statistical Analysis & Data Modeling',
  'Regression & Curve Fitting',
  'Create a CLI tool that fits a bi-exponential decay model y(t)=a1*exp(-k1 t)+a2*exp(-k2 t) using the variable-projection method: optimize k1,k2 via nonlinear search while solving a1,a2 by linear least squares at each step, enforcing a1,a2>=0 and k1,k2>0. Report parameter estimates, bootstrap 95% CIs, and predicted values at specified eval times without using high-level curve-fitting helpers.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Uncertainty Quantification & Sensitivity Analysis',
  'Bayesian Parameter Estimation',
  'Calibrate an SIR epidemic ODE model to noisy incidence data using Bayesian inference (e.g., PyMC/NumPyro with NUTS), estimating transmission and recovery rates and R0. Run multi-chain MCMC to produce posterior credible intervals and posterior predictive trajectories and save a concise summary artifact.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a Python CLI that loads mean and covariance for parameters [a,b,c] of the model y(x)=a*exp(b x)+c and a grid of x, and computes 95% confidence bands for y(x) via both first-order delta-method propagation and Monte Carlo sampling (Cholesky, fixed seed). Write the bands and propagated standard errors to /app/output/bands.csv and a summary JSON, and verify the two methods’ bounds agree within 3% at each x.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Uncertainty Quantification & Sensitivity Analysis',
  'Sensitivity Metrics & Ranking',
  'Implement a Python CLI that loads a differentiable JAX model f: R^d -> R, computes derivative-based global sensitivity measures (DGSM) via automatic differentiation on quasi–Monte Carlo samples, and converts them into provable upper bounds on total Sobol indices using Poincaré constants for Uniform/Normal inputs. Write a JSON file with per-parameter DGSM, total-effect bounds, and a ranking by the bounds.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a CLI that propagates uncertainty in a deterministic SIR ODE model with uncertain β, γ, and I0, computing the distributions of peak infected fraction and time-to-peak via both Monte Carlo (with variance reduction) and non-intrusive polynomial chaos. The tool must read input distributions from a config file and output summary statistics and method agreement diagnostics.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Cipher Cracking & Weak Encryption Analysis',
  'Crack a corpus of hex-encoded messages encrypted with the same unknown repeating-key XOR by estimating key length via normalized Hamming distance and recovering the key using English frequency scoring. Decrypt all files and write the plaintext of a specified target message to /app/output/target.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Cipher Cracking & Weak Encryption Analysis',
  'Exploit AES-CTR nonce reuse across many hex-encoded ciphertexts to reconstruct the keystream via multi-time-pad techniques (pairwise XOR and crib-dragging) and decrypt a designated target message. Write the exact recovered plaintext to /app/secret.txt and the keystream to /app/keystream.hex.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Cipher Cracking & Weak Encryption Analysis',
  'Exploit AES-CTR nonce reuse across multiple ciphertexts by using XOR analysis with known file headers and crib-dragging to recover the keystream and decrypt a target message containing SECRET{...}. Write the recovered secret to /app/secret.txt without modifying other files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Cipher Cracking & Weak Encryption Analysis',
  'Recover plaintexts from multiple files encrypted with the same repeating-key XOR (many-time pad) by estimating key length with Hamming distances, crib-dragging using known file headers, and reconstructing the key to decrypt all messages.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a command-line cracker that parses a mixed credential dump containing unsalted MD5, SHA-1, and NTLM hashes alongside bcrypt entries, auto-detects the hash type per record, and recovers plaintexts for only the weak/unsalted hashes using a provided wordlist plus simple mutation rules. Output cracked username→password pairs in deterministic order to /app/output/cracked.json and leave bcrypt entries untouched.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Password Hash Cracking',
  'Given a mixed-format hash dump at /app/hashes.txt containing LM+NTLM (unsalted), raw MD5, and SHA-1, create a workflow that auto-detects each hash type, cracks them via dictionary+rules and targeted mask attacks (including LM half-cracking and recombination), and verifies candidates. Write username:password pairs to /app/cracked.txt and a brief per-hash-type success summary to /app/stats.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Password Hash Cracking',
  'Recover plaintext passwords from a SQLite database where each user’s hash is the hex-encoded MD5 of lowercase(email)+":"+password (no salt). Reverse-engineer the format from a provided hint script, then use a dictionary+mask attack to crack all accounts and write user_id,email,password to /app/cracked.csv.',
  NULL,
  ARRAY['database']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Applied Cryptanalysis & Reverse Engineering',
  'Protocol Analysis & Exploit Detection',
  'Analyze SMTP traffic to detect a STARTTLS stripping downgrade that exposes credentials, reproduce the attack using standard CLI tools, and write the recovered username:password to /app/creds.txt. Reconfigure the mail server to require TLS (reject plaintext AUTH without STARTTLS) and verify via a captured session that downgrade attempts no longer leak credentials.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Protocol Analysis & Exploit Detection',
  'Analyze a TLS-enabled internal service and an accompanying PCAP to detect reuse of a static TLS session ticket encryption key. Extract the ticket key from the service (e.g., config/env/memory) and use it to decrypt the captured session, recovering a secret and writing it to /app/recovered_secret.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Protocol Analysis & Exploit Detection',
  'Analyze a reverse-proxy setup (HTTP/2 frontend to HTTP/1.1 backend) to detect H2-to-H1 request smuggling caused by improper forwarding of Connection/TE headers. Craft a single HTTP/2 request to smuggle an internal GET /admin/flag to the backend, extract FLAG{...}, and write it to /app/flag.txt.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Protocol Analysis & Exploit Detection',
  'Build a CLI that parses a provided pcap of SMTP/IMAP/POP3 sessions to detect STARTTLS downgrade/misuse and plaintext credential exposure. For each session, report server capabilities, whether TLS was negotiated, and any extracted usernames/passwords in a machine-readable summary.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Protocol Analysis & Exploit Detection',
  'Given a TLS 1.2 packet capture and the server’s RSA private key, decrypt and reconstruct the HTTP conversation to extract a leaked bearer token. Replay the token against the local service to obtain a protected secret and persist the result to a specified file.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Applied Cryptanalysis & Reverse Engineering',
  'Reverse Engineering Binary Artifacts',
  'Analyze a stripped ELF that reconstructs an AES-128 key at runtime from scattered lookup tables and uses it to decrypt an embedded data blob. Recreate the key derivation and decryption in a standalone script to recover the original JSON config and write it to /app/config.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Reverse Engineering Binary Artifacts',
  'Analyze a stripped x86-64 ELF that embeds a custom bytecode virtual machine for license verification; extract the bytecode and reimplement the VM in Python to compute the correct license without running the binary, writing it to /app/license.txt.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Reverse Engineering Binary Artifacts',
  'Analyze a stripped x86-64 ELF that validates input using a custom stack-based bytecode VM and simple anti-debug checks. Reconstruct or emulate the VM to recover the exact passphrase that yields ''ACCESS GRANTED'' and write it to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Reverse Engineering Binary Artifacts',
  'Reverse engineer a stripped x86_64 ELF that decrypts a payload using AES-CTR, where the key and nonce are constructed at runtime from several obfuscated constants. Recover the exact key/nonce and write a CLI tool that decrypts /app/secret.enc to /app/secret.txt without modifying the binary.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Applied Cryptanalysis & Reverse Engineering',
  'Reverse Engineering Binary Artifacts',
  'Reverse-engineer a stripped Linux ELF that embeds a WebAssembly module inside a custom section and validates input by interpreting that WASM; locate and extract the module, reconstruct the check algorithm from its bytecode, and compute the input that makes the program reveal FLAG{...}. Write the recovered flag to /app/secret.txt and note the byte offsets used for the extraction.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Authentication & Access Control',
  'Multi-Factor & Token-Based Authentication',
  'Implement a minimal OAuth 2.0 device authorization flow that issues RS256 JWT access tokens backed by a rotating JWKS, where user approval requires a TOTP code generated from a provisioned per-user secret. Provide a CLI client that enrolls the TOTP secret, completes the device flow while handling authorization_pending/slow_down, and accesses a protected API; tests validate TOTP windowing, key rotation via kid, and strict audience/issuer checks.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a CLI shadow-upgrader that reads a users.json containing mixed legacy password formats (plaintext, SHA-1 hex, salted SHA-256, bcrypt), authenticates a batch of login attempts, and transparently rehashes verified passwords to Argon2id with per-user random salts and a file-based pepper (/app/pepper.key) in PHC format. Use constant-time verification, enforce target Argon2 parameters, write updates atomically with upgraded_at timestamps, and leave unverifiable entries unchanged.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure PostgreSQL with role-based and row-level security: create tenant-scoped roles, enable RLS on a table using tenant_id policies, and expose a masked view so analysts can only SELECT non-PII while ingesters can INSERT but not read. Verify cross-tenant reads are denied and admins retain full access via psql tests.',
  NULL,
  ARRAY['postgresql', 'security']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Authentication & Access Control',
  'Role-Based & Policy Enforcement',
  'Configure an SSH-based Git service that enforces role-based access using authorized_keys restrictions and server-side hooks: create ci and maintainer roles where ci can only perform read-only git-upload-pack on /srv/repoA.git, while maintainer can push to repoA.git but not to repoB.git. Disable interactive shells and all forwarding features for both roles, and verify that unauthorized operations are denied while allowed ones succeed.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Authentication & Access Control',
  'Role-Based & Policy Enforcement',
  'Create Unix roles via groups ''analyst'' and ''operator'' and enforce POSIX ACLs (including default ACLs) so analysts have read-only access to /app/data/reports (present and future files) while operators can modify /app/data/ops but cannot read reports. Lock down sudoers so only operators may run `/usr/bin/systemctl restart metrics-agent.service` without a password and cannot execute any other command or escalate to a shell, and provide a script that proves both allowed and denied behaviors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Authentication & Access Control',
  'Role-Based & Policy Enforcement',
  'Provision role-based access on a Linux host by creating dev, ops, and audit roles with UNIX groups, POSIX ACLs, and sudoers.d policy. Enforce that devs can write to /srv/app/releases but cannot restart services, ops may only sudo systemctl restart app@* without shell escapes or env-based escalation, and auditors can read /var/log/app but not secrets, with default ACLs applied to new files.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Authentication & Access Control',
  'Session Management & Revocation',
  'Extend a JWT-based FastAPI authentication service to implement session-level revocation using per-token jti entries in Redis with TTL and refresh-token rotation with reuse detection that triggers immediate user-wide logout. Provide a CLI/endpoint to revoke all sessions for a username and verify that revoked access tokens return 401 while new logins succeed, with revocation instantly propagated via Redis pub/sub.',
  NULL,
  ARRAY['redis']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a CLI that canonicalizes JSON per RFC 8785 (JCS) and generates/verifies detached Ed25519 signatures over the canonical bytes using local PEM keypair files. Verification must accept semantically identical JSON regardless of whitespace or key order and exit non-zero if any value changes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Digital Signatures & Verification',
  'Implement a CLI tool that verifies OpenPGP cleartext-signed messages (RFC 4880) with correct canonical text handling (CRLF normalization, dash-escaping, and trailing whitespace) against a provided public keyring. The tool scans /app/messages for .asc files and outputs a per-file validity report to /app/verification.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Encryption & Decryption',
  'Implement a hybrid envelope-encryption CLI that recursively encrypts a directory using per-file random AES-256-GCM keys, wrapping each key with an RSA-2048 public key and preserving permissions/mtimes via a JSON manifest. Provide a decrypt/verify command that uses the RSA private key to restore files byte-for-byte and detect tampering via AEAD tag checks and SHA-256 hashes.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Hashing & Integrity Verification',
  'Build a command-line verifier that, given a directory of fixed-size file chunks and their inclusion proofs plus a claimed root hash, validates a Merkle tree over the chunks (SHA-256 by default) and identifies any tampered chunks. Write the zero-based indices of all failing chunks to /app/bad_chunks.txt and exit non-zero if the computed root does not match.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Hashing & Integrity Verification',
  'Implement a CLI that computes a deterministic Merkle tree over /app/data (leaf = SHA-256 of file contents with executable-bit encoded; internal = SHA-256(left||right) in stable lexicographic path order) and verifies the root against /app/expected_root.txt. Output /app/verification_report.json listing any files or links violating integrity (hashing symlink targets, handling Unicode and hardlinks, skipping sockets/FIFOs).',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Hashing & Integrity Verification',
  'Implement a CLI that generates a SHA-256 Merkle tree manifest for a directory (capturing file sizes, permissions, and symlink targets) and outputs the root hash to a JSON file. Provide a verify mode that loads the manifest to report added/removed files, metadata changes, and chunk-level byte-range differences for large files, honoring ignore patterns in a .integrityignore.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Hashing & Integrity Verification',
  'Implement a CLI tool that computes a deterministic SHA-256 Merkle tree over all regular files in /app/data (sorted paths), outputs the root to /app/output/root.txt, and can emit and verify inclusion proofs for any file. Use it to validate a provided set of proofs and write the paths of any tampered files to /app/output/tampered.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create an offline GPG primary certification key and add dedicated signing, encryption, and authentication subkeys; export a revocation certificate and relocate the primary key to an “offline” store. Implement a rotation that replaces the encryption subkey, updates the public keyring, and proves functionality by signing, encrypting, and decrypting test data using only the subkeys.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Key Generation & Management',
  'Establish an internal SSH Certificate Authority that issues, revokes, and rotates user and host certificates via shell scripts. Validate by configuring sshd to trust the CA, publishing a KRL, rotating to a new CA key with dual-trust during migration, and demonstrating that only valid, non-revoked certificates can authenticate.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Randomness & Entropy Generation',
  'Implement a CLI entropy-mixer that collects bits from getrandom(), optional RDRAND, and CPU timing jitter, combines them via HKDF-SHA256 into a seed, and drives a ChaCha20-DRBG with fork detection and periodic reseeding to emit N bytes. Provide a health subcommand that performs basic randomness sanity checks and refuses to run if only a single untrusted source is present.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Randomness & Entropy Generation',
  'Implement a user-space ChaCha20-DRBG that seeds from getrandom(2), a persistent seed file, and timer jitter mixed via HKDF-SHA256, and atomically commits reseed state. Provide a CLI that emits N random bytes and a JSON health report (sources, reseed_count), and passes a compromise-and-recover test for forward/backward secrecy.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cryptographic Operations',
  'Randomness & Entropy Generation',
  'Implement a user-space entropy collector that samples CPU timing jitter and other non-blocking sources, conditions them with SHA-256, and seeds a ChaCha20-based CSPRNG with a CLI to emit N bytes to /app/output/random.bin. Include basic health tests (repetition count and adaptive proportion) and persistent reseed state to avoid output reuse across restarts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Analyze a Linux RAM dump to locate a shared object mapped from a deleted path or memfd that indicates code injection. Carve the ELF from the dump, save it to /app/output/evil.so with its SHA-256, and report the hosting PID and the suspicious VMAs involved.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'File & Memory Forensics',
  'Analyze a Linux memory image to locate a ChaCha20-Poly1305 key and nonce left in a suspected process’s heap, reconstruct them from little-endian 32-bit words, and decrypt /app/capture.enc into /app/plaintext.out. Record the PID and virtual address where the key was recovered in /app/findings.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'File & Memory Forensics',
  'Given a Linux process core dump and an AES-CTR–encrypted blob, recover the 32-byte AES key from memory artifacts (e.g., key schedule structures or contiguous hex bytes) and use it to decrypt the blob to plaintext. Validate success by matching the plaintext’s checksum against a provided reference.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Analyze BIND9 query logs and system auth logs to detect DNS tunneling via long high-entropy subdomains and elevated NXDOMAIN rates, then identify the tunneling domain, originating client IP, and time window. Write findings to /app/output/report.json and provide a CLI that prints the top 5 suspicious FQDNs with counts based on your heuristics.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Log Analysis & Intrusion Detection',
  'Analyze Suricata EVE JSON and SSH auth logs to detect a DNS TXT-based tunneling session followed by lateral movement via successful SSH login from the same source IP. Output the exfiltration domain and compromised username to /app/findings.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Log Analysis & Intrusion Detection',
  'Correlate nginx access.log, /var/log/auth.log, /var/log/cron.log, and syslog to detect a webshell-driven intrusion: identify the initial exploit request and source IP, enumerate compromised accounts via SSH, and reconstruct the timeline through persistence installation and data exfiltration. Write the attacker IP(s), first compromise timestamp, compromised usernames, path and SHA256 of the dropped payload, and the exfil destination to /app/incident_report.txt.',
  NULL,
  ARRAY['installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Log Analysis & Intrusion Detection',
  'Parse DNS resolver logs (e.g., BIND/Unbound) to detect DNS tunneling by flagging high-entropy, long subdomains with abnormal query/NXDOMAIN rates. Attribute offending client IPs and reconstruct the exfiltrated payload by decoding base32/base64 subdomain chunks into /app/exfiltrated.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Malware Behavior Analysis',
  'Inspect an obfuscated Linux ELF dropper that persists via /etc/ld.so.preload and exfiltrates data using DNS TXT queries. Recover and decode its embedded C2 domain (XOR+base64) to /app/iocs.txt and cleanly remove the persistence without breaking legitimate binaries.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Malware Behavior Analysis',
  'Perform static and controlled dynamic analysis of a packed Go-based Linux ELF dropper that decrypts its configuration at runtime. Without contacting external hosts, recover and write its decoded C2 endpoints, mutex/campaign ID, and installed persistence artifacts (e.g., systemd unit/timer names or crontab entries) to /app/iocs.txt, and extract the embedded payload to /app/payload.bin.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Timeline Reconstruction',
  'From /app/artifacts (kube-apiserver audit logs, containerd logs, application auth logs, and a crontab snapshot), reconstruct a minute-by-minute timeline of a Kubernetes pod compromise that began with a leaked CI/CD token, escalated via an over-privileged service account, established cron-based persistence, and exfiltrated data to an external host. Output a strictly chronological /app/output/timeline.json with fields [timestamp, source, action, subject, details] and tag the events of initial access, privilege escalation, persistence, and exfiltration.',
  NULL,
  ARRAY['kubernetes']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Forensics & Incident Analysis',
  'Timeline Reconstruction',
  'Reconstruct a minute-by-minute timeline of a supply-chain compromise by correlating auditd, apt/dpkg logs, pip metadata, systemd journal, and netflow/pcap artifacts from initial package install to persistence and exfiltration. Output a sorted timeline.csv and a findings.txt naming the malicious package, the first persistence write path, and the exfiltration destination IP.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Exploit Simulation & Payload Delivery',
  'Against a sandboxed Flask web app, identify a server-side template injection sink in a preview endpoint and craft an obfuscated Jinja2 payload that writes /tmp/mark_ssti.txt and exfiltrates http://127.0.0.1:8081/flag to /app/result.txt despite a naive WAF blocking common tokens. Success is validated by the presence of the marker file and the exact flag content.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Exploit Simulation & Payload Delivery',
  'Assess a misconfigured Docker Engine API exposed on localhost by deploying a minimal containerized payload that mounts the host filesystem read-only to retrieve a designated secret. Copy the secret to /app and then cleanly remove all created containers, images, and networks to restore the environment.',
  NULL,
  ARRAY['docker', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Exploit Simulation & Payload Delivery',
  'Exploit a Shellshock vulnerability in a CGI-enabled web service by sending a crafted HTTP header that executes a controlled payload to create /app/pwned.txt and print the effective UID. Then harden the server (e.g., CGI config or shell update) and verify the payload no longer executes.',
  'hard',
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Exploit Simulation & Payload Delivery',
  'Exploit a misconfigured JWT verification flow vulnerable to HS/RS algorithm confusion by crafting a forged admin token to access a protected API and read /app/flag.txt. The task validates payload delivery by confirming elevated access and can be extended with a code/config hardening fix.',
  'hard',
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Exploit Simulation & Payload Delivery',
  'Exploit an unsafe YAML deserialization endpoint in a Python microservice that uses yaml.load on user input to achieve remote command execution. Craft and deliver a payload from the terminal that writes /tmp/pwn1, /tmp/pwn2, and /tmp/pwn3 and verifies their creation.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Design a command-line workflow that uses masscan for fast discovery and nmap (with select NSE scripts) for deep enumeration to build a complete inventory of open TCP/UDP ports and service metadata across a provided 172.20.0.0/24 sandbox network. The tool should fall back to netcat banner grabs when NSE is inconclusive and write a normalized JSON report to /app/scan.json plus a brief human summary to /app/REPORT.md.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Port Scanning & Enumeration',
  'Scan the provided lab subnet to discover an HTTP service on a non-standard TCP port, an SNMP agent on UDP 161, and a custom binary service on an unknown port. Use nmap (including relevant NSE scripts) and netcat/openssl to enumerate and write the HTTP title, SNMP sysName, and the custom service’s banner to /app/enum.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Post-Exploitation & Persistence Analysis',
  'After an authorized compromise of a Linux host, enumerate and analyze multiple persistence footholds including a masqueraded systemd unit, an SSH authorized_keys entry with a forced-command, and a cron job carrying a base64-encoded payload. Decode each mechanism, map it to its on-disk artifacts and startup triggers, generate a JSON report with indicators of compromise, and disable the persistence so it does not survive reboot.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Post-Exploitation & Persistence Analysis',
  'Analyze a compromised Linux host that employs layered persistence—a PATH-hijacked systemctl shim, a systemd service drop-in masquerading as a core daemon, an /etc/ld.so.preload hook, and a cron self-healer using immutable files—to identify, validate, and eradicate each mechanism. Produce a machine-readable IOC report (paths, hashes, service/timer names, environment changes) and a verification script that proves persistence does not return after service restarts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'As a low-privileged user, enumerate scheduled tasks and exploit a root cron backup that runs tar on a world-writable directory by abusing wildcard/--checkpoint-action injection to execute a root command. Confirm escalation by reading /root/flag.txt into /app/result.txt and creating a root-owned marker file in /tmp.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Privilege Escalation Simulation',
  'Identify and exploit a misconfigured Linux capability on a helper binary (e.g., cap_setuid+ep) to escalate privileges and read a root-only secret. Output the exact contents of /root/flag.txt to /app/result.txt without altering system state beyond what’s required.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Privilege Escalation Simulation',
  'Simulate a privilege escalation via Python library path hijacking of a root-run systemd timer. The agent must find a group-writable plugin directory used by a backup script, plant a malicious module to execute as root on the next run, create /root/owned.txt as proof, and then revert the change.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Network & System Penetration Testing',
  'Privilege Escalation Simulation',
  'Starting from an unprivileged user, enumerate the host to discover a root cron job that uses tar against a writable directory and exploit tar’s wildcard/--checkpoint-action behavior to execute code as root and write a proof file. Then remediate by correcting permissions and hardening the backup command to use absolute paths and safe options so the escalation path is closed.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Container & Cloud Hardening',
  'Build a CLI that hardens a Docker Compose project by enforcing least-privilege defaults (non-root user, read-only filesystem, dropped capabilities, no-new-privileges, seccomp/AppArmor profiles, CPU/memory limits, and read-only mounts unless whitelisted) and rewrites compose.yaml in place. Provide a verification script that launches the stack and uses docker inspect to confirm each service satisfies the required constraints.',
  'hard',
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'Container & Cloud Hardening',
  'Harden a local Kubernetes cluster by enabling Pod Security Admission at ''restricted'' on a target namespace and adding OPA Gatekeeper constraints requiring runAsNonRoot, readOnlyRootFilesystem, seccompProfile RuntimeDefault, and all capabilities dropped; verify by applying both noncompliant and compliant workloads and writing an enforcement report to a file. Ensure privileged, host* options, and hostPath mounts are rejected while the compliant Deployment runs successfully.',
  'hard',
  ARRAY['kubernetes', 'security']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Secure Configuration & Hardening',
  'Filesystem & Permission Security',
  'Audit a containerized service for insecure file permissions and symlink misuse: find world-readable secrets and an uploads directory that permits symlink-based writes, then harden by correcting ownership/modes, adding sticky bits where needed, and enforcing least-privilege with POSIX (default) ACLs for the service user. Demonstrate remediation by showing unprivileged users can no longer read the secrets or redirect writes via symlinks.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'Network Security Configuration',
  'Harden a Linux host with nftables by implementing a default-deny, stateful firewall that permits inbound HTTPS on 8443 to a sample service, rate-limits SSH (5/s, burst 10), blocks all IPv6, and enforces an egress allowlist (DNS/HTTPS) for both the host and a container bridge subnet. Provide a persistent ruleset and a verification script that proves container isolation, denied outbound ports, and rule survival after a ruleset reload.',
  'hard',
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'Network Security Configuration',
  'Harden the host by replacing permissive rules with an nftables default-deny policy that allows only inbound TCP 8443 and rate-limited SSH from 10.42.0.0/16, permits established/related traffic, and restricts egress to DNS, NTP, and HTTPS while logging first-hit drops to /var/log/nft-blocks.log via ulogd. Ensure the rules persist across reboot via /etc/nftables.conf and verify with connectivity tests that allowed paths work and blocked paths fail.',
  'hard',
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'Network Security Configuration',
  'Using nftables, implement a default-deny egress policy that only allows DNS to the system resolver and HTTPS to a domain whitelist managed as an IP set resolved from /app/allowed_domains.txt, with all other outbound connections rate-limited logged and dropped. Persist the rules in /etc/nftables.conf and provide /app/update_whitelist.sh to refresh the IP set so curl to allowed domains succeeds while others are blocked.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'System & Service Hardening',
  'Harden a root-running Python web service by converting it into a sandboxed systemd unit that uses an unprivileged DynamicUser, drops capabilities, sets NoNewPrivileges, enforces ProtectSystem=strict/PrivateTmp, applies RestrictAddressFamilies/IPAddressDeny, and a seccomp SystemCallFilter. The service must still serve on localhost:8080 and write only to /var/lib/app, while tests verify it cannot read /etc/shadow, spawn a shell, or make outbound network connections.',
  'hard',
  ARRAY['python', 'web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Configuration & Hardening',
  'System & Service Hardening',
  'Install and harden OpenSSH by creating a non-root deploy user, disabling root and password authentication, enforcing Ed25519 key-only access with modern Ciphers/MACs/KexAlgorithms, and restricting logins to that user via AllowUsers. Prove hardening by successfully logging in to localhost with the key while root/password logins fail, and write the final sshd_config and test results to /app/output.',
  'hard',
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Input Validation & Sanitization',
  'Patch a Python backup CLI that currently builds a shell command like "tar cf - <path> | {compressor} > out.tar.{ext}" from user input, allowing command injection and path traversal. Refactor to use subprocess with argument lists, whitelist compressor choices (gzip/bzip2/xz), canonicalize and restrict the source path to an allowed base directory, and enforce length/charset limits while preserving normal backup behavior.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Input Validation & Sanitization',
  'Refactor a FastAPI + SQLite microservice that currently builds SQL from query parameters to enforce strict validation and sanitization using parameterized queries and Pydantic validators (types, length limits, regex whitelists), returning 400s for disallowed input. Include a CLI verifier that exercises endpoints to prove SQLi payloads are neutralized while valid requests still return correct results.',
  NULL,
  ARRAY['sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Secure Software Development',
  'Secrets & Key Management in Codebases',
  'Convert all plaintext secrets in the repo to SOPS-encrypted files using age, adding a .sops.yaml policy and scripts to encrypt/decrypt/rotate while modifying the app to load secrets from environment or decrypted files. Rewrite Git history to remove the original cleartext and install a pre-commit hook that rejects new secret leaks; the harness verifies no secret bytes remain in blobs, packs, or tags and that the hook blocks a seeded leak.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Secure Build & Dependency Management',
  'Build a CLI that scans a monorepo’s Python (pip) and Node (npm) dependencies with OSV/pip-audit/npm audit, applies minimal non-breaking upgrades to eliminate high/critical CVEs, and regenerates lockfiles with hash/integrity pins. It must emit pre/post CycloneDX SBOMs, run the project tests to validate the upgrade, and fail the run if vulnerabilities persist or the build is not reproducible.',
  NULL,
  ARRAY['python']
);

-- Batch 11 complete (1100 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Secure Software Development',
  'Secure Build & Dependency Management',
  'In a mixed Python/Node project, use pip-audit and npm audit to identify one direct and one transitive vulnerable dependency, then remediate with minimal safe upgrades by pinning versions (requirements/constraints and package.json overrides) and regenerating lockfiles with strict hash verification. Enforce deterministic offline installs via pip.conf and .npmrc (require-hashes, npm ci with scripts disabled), generate CycloneDX SBOMs, and output a brief report of fixed CVEs and final versions.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Secure Build & Dependency Management',
  'In a polyglot monorepo (Python, Node.js, and Rust), audit dependencies with pip-audit, npm audit, and cargo audit, then apply the minimal safe upgrades and regenerate lockfiles with hashes. Emit a consolidated CycloneDX SBOM and JSON advisory report, wire a CI script to fail on new critical CVEs, and verify builds and tests still pass.',
  NULL,
  ARRAY['python', 'rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Secure Build & Dependency Management',
  'Scan a Python + Node monorepo with pip-audit and npm audit, then apply minimal safe upgrades via constraints.txt and npm overrides to remove all High/Critical findings and regenerate lockfiles. Output a unified JSON diff of vulnerabilities before/after and enforce deterministic installs with pip --require-hashes and intact npm integrity fields.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Security & Cryptography',
  'Secure Software Development',
  'Static Code Analysis & Vulnerability Detection',
  'Author a custom Semgrep rule set that models taint flow across a mixed Python/Node.js codebase to detect untrusted input reaching command execution, SQL queries (string interpolation), and unsafe path joins (zip-slip). Run the rules to produce a SARIF report, refactor the code to remediate all high-severity findings, and re-run to confirm zero remaining issues.',
  NULL,
  ARRAY['python', 'sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Secure Software Development',
  'Static Code Analysis & Vulnerability Detection',
  'Install and run Bandit and Semgrep on a deliberately vulnerable Python microservice, and author custom Semgrep rules to detect ECB mode, static IVs, weak hashes, and subprocess calls with shell=True, then refactor the code to remove all findings. Produce before/after SARIF reports and a CI-failing script that exits non‑zero if any critical issues remain.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Alerting & Incident Response Automation',
  'Build a lightweight fail2ban-style responder that tails a custom service log, detects credential-stuffing/401-flood patterns via a regex filter, and posts JSON alerts to a local webhook endpoint. On threshold breach, automatically quarantine offending IPs by appending to a persistent blocklist enforced by a provided mock-firewall script, with tests that simulate attacks and benign traffic to verify correct alerting and no false positives.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Alerting & Incident Response Automation',
  'Implement a real-time incident responder that tails auth and HTTP logs, loads YAML rule files defining thresholds over sliding windows, and on matches emits HMAC-signed JSON alerts while executing mapped actions (append IP with TTL to /app/blocked_ips, lock a user, or disable a service) and producing a triage bundle with relevant logs, process tree, and socket info. Validation simulates brute-force SSH and repeated 403s, expecting alert files in /app/alerts, auto-expiring IP entries, and timestamped incident report directories with captured evidence.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure Linux auditd to record execve events for privileged commands and writes under /etc, enable persistent journald storage, and set up rsyslog (via imjournal) to forward auth/kern/daemon logs to a local RELP+TLS syslog listener with certificate pinning. Verify by triggering sudo, user management, and config file edits, then assert the events appear in ausearch and in the forwarded stream with correct timestamps, host metadata, and persistence across service restarts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Audit Logging & Monitoring Setup',
  'Configure auditd and systemd-journald for persistent, immutable auditing of privileged execve events and file writes under /app/secret, and set up rsyslog to forward audit and authpriv logs over TLS to a provided local syslog endpoint. Trigger test events and produce /app/output/verification.txt proving capture locally and remotely, and that rules persist after service and system restarts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Audit Logging & Monitoring Setup',
  'Configure persistent journald storage and auditd rules to record execve, sudo usage, writes to /etc/ssh, and kernel module loads with distinct AUDIT_KEY tags. Bridge audit logs into journald and forward them via systemd-journal-upload to a local journal-remote collector, then trigger each event and verify receipt with expected fields and counts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Audit Logging & Monitoring Setup',
  'Configure persistent system-wide logging by enabling systemd-journald persistence and auditd with rules to track /etc changes, kernel module loads, and executions of privileged binaries, then forward events via rsyslog over TLS to a local mock SIEM listener. Validate by triggering sample events and confirming they appear in persistent logs, are rotated with a 7‑day retention policy, and are received by the SIEM with hostname and UTC timestamps.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Audit Logging & Monitoring Setup',
  'Enable persistent journald storage and configure auditd rules to log all execve by uid 0, any chmod that adds setuid/setgid bits, and writes under /app/secure. Validate by triggering events and generate /app/audit_report.json summarizing counts and the latest five matching events from both audit logs and the journal.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Security Policy Compliance',
  'Implement a Python CLI that validates a minimal CIS Ubuntu Server baseline by auditing password/PAM policy, SSH hardening, key sysctl settings, and world-writable permissions, emitting a structured JSON pass/fail report with remediation guidance. Provide an idempotent --fix mode that backs up affected files and applies compliant configurations where safe.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security Monitoring & Compliance',
  'Vulnerability Scanning & Reporting',
  'Scan a provided container image and its running service with Trivy and nmap to generate a consolidated SARIF report, then refactor the Dockerfile and service configuration to remediate all Critical findings and close an inadvertently exposed admin port. Rebuild and re-scan to verify the report shows zero Critical/High CVEs and the admin port is unreachable, saving before/after reports in /app/reports.',
  NULL,
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Common Vulnerability Reproduction',
  'Investigate a C logging daemon with a format-string vulnerability in printf that allows leaking stack memory; craft an input to extract FLAG{...} and write it to /app/flag.txt, then patch the code to use fixed format strings and recompile, confirming normal logging still works.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Common Vulnerability Reproduction',
  'Reproduce an XML External Entity (XXE) vulnerability in a service that parses uploaded XML files by crafting a payload to read /app/flag.txt and save the contents to /app/leak.txt. Then harden the XML parser to disable external entities and DTDs while preserving normal document handling.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Common Vulnerability Reproduction',
  'Reproduce and mitigate a ZIP Slip directory traversal in a Python CLI that naively extracts user-submitted archives. Craft a malicious ZIP to write a marker file outside the intended directory, then patch the extractor to sanitize paths so extraction is safe and idempotent.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Exploit Development & Analysis',
  'Analyze a hardened 64-bit ELF service to locate a format-string vulnerability, then craft a multi-stage exploit that leaks stack/libc addresses and overwrites a GOT entry to redirect execution to a hidden print_secret() routine. Write the recovered secret to /app/flag.txt after successful exploitation.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Exploit Development & Analysis',
  'Develop a proof-of-concept that exploits JWT algorithm confusion in a local API by re-signing an RS256 token as HS256 using the service’s RSA public key to forge an admin token and trigger a privileged action that writes /app/pwned.txt. Add brief inline analysis of the root cause and mitigations (algorithm whitelisting and key-type separation).',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Exploit a misconfigured sudoers rule granting NOPASSWD access to a root-run backup helper that invokes tar over a user-writable directory with unquoted wildcards. Discover the entry and escalate via tar option/wildcard injection to execute code as root, proving success by creating /root/pe_proof.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Privilege Escalation Demonstrations',
  'Exploit a root-run backup script that calls utilities without absolute paths and executes in a user-writable directory by performing a PATH hijack to gain root and prove it by creating /root/owned.txt. Then remediate by hardcoding absolute paths and fixing permissions so the backup still works but the escalation is no longer possible.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Privilege Escalation Demonstrations',
  'Exploit a root-run cron backup script that invokes commands via an insecure PATH and a world-writable /usr/local/bin by dropping a malicious shim to hijack execution and gain root. Read /root/flag.txt and write a byte-identical copy to /app/flag.txt.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Privilege Escalation Demonstrations',
  'Exploit a sudoers misconfiguration that permits running tar as root to achieve privilege escalation by abusing tar’s extended features to execute a root-owned payload, then prove success by creating /root/pe_proof.txt and exporting a protected file to /app/shadow_copy. The task includes a decoy backup workflow and must be completed without editing sudoers or using external tools.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Vulnerability Demonstration & Exploitation',
  'Privilege Escalation Demonstrations',
  'Starting as an unprivileged user, exploit a sudoers misconfiguration that permits passwordless tar to escalate via --checkpoint-action=exec (or crafted wildcard injection), then prove root by creating /root/owned.txt. Mitigate by tightening the sudoers rule to a safe, argument-pinned form so the exploit is no longer possible.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Code Maintenance, Refactoring & Optimization',
  'Architecture & Modularization',
  'Refactor a monolithic Python CLI in /app/tool.py into a modular package with a plugin architecture, splitting core parsing, IO, and business logic into reusable modules and dynamically discovering subcommands from a plugins/ namespace (or entry points) while preserving the exact CLI and outputs. Add a thin library API, dependency inversion for side effects, and an environment variable to control plugin loading for deterministic runs.',
  NULL,
  ARRAY['python', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Architecture & Modularization',
  'Refactor a monolithic Python log-ingestion CLI into a modular package with layered components (parsers, processors, sinks) and a plugin system that discovers extensions via entry points. Preserve the original CLI flags and output behavior while enabling backend swapping through configuration and dependency injection.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Code Cleanup & Refactoring',
  'Refactor a sprawling monolithic Makefile in /app/Makefile into a maintainable build system using pattern rules, variables, and included fragments, preserving all target names, dependencies, and artifacts. Serial and parallel builds (-j) must remain deterministic and identical to the original, with the default target and CLI UX unchanged.',
  NULL,
  ARRAY['parallel']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Migrate a FastAPI service from FastAPI 0.9x and pydantic v1.x to FastAPI 0.110+ and pydantic v2.x, updating models, validators, settings, and serialization (parse_obj -> model_validate, .dict()/.json() -> model_dump()/model_dump_json()). Preserve all route signatures, OpenAPI schema, and response payloads so the existing tests (including schema snapshots) pass unchanged.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Dependency Modernization',
  'Upgrade a FastAPI microservice from Pydantic v1.x and FastAPI <0.100 to Pydantic v2.x and the corresponding FastAPI release, refactoring models, validators, and response models to the new API (or applying the pydantic.v1 shim) while preserving the external HTTP API and OpenAPI schema. Update dependency pins and build config so the existing tests pass unchanged and runtime behavior remains stable.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Dependency Modernization',
  'Upgrade a Python data pipeline from NumPy 1.x/Pandas 1.x to NumPy 2.x/Pandas 2.x, replacing deprecated APIs (e.g., dtype aliases, numpy.matrix, pandas time zone handling, integer NA) and migrating packaging to PEP 517/621. Preserve identical CLI behavior and produce byte-for-byte identical CSV outputs across provided fixtures and hidden tests.',
  NULL,
  ARRAY['python', 'pandas']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Dependency Modernization',
  'Upgrade a legacy Spring Boot 1.5.x Maven service to Spring Boot 3.3.x, migrating javax.* to jakarta.*, updating Spring Security to 6.x and JUnit 4→5. Preserve public REST endpoints and config semantics; build with Java 17+, pass mvn verify, and keep /health responding on localhost:8080.',
  NULL,
  ARRAY['security', 'rest', 'java']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Code Maintenance, Refactoring & Optimization',
  'Performance Profiling & Optimization',
  'Profile a Go CLI that aggregates per-key metrics from a large NDJSON stream but suffers from excessive allocations, JSON decoding hotspots, and goroutine leaks. Use pprof and benchmarks to identify bottlenecks, then refactor to a streaming, buffered design (pre-sized maps, sync.Pool, proper backpressure) to cut memory churn and achieve at least 2× throughput without changing outputs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Performance Profiling & Optimization',
  'Profile a Python CLI that computes PageRank on a large graph using pure Python lists and nested loops, identifying CPU and memory hot spots. Refactor it to use efficient sparse matrix operations and streaming I/O to achieve at least a 5× speedup while preserving identical CLI behavior and output.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Performance Profiling & Optimization',
  'Profile a Python CSV-to-JSON ETL script that processes 1M rows and exhibits long runtimes and high peak memory. Using cProfile and memory_profiler, optimize hot paths (vectorize operations, stream rows, precompile regex/date parsers, eliminate temporary lists) to produce identical output with ≥3× speedup and ≥50% lower peak RSS.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Code Maintenance, Refactoring & Optimization',
  'Performance Profiling & Optimization',
  'Profile a Rust log aggregation tool that is slow due to repeated string allocations and O(n^2) lookups, then refactor it to use zero-copy slice parsing and hash-based indexing to reduce runtime and peak memory by at least 3x without changing output. Provide before/after flamegraphs and memory measurements to demonstrate the optimization.',
  NULL,
  ARRAY['rust', 'optimization']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Collaboration, Review & Documentation',
  'Change Log & Release Notes',
  'Consolidate scattered CHANGES files and an inconsistent legacy changelog into a single Keep a Changelog–compliant CHANGELOG.md, auto-inferring the next SemVer (including pre-release and breaking-change bumps) from Conventional Commits since the last stable tag. Produce release_notes_vX.Y.Z.md with compare links, grouped sections (Added/Changed/Fixed/etc.), deduplicated PR/issue references, and create an annotated git tag for the release.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Author a production-grade README.md and CONTRIBUTING.md for an existing CLI tool in /app, covering Quickstart, Configuration via environment variables, copy-pastable Usage examples, and Troubleshooting. All README code blocks must execute verbatim in the container to produce the documented outputs, and CONTRIBUTING must define branching, Conventional Commits, and local test/lint workflow.',
  NULL,
  ARRAY['container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Collaboration, Review & Documentation',
  'Documentation & README Creation',
  'Author a reproducible README.md and CONTRIBUTING.md for a small CLI in /app that includes Quickstart, installation matrix, a Mermaid architecture diagram, and troubleshooting, plus a scripts/verify_snippets.py that executes every shell code fence from the README and asserts expected outputs. Provide a Makefile doc target that runs the verifier and fails on drift to keep documentation and behavior in sync.',
  NULL,
  ARRAY['installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Collaboration, Review & Documentation',
  'Documentation & README Creation',
  'Create an executable README.md and CONTRIBUTING.md for the provided multi-command Python CLI in /app/tool, including installation, feature overview, per-subcommand usage, examples, and contribution steps. The harness will run markdownlint, execute all shell code blocks in the README to verify outputs, and fail if the README’s documented flags or a generated help2man man page diverge from the program’s --help.',
  NULL,
  ARRAY['python', 'installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Collaboration, Review & Documentation',
  'Documentation & README Creation',
  'Given a small CLI project in /app, write a production-grade README.md and CONTRIBUTING.md that include installation, usage (auto-synced from the tool’s --help), examples, troubleshooting, and licensing. Add an offline `make docs` workflow that verifies all README code blocks execute, checks links, and builds a static docs/ site artifact, failing the build if examples or links are stale.',
  NULL,
  ARRAY['installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Collaboration, Review & Documentation',
  'Documentation & README Creation',
  'Produce a contributor-focused documentation suite for a small monorepo (Python FastAPI service + Node/React client): a top-level README with Mermaid architecture, quickstart via Docker Compose, a troubleshooting matrix, and performance benchmarking guidelines, plus CONTRIBUTING.md with branch strategy, Conventional Commits, code style, test commands, and a PR checklist. Generate a docs site (MkDocs Material) that auto-builds API references from Python docstrings (pdoc) and JSDoc (TypeDoc) and add a CI check that fails on broken links and incomplete sections.',
  NULL,
  ARRAY['python', 'docker', 'performance', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Collaboration, Review & Documentation',
  'Project Management & Issue Tracking',
  'Build a repo-local CLI that scans the codebase for TODO/FIXME annotations and migrates them into GitHub Issues via gh against a local dummy remote, assigning owners from CODEOWNERS, applying labels/milestones from inline tags, and attaching file-line permalinks. The tool must be idempotent (update instead of duplicate), aggregate related comments into checklist issues, and auto-close issues when the corresponding comments are removed.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Collaboration, Review & Documentation',
  'Project Management & Issue Tracking',
  'Create a local file-based issue tracker CLI that imports backlog.csv into /app/issues as YAML files, applies label/assignee rules from label-rules.yml, organizes milestones from milestones.yml, and de-duplicates similar issues. Implement an auto-close command that scans git commit messages for ''Fixes #ID'', updates issue states, and generates release_notes.md grouped by milestone and label.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Logic & Behavior Bugs',
  'A Node.js library that claims to implement the JSON Canonicalization Scheme (RFC 8785) produces incorrect canonical strings for numbers, Unicode escapes, and object key ordering, causing digest mismatches. Identify and fix the serialization logic so SHA-256 hashes of provided fixture JSONs match the expected values and the CLI yields stable byte-for-byte canonical output.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Logic & Behavior Bugs',
  'Fix a cron-like scheduler’s next_run function that produces incorrect times around DST transitions and in time zones with non-integer offsets. Correct wall-clock semantics so 02:30 jobs are correctly skipped or duplicated across transitions and match a provided reference timeline.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Logic & Behavior Bugs',
  'Fix a web framework’s URL router that incorrectly prioritizes parameterized routes over static ones, causing paths like /users/new to match /users/:id instead of /users/new. Identify the flawed matching logic and update precedence (static > param > wildcard) and trailing-slash handling so all routing tests pass.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'A C-based CLI backup tool sporadically segfaults when the user presses Ctrl-C during a deep directory scan due to unsafe access to freed memory in a SIGINT handler. Use gdb and valgrind to isolate the use-after-free, make the signal handling async-signal-safe and fix the buffer lifetime, then add a deterministic regression test that reproduces the original crash.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Runtime Error Debugging',
  'Debug a C++ network daemon that consistently segfaults on the second configuration reload (SIGHUP) due to a use-after-free of a shared configuration object. Reproduce the crash, inspect the core with gdb and run under AddressSanitizer to pinpoint the invalid access, then fix ownership/lifetime and verify that multiple consecutive reloads complete without crashes or leaks.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Runtime Error Debugging',
  'Diagnose and fix a heap-buffer-overflow that triggers a segmentation fault in a C-based PNG decoder CLI when processing a specific image. Reproduce the crash, use gdb and AddressSanitizer to pinpoint the faulty scanline index arithmetic, patch the logic, and verify decoding succeeds without memory errors.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Debugging & Issue Resolution',
  'Runtime Error Debugging',
  'Diagnose and fix an intermittent SIGSEGV in a multithreaded C++ log collector caused by a use-after-free in an async callback. Reproduce under load, pinpoint with AddressSanitizer/gdb, and patch object ownership/lifetimes to eliminate the crash and pass a stress test.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
  'Build Tool Configuration',
  'Configure Bazel (with Bzlmod) for a polyglot monorepo (Python, TypeScript, and Go) that builds, tests, and packages each component, including a custom Starlark rule to stamp git version metadata into binaries. Ensure hermetic, reproducible builds with remote-cache fallback and a //:release target that emits signed tarballs and a CycloneDX SBOM.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Build Tool Configuration',
  'Configure a Bazel monorepo to build a Go CLI and a TypeScript library, vendoring dependencies (Go modules and npm) for offline, hermetic builds and running unit tests for both. Provide WORKSPACE/BUILD files so that bazel build //... and bazel test //... produce reproducible, versioned artifacts in a clean container.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Build Tool Configuration',
  'Create a CMake build for a C++ library that generates a version header from git metadata, fetches fmt via FetchContent, and installs exportable targets with both a CMake package config and a pkg-config .pc file for downstream consumption. The harness should build out-of-tree, run ctest, install to /app/dist, then compile a separate consumer using find_package or pkg-config, and verify incremental builds are no-ops and the reported version matches the latest git tag.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  NULL,
  ARRAY['python', 'api', 'web', 'frontend', 'backend', 'redis', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Developer Environment Setup',
  'Create a reproducible VS Code devcontainer for a polyglot repo (FastAPI backend + Next.js frontend) with hot-reload debugging, pre-commit hooks, and Postgres/Redis services started via docker-compose, exposing ports 8000 and 3000. Include a non-VS Code bootstrap script and health checks so the task passes only when both apps, databases, and lint hooks are active.',
  NULL,
  ARRAY['backend', 'frontend', 'debugging', 'redis', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
  'Developer Environment Setup',
  'Create a reproducible polyglot developer environment using Nix flakes and direnv for a repo combining Python 3.11, Rust 1.75, and Node 20, with a matching Docker image generated from the same flake. Pin all toolchains, wire pre-commit hooks, and ensure `make test` runs identically inside `nix develop` and `docker run`.',
  NULL,
  ARRAY['python', 'rust', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
  'Developer Environment Setup',
  'Set up a Nix flake-powered VS Code devcontainer that provides a hermetic polyglot toolchain (Rust, Python, Node.js, Go) with pinned versions, LSPs, and pre-commit hooks via direnv integration. Enable Docker Buildx/QEMU multi-arch and ccache/sccache so the same make bootstrap and make test targets work identically on x86_64 and arm64.',
  NULL,
  ARRAY['rust', 'python', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
  'Developer Environment Setup',
  'Set up a VS Code Dev Container backed by Docker Compose that provisions Python 3.11 (via uv), Node.js 20, and Rust stable, with Postgres 15 and Redis 7 as sidecar services. Include bootstrap scripts and pre-commit so that entering the container pins tool versions and a single make verify command builds a sample Rust crate, runs npm install, and executes pytest integration tests that talk to the databases.',
  NULL,
  ARRAY['container', 'docker', 'python', 'rust', 'redis']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Development Tooling & Workflow Automation',
  'Toolchain Customization & Extensions',
  'Build a custom clang-tidy module that implements a check (e.g., modernize-avoid-raw-new) to flag and auto-fix uses of new/delete by suggesting std::make_unique/make_shared, and integrate it into a CMake project with a .clang-tidy config and a script to run it on the codebase. Include unit tests for the check and ensure the plugin builds and runs entirely within the sandbox.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Toolchain Customization & Extensions',
  'Implement an ESLint plugin with a rule that bans direct fetch/axios usage and enforces routing HTTP calls through a project-specific client API, including a robust AST-based autofixer. Provide CLI tests that lint and auto-fix sample files to verify correct detection, messages, and transformations.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Version Control & Branching',
  'Locate a regression by automating git bisect with a script that runs the project’s tests to identify the first bad commit, then create a hotfix branch with the minimal fix. Cherry-pick the fix onto the latest release branch and create a GPG-signed annotated patch-release tag, ensuring linear history and passing tests on both branches.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Version Control & Branching',
  'Migrate a repository that uses two submodules into a monorepo via git subtree, preserving complete history and retagging releases with component-prefixed tags. Then merge three diverging feature branches with an octopus merge, resolving JSON conflicts via a custom merge driver configured through .gitattributes.',
  NULL,
  ARRAY['git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Development Tooling & Workflow Automation',
  'Version Control & Branching',
  'Split a provided monorepo’s frontend/ and backend/ histories into two standalone repositories using git subtree split while preserving commit history and tags, then re-integrate them into the original monorepo as subtrees wired to remotes. Demonstrate a subsequent upstream sync by pulling new commits from both remotes and merging into main as fast-forwards with no content drift.',
  NULL,
  ARRAY['frontend', 'backend', 'git']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Feature Implementation & Algorithm Development',
  'API Design & Integration',
  'Create a WebSocket-to-MQTT bridge that authenticates clients via JWT and implements a JSON protocol for subscribe, unsubscribe, and publish operations, translating them to MQTT with QoS1 and retained message support. Expose an HTTP endpoint to list active client sessions and subscriptions, and ensure clean mapping of error states between WebSocket frames and MQTT acknowledgments.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Implement a KLL streaming quantile sketch with configurable error (epsilon) that supports insert, merge, serialize/deserialize, and percentile queries, exposing both a small library and a CLI that reads floats from stdin and returns requested quantiles. Provide deterministic tests verifying accuracy bounds against exact quantiles on synthetic and adversarial streams.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Algorithm Implementation',
  'Implement a single-pass streaming quantile estimator using the Greenwald–Khanna algorithm with guaranteed epsilon-approximate quantiles. Expose a CLI that ingests an arbitrary-length numeric stream and outputs requested quantiles deterministically for a given epsilon.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Algorithm Implementation',
  'Implement a succinct trie using the LOUDS representation with bit-level rank/select to support exact lookup, prefix enumeration, and lexicographic k-th word queries. Provide a CLI to build from a newline-delimited dictionary and answer mixed queries from stdin efficiently.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Algorithm Implementation',
  'Implement an exact 64-bit integer convolution using Number Theoretic Transforms: compute convolutions modulo multiple NTT-friendly primes and recombine via the Chinese Remainder Theorem (or Garner’s algorithm) to match Python big-integer results. Provide a CLI that reads two integer sequences from stdin and outputs their full convolution, running in O(n log n) for n up to 200,000.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Feature Implementation & Algorithm Development',
  'Code Generation & Automation Utilities',
  'Build a CLI that reads a JSON Schema (Draft 7) from /app/schema.json and generates a Rust crate at /app/gen with idiomatic serde-annotated structs/enums, correctly handling oneOf/anyOf/allOf, defaults, optional fields, and safe field/enum naming. Emit and compile a validator binary that uses the generated types to validate all /app/samples/*.json inputs and writes a summary JSON reporting per-file validity and human-readable errors.',
  NULL,
  ARRAY['rust']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Code Generation & Automation Utilities',
  'Implement a CLI that converts a docker-compose.yml into a Helm chart (Chart.yaml, values.yaml, and templates/*) and auto-generates a GitHub Actions workflow for chart linting and release. The tool (/app/compose2helm.py) supports multiple compose files and environment interpolation, and tests verify the rendered manifests on a sample project.',
  NULL,
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Feature Extension & Enhancement',
  'Extend an existing Node.js Express REST API backed by SQLite by adding optimistic concurrency (ETags/If-Match), soft deletes with a restore endpoint, and full-text search over titles/descriptions using SQLite FTS5. Introduce /search and /items/:id/restore routes, apply schema migrations, and update the OpenAPI spec to reflect the new behavior and error codes.',
  NULL,
  ARRAY['rest', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Feature Extension & Enhancement',
  'Extend an existing Python CLI notes/todo app by adding a `search` subcommand backed by SQLite FTS5 that queries titles and bodies with ranked results and optional --limit/--offset/--json output. Implement a migration to create and keep the FTS index in sync, update the data layer, and add tests covering ranking, pagination, no-match behavior, and Unicode tokenization.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Feature Extension & Enhancement',
  'Extend an existing Python CLI that reads NDJSON logs to support a SQL-like query engine (SELECT fields, WHERE, ORDER BY, LIMIT/OFFSET, GROUP BY with count/sum/avg) and a --follow mode that processes streaming input in constant memory. Add a plugin system for custom aggregate functions discovered at runtime and a plugins subcommand to list/validate them with robust error reporting.',
  NULL,
  ARRAY['python', 'sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Feature Implementation & Algorithm Development',
  'Feature Extension & Enhancement',
  'Extend the provided Python static site generator by adding an incremental build cache and a `watch` subcommand. Track per-page dependencies via content hashes (templates, partials, assets) so only affected outputs are rebuilt on change, and write a manifest proving cache hits/misses for each build.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security, Compliance & Reliability Engineering',
  'Dependency & License Compliance',
  'Create a CLI that compares two dependency lockfiles (npm, Poetry/pip-tools, and Go modules), resolves each dependency’s license (including transitives), and writes a policy-checked diff report to /app/license_diff.json. It must detect license changes, dual-licensing nuances, and missing metadata, consult OSV for disallowed packages, and exit non-zero on violations.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security, Compliance & Reliability Engineering',
  'Reliability & Fault Tolerance',
  'Implement a resilient webhook relay daemon that reads events from /app/queue.jsonl and delivers them to a flaky HTTP endpoint using capped exponential backoff with jitter, a circuit breaker (with half-open probing), and a token-bucket rate limiter. On persistent failure it must dead-letter events, serve stale-but-valid cached results, and guarantee idempotent, exactly-once visible delivery across restarts via checkpointed offsets and idempotency keys.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Audit and harden a Python backup/restore utility that creates and extracts tar archives, currently vulnerable to Zip Slip path traversal and a --post-hook command injection via shell=True. Constrain extraction to a specified base directory, sanitize tar members, replace shell execution with safe subprocess invocation and an allowlist, and add tests that confirm malicious archives cannot escape the sandbox while preserving normal behavior.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security, Compliance & Reliability Engineering',
  'Secure Coding Practices',
  'Given an intentionally vulnerable Node.js microservice/CLI in /app, remediate prototype pollution in JSON merging, command injection in child_process usage, and ReDoS in a user-supplied regex. Replace unsafe patterns with secure alternatives, add regression tests, and ensure npm audit reports no high/critical issues.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security, Compliance & Reliability Engineering',
  'Secure Coding Practices',
  'Harden a Python FastAPI file-processing service that currently uses shell=True and trusts filenames by replacing unsafe subprocess calls with argument lists, adding strict input validation and path whitelisting to prevent command injection and directory traversal, and moving credentials out of source into an .env file with parameterized loading. Add automated tests that demonstrate exploit payloads are blocked (command injection, path traversal) while valid operations still pass.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Security, Compliance & Reliability Engineering',
  'Secure Coding Practices',
  'Harden a vulnerable Python Flask file-processing API by replacing unsafe YAML loading, removing shell=True subprocess usage to prevent command injection, and blocking path traversal/symlink attacks on uploads. Add tests proving malicious payloads are neutralized while preserving intended functionality.',
  'hard',
  ARRAY['python', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'Codebase Architecture Documentation',
  'Create a script that scans a polyglot repo (Python and Node) to generate /app/docs containing a C4-style container diagram inferred from docker-compose.yml, per-service module dependency graphs, and a consolidated architecture README. The script must be idempotent, detect and list circular dependencies, and output diagrams in both Mermaid and PlantUML formats.',
  NULL,
  ARRAY['python', 'container', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Software Architecture & Design Patterns',
  'Codebase Architecture Documentation',
  'Given a polyglot microservices monorepo with docker-compose, build a tool that parses source imports and compose files to generate a cross-service architecture diagram and per-language package dependency graph, emitting Graphviz artifacts and a Markdown overview. The tool must detect cycles and boundary violations and fail CI when found, with tests verifying required nodes/edges and report contents.',
  NULL,
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a Unix-style streaming log processor CLI where pipeline stages share a common Stream interface and are composed using Chain of Responsibility, with cross-cutting concerns (timing, retries, metrics) applied via Decorator. Support dynamic stage discovery and instantiation through an Abstract Factory that loads plugins from a plugins/ directory and a config file describing the pipeline.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'Design Pattern Implementation',
  'Implement a Python CLI task runner that uses the Command pattern for actions, Memento for undo/redo, and an Abstract Factory to load pluggable commands from /app/commands at runtime. The tool must support run, undo, redo, and macro commands (Composite) without modifying the core engine when new commands are added.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'Design Pattern Implementation',
  'Implement a mini rule-engine that parses and evaluates a boolean filtering DSL over JSON records using the Interpreter and Composite patterns. Provide a CLI that reads NDJSON from stdin, prints matching lines, and supports adding new operators via pluggable terminals without modifying the core parser.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'Design Pattern Implementation',
  'Refactor a provided Python CLI to-do app into a modular design that applies Command (with undo/redo), Strategy (pluggable storage backends: in-memory, JSON file, SQLite), and Observer (event hooks for sync/logging). Implement dynamic plugin discovery for new Strategy backends and a test suite validating persistence, undo/redo semantics across restarts, and event notifications.',
  NULL,
  ARRAY['python', 'logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Refactor a Node.js Express REST API that uses module-scoped singletons and inline SQL into a layered design (controllers/services/repositories) with dependency injection and repository interfaces so side effects are isolated and components are easily testable. Preserve all route paths and JSON responses exactly, and ensure the existing test suite passes unchanged.',
  NULL,
  ARRAY['rest', 'api', 'sql']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'Refactoring for Maintainability',
  'Refactor a monolithic Go HTTP service that directly accesses PostgreSQL and global singletons into a hexagonal (ports/adapters) architecture with domain, application, and infrastructure layers, explicit interfaces, and constructor-based dependency injection. Preserve all HTTP routes, response schemas, environment variables, and logging formats, and add golden tests to verify identical behavior before and after.',
  NULL,
  ARRAY['postgresql', 'logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Software Architecture & Design Patterns',
  'Refactoring for Maintainability',
  'Refactor a small Flask microservice in /app to a ports-and-adapters (hexagonal) architecture by extracting domain logic into pure modules, introducing repository/service interfaces, and isolating framework/infrastructure behind adapters. Preserve the exact REST API and CLI behavior and response formats while removing global state and adding dependency injection seams for testability.',
  NULL,
  ARRAY['rest', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software Architecture & Design Patterns',
  'System & Module Design',
  'Design a plugin-based data pipeline with strict layering (domain: Stage/DAG interfaces, application: orchestrator, infrastructure: adapters) where stages are discovered dynamically and wired from a YAML-defined DAG. Implement CSVReader, Filter, Aggregate, and JSONWriter stages and provide a static dependency check that fails if any stage module imports the orchestrator or adapters.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Continuous Testing Integration',
  'Implement a local CI harness that reads a ci.yml, spins up required services via Docker Compose (e.g., PostgreSQL), shards tests across N parallel workers for Python and Node subprojects, and retries failures once to classify flakiness. The pipeline must produce merged JUnit XML and coverage reports, enforce coverage thresholds during the build stage, and output a summary.json with pass/fail, flake counts, and artifacts paths.',
  'hard',
  ARRAY['docker', 'postgresql', 'parallel', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Testing, Validation & Quality Assurance',
  ...
  NULL,
  ARRAY['testing', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Testing, Validation & Quality Assurance',
  'End-to-End (E2E) & Regression Testing',
  'Build a Dockerized E2E and regression test harness that launches a three-service sample app (frontend, API, Postgres) via docker-compose, seeds test data, and runs headless Playwright tests against localhost. Include golden JSON and visual snapshot assertions, collect screenshots/HAR/logs on failure, and provide a single CI-friendly script that exits nonzero on any diff.',
  NULL,
  ARRAY['frontend', 'api', 'docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Testing, Validation & Quality Assurance',
  'End-to-End (E2E) & Regression Testing',
  'Create a migration regression harness that spins up a temporary PostgreSQL instance, applies upgrade/downgrade paths across a set of SQL migrations, seeds data, and verifies invariants by comparing normalized query results and schema digests to golden snapshots. Include a CLI to run the full matrix (all from→to versions), detect drift and irreversibility, and optionally update snapshots.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'End-to-End (E2E) & Regression Testing',
  'Create a regression harness that runs the same Playwright E2E suite against two app versions (baseline vs candidate) via docker-compose, capturing API response snapshots and page screenshots, then producing semantic diffs and visual diffs in /app/artifacts. Implement retry-based flake detection with automatic quarantine list generation and emit a JUnit XML summary suitable for CI.',
  NULL,
  ARRAY['docker', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'End-to-End (E2E) & Regression Testing',
  'Design an automated cross-version E2E regression harness that spins up vN and vN-1 of a sample service (HTTP + gRPC) with docker-compose, replays recorded interactions, and validates API responses, protobuf/JSON schemas, DB state, and log invariants. Integrate OpenAPI/Buf breaking-change checks and emit JUnit and HTML reports to fail the pipeline on incompatibilities.',
  NULL,
  ARRAY['grpc', 'docker', 'api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'Software Engineering & Development',
  'Testing, Validation & Quality Assurance',
  'End-to-End (E2E) & Regression Testing',
  'Implement an E2E regression harness that launches two Dockerized versions (v1 and v2) of a FastAPI service against a fresh Postgres, applies Alembic migrations, seeds fixtures, replays a recorded HTTP trace, and diffs normalized JSON responses to detect behavior drift. The runner must produce JUnit XML and a readable diff, ignoring nondeterministic fields (ids/timestamps/order), and exit nonzero on any semantic mismatch.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Mocking & Test Data Simulation',
  'Build a minimal mock OpenID Connect provider that serves a .well-known discovery document and a rotating RS256 JWKS, and generates signed ID tokens for a set of fixture users. Include a verifier script that fetches the JWKS over HTTP and validates tokens before and after a key rotation, ensuring expired/old-key tokens fail and newly issued tokens pass.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Mocking & Test Data Simulation',
  'Create a spec-driven mock HTTP service that reads an OpenAPI 3.0 spec from /app/spec.yaml and deterministically generates synthetic responses from schema examples and constraints, with toggles for error injection, pagination, and rate limits. Include fixtures and a test harness that validate a client’s handling of boundary values, idempotency keys, and retry/backoff behavior using only the mock service.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Mocking & Test Data Simulation',
  'Implement a local mock payment gateway and webhook relay that mimics Stripe-style semantics: create/confirm payment intents, idempotency-key enforcement, HMAC-signed webhooks with rotating secrets, and deterministic fake card numbers that trigger specific error paths. Provide a seedable synthetic data generator and runtime toggles to simulate latency, network flakiness, 3DS challenge flows, rate limits, and partial outages to validate client robustness.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure a Python+TypeScript monorepo to enforce strict static analysis: mypy --strict (with custom stub packages for a vendored library), flake8 with a custom plugin forbidding naive datetime usage, and ESLint/TypeScript rules requiring explicit return types. Refactor the codebase to eliminate all violations, wire the tools into pre-commit and a CI script that produces /app/lint_report.json and fails on any new issues.',
  NULL,
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Static Analysis & Linting',
  'Create and integrate a custom Flake8 plugin that flags timezone-naive datetime usage, mutable default arguments, and broad exception handlers in a small Python repo. Configure pyproject.toml so flake8 (with the plugin) and mypy --strict both run clean after refactoring the code to satisfy all checks.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Static Analysis & Linting',
  'Implement a custom Flake8 plugin that flags calls where the return value of any function decorated with @must_use is ignored, emitting code MUU100 at the call site. Register the plugin and provide a script that runs flake8 on /app/src and writes a SARIF report to /app/lint.sarif.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Static Analysis & Linting',
  'Implement a custom flake8 plugin that flags functions and methods using mutable default arguments (lists, dicts, sets, and comprehensions), supporting per-line noqa and exemptions for dataclasses field(default_factory=...). Integrate it via setup.cfg, run it over a small Python package with seeded violations, and make the codebase pass with a combination of fixes and justified ignores.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Testing, Validation & Quality Assurance',
  'Unit & Integration Test Implementation',
  'Write a comprehensive pytest + Hypothesis suite for an existing Python CRDT library (e.g., LWW-Element-Set and OR-Map) that verifies merge algebra (commutativity, associativity, idempotence), serialization round-trips, and tombstone semantics. Tests should generate randomized concurrent operation sequences across multiple replicas, simulate partitions and merges, and assert eventual consistency and order-independence in end-to-end scenarios.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cloud & Remote Environment Configuration',
  'Cloud CLI Setup',
  'Configure the AWS CLI to use a named profile that obtains credentials via credential_process from a local Python helper and auto-assumes a role, with region/output defaults set. Point S3 and STS to LocalStack endpoints so offline aws sts get-caller-identity and aws s3api list-buckets work using that profile.',
  NULL,
  ARRAY['aws', 'python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cloud & Remote Environment Configuration',
  'Cloud CLI Setup',
  'Install Google Cloud SDK and create two named gcloud configurations (dev and prod) using provided service account key files in /app/keys, setting distinct default project IDs and compute regions/zones for each. Activate each config in turn, initialize Application Default Credentials from its key, and verify the active account, project, and ADC source switch correctly between dev and prod.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Launch a LocalStack instance and use Terraform to provision an S3 bucket, an SQS queue, and a least-privilege IAM user/policy, wiring S3 ObjectCreated notifications to the queue. Configure awscli with the issued credentials, upload a test object, and consume the resulting queue message to validate the end-to-end flow.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cloud & Remote Environment Configuration',
  'Resource Provisioning & Management',
  'Start a LocalStack container and use Terraform to provision an SNS topic, an SQS queue with a dead-letter queue, and a subscription connecting the topic to the queue. Publish a test message and verify delivery by consuming it from the queue via the AWS CLI.',
  NULL,
  ARRAY['container', 'aws']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Cloud & Remote Environment Configuration',
  'Resource Provisioning & Management',
  'Use Terraform against LocalStack to provision an S3→SNS→SQS event pipeline: a versioned bucket that publishes object-created events to an SNS topic with an SQS subscription and a dead-letter queue. Validate by uploading a test object via awscli, reading the event from SQS, and demonstrating DLQ redrive behavior.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create an LVM volume group on a loopback disk with an ext4 logical volume mounted at /mnt/data, and implement consistent backups by taking read-only LVM snapshots before each run. Configure a systemd service/timer that uses rsync --link-dest to maintain 7 rotating daily backups in /srv/backups, then demonstrate recovery by restoring a file from a previous snapshot.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Backup & Snapshot Management',
  'Deploy a local MinIO S3 service and configure restic with repository encryption to back up /app/data using exclude patterns, tags, and a scheduled cron job enforcing a retention policy (keep 7 daily, 4 weekly, 12 monthly). Perform initial and follow-up backups with file changes, run forget/prune, then restore a specific snapshot to /app/restore verifying checksums and that no plaintext filenames exist in the repository.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Backup & Snapshot Management',
  'Install and configure BorgBackup to create encrypted, deduplicated snapshots of /data into a local repository at /backups/borg with an hourly systemd timer and a retention policy of 7 daily, 4 weekly, and 6 monthly snapshots, followed by a repository integrity check. Demonstrate correctness by modifying and deleting sample files, restoring a chosen snapshot to /restore, and verifying contents and that prune retained the requested generations.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Disk Partitioning & Mounting',
  'Create a GPT-partitioned loopback disk, build an LVM-on-LUKS stack on one partition, and mount the decrypted logical volume at /srv/secure with persistent /etc/crypttab and /etc/fstab entries using UUIDs and a root-only keyfile. Demonstrate that after detaching and reattaching the loop device the volume auto-opens and mounts non-interactively, preserving data.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a loopback-backed XFS filesystem mounted at /mnt/projects with pquota enabled and configure project quotas for two directories (/mnt/projects/build-cache and /mnt/projects/datasets) via /etc/projid and /etc/projects, setting soft/hard limits of 500MB and 1GB with a 7-day grace period. Apply setgid and default ACLs so group ''research'' has rwx on both trees, then verify quota enforcement with xfs_quota reports and writes that exceed the limits.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Filesystem Permissions & Quotas',
  'Create a loopback-backed XFS filesystem mounted at /srv/projects with project quotas (prjquota) enabled, defining two directory-scoped projects via /etc/projects and /etc/projid with distinct soft/hard limits, and configuring setgid plus default ACLs for collaborative inheritance. Verify enforcement by filling each project until soft/hard limits and grace periods trigger, confirming with xfs_quota reports and observed EDQUOT failures.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Filesystem Permissions & Quotas',
  'Provision a loopback-mounted XFS filesystem at /mnt/projects with prjquota enabled, bind project ''projA'' to /mnt/projects/projA via /etc/projid and /etc/projects, and enforce an 80MB soft/100MB hard project quota (7-minute grace) using xfs_quota with persistence in /etc/fstab. Validate enforcement by writing data as multiple users and confirming over-limit writes are denied.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Filesystem & Storage Management',
  'Filesystem Permissions & Quotas',
  'Provision an XFS filesystem on a loopback device mounted at /mnt/studio with prjquota enabled, configure a project quota that caps /mnt/studio/assets at 1 GiB via /etc/projects and xfs_quota, and set per-user soft/hard quotas for alice and bob. Enforce collaborative permissions by applying setgid, sticky bit, and default ACLs for the ''artists'' group, demonstrate chattr +i on a file, and verify quota/permission enforcement with xfs_quota and failed writes.',
  'hard',
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Networking & Connectivity',
  'Firewall & Security Rules',
  'Configure iptables to implement a three-step port knocking sequence (4001 → 4002 → 4003 within 10s) that temporarily opens SSH (port 22) only for the knocking source, while default-denying inbound and allowing established/related traffic. Persist the rules across reboots and verify SSH is blocked before knocking, opens after the sequence, and relocks after a timeout.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Networking & Connectivity',
  'Firewall & Security Rules',
  'Configure iptables-based port knocking that keeps SSH (port 22) closed by default and opens it for 60 seconds only to the knocking client after a correct sequence on three high ports. Enforce a default-deny inbound policy, add logging for knock attempts, and verify both denial without knocking and successful SSH after the sequence.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure a dual-homed Linux host where eth0 uses DHCP and eth1 has a static 192.168.50.2/24; add policy-based routing so traffic sourced from 192.168.50.0/24 uses gateway 192.168.50.1 while all other traffic uses the DHCP default route. Set per-domain DNS with systemd-resolved so queries to corp.local use 192.168.50.53 via eth1, ensuring settings persist across reboots with netplan.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build a three-namespace topology (client–router–server) with mismatched MTUs and ICMP “Fragmentation Needed” filtered, then diagnose a stalled TCP connection using tracepath/ping and tcpdump to pinpoint a PMTU blackhole. Fix the issue by permitting ICMP or enabling TCP MSS clamping and verify successful HTTP transfer end-to-end.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Networking & Connectivity',
  'Network Diagnostics & Debugging',
  'Create a three-namespace topology (client-router-server) where the router drops ICMP Fragmentation Needed, producing a PMTU blackhole that causes HTTPS requests to hang. Use ping with DF, traceroute, and tcpdump to confirm the issue, then fix it by enabling TCP MSS clamping (or lowering MTU) on the router and verify curl completes successfully.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Networking & Connectivity',
  'Network Diagnostics & Debugging',
  'Create three network namespaces (client, router, server) linked by veth; drop ICMP ''Fragmentation Needed'' on the router to simulate a PMTU black hole that causes HTTP transfers to hang. Diagnose with ping -M do, traceroute, ss, and tcpdump, then fix by enabling TCP MSS clamping on the router and verify a large curl from client to server succeeds.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Operating System Configuration',
  'Environment Variables & Profiles',
  'Install direnv and integrate it system-wide for both bash and zsh via /etc/profile.d so it loads automatically for all users. Create /srv/project with a .envrc that exports APP_ENV=staging, prepends /opt/tools/bin to PATH, sets PYTHONPATH, and verify as user dev that entering/leaving the directory auto-loads/unloads these variables.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Operating System Configuration',
  'Process & Resource Management',
  'Create a systemd slice and templated service constrained by cgroup v2 (e.g., CPUQuota and MemoryMax) and trigger it via a Persistent=true systemd timer to run periodic batch jobs. Verify scheduled execution, enforced resource limits, automatic restart-on-failure behavior, and logs accessible with journalctl.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Operating System Configuration',
  'System Parameters & Kernel Settings',
  'Enable compressed swap-on-RAM (zram) with a persistent swap device sized to 50% of system memory, tune vm.swappiness=80 and vm.vfs_cache_pressure=200 via /etc/sysctl.d, and disable Transparent Huge Pages at boot. Verify the settings persist and that zram is active in /proc/swaps and THP shows "never" in sysfs.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Operating System Configuration',
  'System Parameters & Kernel Settings',
  'Persistently harden and tune the kernel by setting sysctl values via /etc/sysctl.d (disable unprivileged user namespaces and BPF, restrict dmesg, enable TCP syncookies, increase somaxconn and inotify limits) and raise per-user nofile/nproc ulimits via /etc/security/limits.d. Verify live and persistent effect with sysctl and ulimit checks after reloading settings and starting a fresh shell.',
  'hard',
  ARRAY['security']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Service & Daemon Management',
  'Log Monitoring & Service Debugging',
  'Debug a systemd unit ''imgsvc.service'' that crash-loops on startup: journald reveals ''listen tcp :80: bind: permission denied'' and write failures due to DynamicUser=yes. Update the unit to grant AmbientCapabilities=CAP_NET_BIND_SERVICE and define a RuntimeDirectory with correct permissions, then verify it binds to 0.0.0.0:80 and runs cleanly with logs visible in journald.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Install Prometheus and node_exporter as system services, configure Prometheus to scrape node_exporter and itself on localhost, and ensure both start on boot. Verify successful scraping by querying Prometheus’s HTTP API for the up metric and confirm it returns 1 for both targets.',
  NULL,
  ARRAY['api']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Service & Daemon Management',
  'Service Installation & Setup',
  'Install and configure MinIO as an S3-compatible object storage service with a self-signed TLS certificate, listening on 0.0.0.0:9443 and managed via systemd. Create an admin user and a test bucket with a read-only policy, configure AWS CLI to use the endpoint, and verify by uploading and retrieving a file.',
  NULL,
  ARRAY['aws']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Service & Daemon Management',
  'Service Installation & Setup',
  'Install and configure the Mosquitto MQTT broker with plaintext (1883) and TLS (8883) listeners, password-based authentication, and persistence managed via systemd. Generate a self-signed certificate, enable the service on boot, and verify pub/sub functionality using mosquitto_pub and mosquitto_sub over both transports.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a socket-activated, templated systemd service (echo@.service) that spawns per-connection Python echo handlers from echo.socket on 127.0.0.1:9999 (Accept=yes), running under DynamicUser with hardening and network-online dependencies. Add a non-root user-level timer (with lingering enabled) that health-checks the socket every minute and configure persistent journald logs to verify on-demand startup and successful checks.',
  'hard',
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Service & Daemon Management',
  'Systemd & Init Configuration',
  'Create a socket-activated, templated systemd service that spawns per-connection instances of a tiny Python HTTP responder via Accept=yes on port 8080 using the inherited socket (fd 3). Verify on-demand activation with curl, that each instance exits after one request, and enable the socket to start at boot.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Service & Daemon Management',
  'Systemd & Init Configuration',
  'Implement a socket-activated, per-connection systemd service (using a .socket and a templated .service) that runs a minimal HTTP echo server bound to 127.0.0.1:8085 with DynamicUser and strict sandboxing. Validate that a curl request triggers on-demand startup, serves a response, then the service stops after an idle timeout while the socket remains listening.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Diagnose and repair a system with corrupted shared libraries and an interrupted apt/dpkg transaction by verifying package integrity with debsums and fixing the broken package state. Reinstall only the affected packages, refresh the dynamic linker cache, and verify the repair with a successful HTTPS curl and a Python ssl import.',
  NULL,
  ARRAY['python']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Configure APT pinning to add Debian testing with low priority, then install only neovim (>=0.9) from testing while keeping the rest of the system on stable, removing any vim* packages and setting nvim as the default vi/editor via update-alternatives. Place neovim on hold to prevent unintended upgrades and verify pinning/hold status with apt-cache policy and apt-mark.',
  NULL,
  ARRAY['testing', 'rest']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software & Package Management',
  'Package Installation & Removal',
  'Create a GPG-signed local APT repository served over HTTP, build and publish a hello-terminal-bench .deb to it, add the repository to sources.list with its key, then install the package using apt. Finally, remove and purge the package and verify its maintainer scripts executed by logging to a known file.',
  NULL,
  ARRAY['logging']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software & Package Management',
  'Package Installation & Removal',
  'Create a signed local APT repository under /srv/apt (using apt-ftparchive or reprepro), add it to sources.list.d with its GPG key, and install a provided custom .deb from it. Then remove the package, revoke the repo by removing the key and source, run apt clean/update, and verify the package is no longer available.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software & Package Management',
  'Package Installation & Removal',
  'Enable multiarch on a Debian/Ubuntu system to install side-by-side i386 and amd64 variants of selected libraries (e.g., libssl and zlib), pin the exact versions, and validate via dpkg-query that both architectures are present. Then purge the i386 variants, remove the version holds, disable multiarch, and confirm apt autoremove leaves no residual dependencies.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Software & Package Management',
  'Package Installation & Removal',
  'Set up a signed local APT repository hosting a dummy hello-bench .deb and configure apt to trust and prefer it via pinning. Install hello-bench from the local repo, then remove and purge it, verifying with apt-cache policy and dpkg status that the correct source and state transitions occurred.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Build and serve a local APT repository containing a trivial hello-world .deb; generate a GPG key, sign the Release, and add a deb822 .sources entry using signed-by in /usr/share/keyrings. Pin priorities so only hello-world resolves from the local repo while all other packages come from the default sources, and verify via apt-cache policy and installation.',
  NULL,
  ARRAY['installation']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Create a CLI that parses /var/log (syslog, auth.log, kern.log, and rotated files) for the last 24h, normalizes PIDs/IPs/hex to cluster messages into error signatures, and ranks them by frequency. Produce /app/log_report.json and /app/log_report.txt summarizing each cluster with count, first/last timestamps, and inferred service to aid rapid fault isolation.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Performance Tuning',
  'Deploy Nginx to serve a large static file and record a baseline using a load generator (e.g., wrk). Tune worker and I/O settings (epoll, worker_processes auto, worker_connections, sendfile/tcp_nopush, open_file_cache, reuseport, directio for large files) to achieve at least a 50% throughput increase while keeping 99th percentile latency under a set target.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Performance Tuning',
  'Implement PSI-aware memory tuning by enabling zram swap and adjusting vm.swappiness, min_free_kbytes, and dirty writeback thresholds to reduce contention under load. Drive concurrent memory pressure with stress-ng alongside a lightweight HTTP service and demonstrate improved p95/p99 latency and zero OOMs versus a baseline configuration.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Performance Tuning',
  'Optimize a localhost Nginx static-file server for high concurrency and low latency by tuning Linux TCP/sysctl (e.g., somaxconn, tcp_max_syn_backlog, ip_local_port_range), file-descriptor limits, and Nginx worker settings (worker_processes, worker_connections, reuseport, sendfile). Provide a repeatable wrk/ab benchmark that records before/after throughput and p99 latency, demonstrating measurable improvement and saving results to /app/perf/results.json.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Performance Tuning',
  'Use cgroup v2 (via systemd) to isolate a foreground web service from background CPU and disk contention by tuning cpu.max/cpu.weight, io.weight, and memory.high/memory.min. Induce load with stress-ng/fio and demonstrate improved p99 latency under wrk after tuning compared to a baseline.',
  NULL,
  ARRAY['web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Performance Tuning',
  'Use cgroups v2 (via systemd slices) to constrain a CPU/memory‑intensive background workload while prioritizing a latency‑sensitive HTTP server, and tune kernel networking sysctls (somaxconn, tcp_fastopen) to improve accept throughput. Verify under sustained stress that the server maintains sub‑50 ms p95 latency over 1000 requests and that the batch workload cannot exceed its CPU/memory quotas.',
  NULL,
  ARRAY['networking']
);

-- Batch 14 complete (1400 tasks)

INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'System Setup & Configuration',
  'System Monitoring & Diagnostics',
  'Resource Monitoring',
  'Build a CLI monitoring tool that periodically samples CPU, memory, and disk I/O using top/ps, vmstat, and iostat over a fixed window and writes a single summary report highlighting bottlenecks (top CPU/RSS processes, avg iowait, swap activity, busiest block device). If thresholds are exceeded, emit actionable tuning suggestions (e.g., processes to renice/ionice and kernel parameter hints like vm.swappiness) and exit non-zero to signal an alert.',
  NULL,
  ARRAY['monitoring']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'System Monitoring & Diagnostics',
  'Resource Monitoring',
  'Create an automated profiler that runs a short, reproducible workload and samples top, ps, iostat -x, and vmstat at 1-second intervals for 60 seconds, writing CSV logs and a human-readable summary. Based on thresholds (CPU idle, iowait, swap-in/out, disk util/await), classify the bottleneck as CPU-, memory-, or disk-bound and emit one concrete tuning recommendation (e.g., adjust vm.swappiness or revisit the I/O scheduler).',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Authentication & Access Control',
  'Configure OpenSSH to accept only user certificates signed by a local CA, using TrustedUserCAKeys and an AuthorizedPrincipalsFile restricted to the principal ''ci-runner''. Generate the CA and client certs, add a RevokedKeys list for a second cert, and verify cert-based login succeeds while password and plain public key auth are denied.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'User & Access Management',
  'Authentication & Access Control',
  'Configure OpenSSH to require certificate-based user authentication using a locally generated OpenSSH CA, with TrustedUserCAKeys set and PasswordAuthentication/PubkeyAuthentication disabled. Create one valid signed client cert and one revoked cert via RevokedKeys, then verify only the non-revoked certificate can log in.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'User & Access Management',
  'Authentication & Access Control',
  'Set up OpenSSH to use a user certificate authority for authentication: generate a CA keypair, sign a user’s key with a principal, configure sshd with TrustedUserCAKeys and AuthorizedPrincipalsFile, and disable password/non-cert public key logins. Verify the user can SSH to localhost using the signed certificate while ordinary keys and passwords are rejected.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'User & Access Management',
  'File Ownership & ACL Management',
  'Create a multi-team workspace in /srv/work using POSIX ACLs, default ACLs, setgid directories, and sticky bits so new files inherit the correct group and permissions: alpha/ and beta/ are rwX for their teams, read-only to the other team, ops has rwX everywhere, dropbox/ is write-only for all except owners and ops, and secrets/ is ops-only. Validate effective rights and inheritance by creating test files as alice, bob, carol, and an ops user via su, and confirming expected access with getfacl and targeted read/write attempts.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'User & Access Management',
  'File Ownership & ACL Management',
  'Create a multi-tenant /data/workspace with subdirectories shared, dropbox, and pii using POSIX ACLs plus setgid/sticky bits to enforce role-specific access (dev/audit/intern): shared RWX for dev+audit with interns read-only, dropbox write-only for interns with sticky, and pii RWX for dev, read-only for audit, no access for interns. Configure default ACLs so new content inherits correctly and adjust the ACL mask to demonstrate effective permission reduction where required.',
  NULL,
  NULL
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Container Setup & Management',
  'Build a Docker Compose stack with a non-root Python web app and a Redis service on a custom user-defined bridge network (with service DNS aliases), using a named volume for Redis persistence and a bind-mounted read-only app config. Harden the containers (read-only rootfs, drop all capabilities except NET_BIND_SERVICE, no-new-privileges), add HTTP healthchecks, CPU/memory limits, and restart policies; expose the app on host port 8081 and verify it can round-trip keys through Redis.',
  'hard',
  ARRAY['docker', 'python', 'web', 'redis']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'System Setup & Configuration',
  'Virtualization & Containerization',
  'Container Setup & Management',
  'Build and run a Docker Compose stack where a custom Flask API image connects to a Redis container over a user-defined bridge network with aliases, and Redis uses a named volume for persistent storage. Expose the API on host port 8080, add healthchecks and a dependency on Redis readiness, then verify via curl that a request counter persists across restart cycles.',
  NULL,
  ARRAY['docker', 'api', 'redis', 'container']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'System Setup & Configuration',
  'Virtualization & Containerization',
  'Container Setup & Management',
  'Deploy a private Docker Registry v2 on localhost with storage in /srv/registry, secured with self-signed TLS and HTTP basic auth, and configure the host (certs and /etc/hosts) so the Docker client can trust and authenticate to it. Build, tag, and push a custom hello-web image to the registry, then run it from the registry and verify it serves the expected page on port 8081.',
  NULL,
  ARRAY['docker', 'web']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Container Setup & Management',
  'Deploy a private, TLS-enabled Docker Registry with basic auth backed by a persistent volume, reachable at https://registry.local:5000 on a custom bridge network. Generate a self-signed CA and server cert, install the CA for the Docker client, docker login, build and push a labeled test image, then pull it to verify digest and label integrity.',
  NULL,
  ARRAY['docker']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  'System Setup & Configuration',
  'Virtualization & Containerization',
  'Image Building & Exporting',
  'Assemble a minimal Debian-based cloud image from scratch using debootstrap, package it into a bootable qcow2 with ext4 and GRUB, and enable cloud-init. Export the image to /app/images/debian-cloud.qcow2 and verify it by booting with QEMU using a NoCloud seed that creates a known user and hostname.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Image Building & Exporting',
  'Build a bootable Debian 12 cloud-init image from scratch by creating a minimal rootfs with debootstrap, adding kernel/initramfs, OpenSSH, and cloud-init, then installing GRUB into a qcow2 disk and compressing it to /app/images/debian12-cloud.qcow2.zst with a sha256 checksum. Generate a NoCloud seed ISO that provisions user tb with an SSH key, and verify by booting the qcow2 in QEMU with host port 2222 forwarded and successful SSH login.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Image Building & Exporting',
  'Build a bootable Ubuntu 22.04 cloud image (qcow2) from scratch using debootstrap, installing cloud-init and OpenSSH, and configuring GRUB for virtio on /dev/vda. Generate a NoCloud seed ISO that creates a sudo user ''tb'' on first boot, then export both artifacts to /app/images/ for reuse.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Image Building & Exporting',
  'Build a customized Ubuntu 22.04 cloud qcow2 image that preinstalls Nginx and a systemd healthcheck service, and generate a NoCloud cloud-init seed ISO that creates a ''bench'' user with SSH key and enables the service. Export the compressed qcow2 and seed ISO to /app/images with SHA256SUMS, then verify via QEMU that the VM boots and serves a /health endpoint reachable on host port 8081 via user-mode port forwarding.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Image Building & Exporting',
  'Create a minimal Debian qcow2 VM image from scratch using debootstrap, configuring fstab, GRUB for serial console, a non-root tb user with SSH access, and cloud-init. Export the qcow2 and a cloud-init seed ISO, then boot with QEMU to verify SSH connectivity via host port forwarding.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Provision an Ubuntu VM with QEMU/KVM using an official cloud image and a NoCloud (cloud-init) seed that creates a user, installs Nginx, and exposes SSH and HTTP via host port forwards. Use a read-only base qcow2 with per-boot ephemeral overlays, verifying SSH access and that the Nginx default page is reachable from the host.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Virtual Machine Provisioning',
  'Provision an Ubuntu cloud-image VM with QEMU and cloud-init (NoCloud) to create a tb-admin user with a provided SSH public key, preinstall nginx, and serve a custom index.html reachable via host port 8080. After verifying SSH and HTTP access, create a named external qcow2 snapshot, change the site, then revert to the snapshot to demonstrate full VM state rollback.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Virtual Machine Provisioning',
  'Provision an Ubuntu cloud-image VM with QEMU/KVM using a NoCloud cloud-init seed that creates a tb-admin user with SSH key authentication, sets the hostname, and installs/enables nginx on first boot. Forward host 127.0.0.1:8080 to the VM’s port 80, verify the default nginx page is reachable, and leave the VM running headless.',
  NULL,
  ARRAY['cloud']
);
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
...
INSERT INTO task_inspiration (category, subcategory, subsubcategory, description, difficulty, tags) VALUES (
  ...
  'Virtualization & Containerization',
  'Virtual Machine Provisioning',
  'Provision an Ubuntu cloud-image VM with libvirt/KVM using cloud-init to create user ''tb'' (password ''benchmarkpass''), inject an SSH public key, set hostname tb-vm, and enable qemu-guest-agent. Create an isolated libvirt network with a static VM IP and host port-forwarding 2222->22, autostart the VM, and verify SSH connectivity and hostname via a test script.',
  NULL,
  ARRAY['cloud']
);
